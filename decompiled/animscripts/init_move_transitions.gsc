...
{
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left"][7] = 0.465465;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left_crouch"][7] = 0.284284;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left_crouch_cqb"][7] = 0.246246;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left_cqb"][7] = 0.454454;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left"][7] = 0.555556;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left_crouch"][7] = 0.644645;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left_crouch_cqb"][7] = 0.678679;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left_cqb"][7] = 0.598599;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left"][8] = 0.4004;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left_crouch"][8] = 0.404404;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left_crouch_cqb"][8] = 0.33033;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["left_cqb"][8] = 0.456456;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left"][8] = 0.54955;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left_crouch"][8] = 0.537538;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left_crouch_cqb"][8] = 0.544545;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["left_cqb"][8] = 0.67968;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right"][8] = 0.446446;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right_crouch"][8] = 0.23023;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right_cqb"][8] = 0.269269;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right_crouch_cqb"][8] = 0.438438;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right"][8] = 0.431431;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right_crouch"][8] = 0.66967;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right_cqb"][8] = 0.602603;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right_crouch_cqb"][8] = 0.621622;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right"][9] = 0.418418;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right_crouch"][9] = 0.21021;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right_cqb"][9] = 0.317317;
    anim.archetypes["s1_soldier"]["cover_trans_split"]["right_crouch_cqb"][9] = 0.396396;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right"][9] = 0.461461;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right_crouch"][9] = 0.638639;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right_cqb"][9] = 0.50951;
    anim.archetypes["s1_soldier"]["cover_exit_split"]["right_crouch_cqb"][9] = 0.550551;
}
...
{
    if ( isdefined( anim.archetypes[var_0]["cover_exit_split"][var_1] ) && isdefined( anim.archetypes[var_0]["cover_exit_split"][var_1][var_2] ) )
...
{
    if ( isdefined( anim.archetypes[var_0]["cover_trans_split"][var_1] ) && isdefined( anim.archetypes[var_0]["cover_trans_split"][var_1][var_2] ) )
