...
advancedtraverse( var_0, var_1 )
{
    ...
    var_4 = 0.15;
    self _meth_8142( %body, var_4 );
    self _meth_8110( "traverse", var_0, %animscript_root, 1, var_4, 1 );
    var_5 = 0.2;
    var_6 = 0.2;
...
teleportthread( var_0 )
{
    ...
    {
        self _meth_81C6( self.origin + var_2 );
        wait 0.05;
    }
}
...
teleportthreadex( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) && var_3 < 1.0 )
        self _meth_810F( "traverseAnim", self.traverseanim, self.traverseanimroot, 1, 0.2, var_3 );

    for ( var_5 = 0; var_5 < var_2; var_5++ )
    {
        self _meth_81C6( self.origin + var_4 );
        wait 0.05;
    }

    if ( isdefined( var_3 ) && var_3 < 1.0 )
        self _meth_810F( "traverseAnim", self.traverseanim, self.traverseanimroot, 1, 0.2, 1.0 );
}
...
dotraverse( var_0 )
{
    ...
    self _meth_818F( "face angle", var_1.angles[1] );
    ...
    self _meth_8110( "traverseAnim", var_3, self.traverseanimroot, 1, 0.2, 1 );
    ...
    if ( var_5 && isdefined( self.node ) && distancesquared( self.origin, self.node.origin ) < 256 )
    {
        ...
        self _meth_81C5( self.node.origin );
    }
...
handletraversedrop()
{
    ...
    var_1 = self _meth_814F( self.traverseanim );
...
dovariablelengthtraverse( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    self _meth_818F( "face angle", var_8.angles[1] );

    if ( isdefined( var_0 ) )
    {
        self _meth_8110( "traversal", var_0, var_17, 1, 0.1, var_7 );
        animscripts\shared::donotetracks( "traversal" );
    }

    self _meth_8110( "traversal", var_1, var_17, 1, 0.1, var_7 );
    animscripts\notetracks::donotetracksfortime( var_16, "traversal" );

    if ( isdefined( var_2 ) )
    {
        self _meth_8110( "traversal", var_2, var_17, 1, 0.1, var_7 );
        animscripts\shared::donotetracks( "traversal" );
    }
...
dog_wall_and_window_hop( var_0, var_1, var_2 )
{
    ...
    var_3 = self _meth_819D();
    self _meth_818F( "face angle", var_3.angles[1] );
    ...
    self _meth_8113( "dog_traverse", self.traverseanim, 1, 0.2, 1 );
...
dog_jump_down( var_0, var_1, var_2, var_3 )
{
    ...
    self _meth_818D( "noclip" );
    thread dog_traverse_cleanup_on_end();
    var_4 = self _meth_819D();
    var_5 = self _meth_819E();
    self _meth_818F( "face angle", var_4.angles[1] );
    ...
    self.moveanimtype = "land";
    self _meth_8142( %body, 0.2 );
    self _meth_8113( "traverseAnim", self.traverseanim, 1, 0.2, 1 );
...
dog_long_jump( var_0, var_1 )
{
    ...
    self.moveanimtype = "land";
    self _meth_8142( %body, 0.2 );
    self _meth_8110( "dog_traverse", anim.dogtraverseanims[var_0], 1, 0.2, 1 );
