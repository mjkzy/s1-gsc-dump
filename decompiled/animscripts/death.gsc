...
init_animset_death()
{
    ...
    var_0["melee_exo_front_stand_stand"] = [ %npc_sp_exo_melee_stand_front ];
    var_0["melee_exo_back_stand_stand"] = [ %npc_sp_exo_melee_stand_back ];
    var_0["melee_exo_right_stand_stand"] = [ %npc_sp_exo_melee_stand_right ];
    var_0["melee_exo_left_stand_stand"] = [ %npc_sp_exo_melee_stand_left ];
    var_0["melee_exo_front_stand_crouch"] = [ %npc_sp_exo_melee_kneel_front ];
    var_0["melee_exo_back_stand_crouch"] = [ %npc_sp_exo_melee_kneel_back ];
    var_0["melee_exo_left_stand_crouch"] = [ %npc_sp_exo_melee_kneel_left ];
    var_0["melee_exo_right_stand_crouch"] = [ %npc_sp_exo_melee_kneel_right ];
    var_0["melee_exo_front_stand_prone"] = [ %npc_sp_exo_melee_prone_front ];
    var_0["melee_exo_back_stand_prone"] = [ %npc_sp_exo_melee_prone_back ];
    var_0["melee_exo_left_stand_prone"] = [ %npc_sp_exo_melee_prone_left ];
    var_0["melee_exo_right_stand_prone"] = [ %npc_sp_exo_melee_prone_right ];
    var_0["melee_exo_front_crouch_stand"] = [ %npc_sp_exo_melee_stand_front ];
    var_0["melee_exo_back_crouch_stand"] = [ %npc_sp_exo_melee_stand_back ];
    var_0["melee_exo_left_crouch_stand"] = [ %npc_sp_exo_melee_stand_left ];
    var_0["melee_exo_right_crouch_stand"] = [ %npc_sp_exo_melee_stand_right ];
    var_0["melee_exo_front_crouch_crouch"] = [ %npc_sp_exo_melee_kneel_front ];
    var_0["melee_exo_back_crouch_crouch"] = [ %npc_sp_exo_melee_kneel_back ];
    var_0["melee_exo_left_crouch_crouch"] = [ %npc_sp_exo_melee_kneel_left ];
    var_0["melee_exo_right_crouch_crouch"] = [ %npc_sp_exo_melee_kneel_right ];
    var_0["melee_exo_front_crouch_prone"] = [ %npc_sp_exo_melee_prone_front ];
    var_0["melee_exo_back_crouch_prone"] = [ %npc_sp_exo_melee_prone_back ];
    var_0["melee_exo_left_crouch_prone"] = [ %npc_sp_exo_melee_prone_left ];
    var_0["melee_exo_right_crouch_prone"] = [ %npc_sp_exo_melee_prone_right ];
    var_0["melee_exo_front_prone_stand"] = [ %npc_sp_exo_melee_stand_front ];
    var_0["melee_exo_back_prone_stand"] = [ %npc_sp_exo_melee_stand_back ];
    var_0["melee_exo_left_prone_stand"] = [ %npc_sp_exo_melee_stand_left ];
    var_0["melee_exo_right_prone_stand"] = [ %npc_sp_exo_melee_stand_right ];
    var_0["melee_exo_front_prone_crouch"] = [ %npc_sp_exo_melee_kneel_front ];
    var_0["melee_exo_back_prone_crouch"] = [ %npc_sp_exo_melee_kneel_back ];
    var_0["melee_exo_left_prone_crouch"] = [ %npc_sp_exo_melee_kneel_left ];
    var_0["melee_exo_right_prone_crouch"] = [ %npc_sp_exo_melee_kneel_right ];
    var_0["melee_exo_front_prone_prone"] = [ %npc_sp_exo_melee_prone_front ];
    var_0["melee_exo_back_prone_prone"] = [ %npc_sp_exo_melee_prone_back ];
    var_0["melee_exo_left_prone_prone"] = [ %npc_sp_exo_melee_prone_left ];
    var_0["melee_exo_right_prone_prone"] = [ %npc_sp_exo_melee_prone_right ];
    var_0["melee_exo_stand_front_head"] = [ %npc_sp_exo_melee_stand_front_head ];
    var_0["melee_exo_stand_back_head"] = [ %npc_sp_exo_melee_stand_back_head ];
    var_0["melee_exo_stand_left_head"] = [ %npc_sp_exo_melee_stand_left_head ];
    var_0["melee_exo_stand_right_head"] = [ %npc_sp_exo_melee_stand_right_head ];
    var_0["melee_exo_crouch_front_head"] = [ %npc_sp_exo_melee_kneel_front_head ];
    var_0["melee_exo_crouch_back_head"] = [ %npc_sp_exo_melee_kneel_back_head ];
    var_0["melee_exo_crouch_left_head"] = [ %npc_sp_exo_melee_kneel_left_head ];
    var_0["melee_exo_crouch_right_head"] = [ %npc_sp_exo_melee_kneel_right_head ];
    var_0["melee_exo_prone_front_head"] = [ %npc_sp_exo_melee_prone_front_head ];
    var_0["melee_exo_prone_back_head"] = [ %npc_sp_exo_melee_prone_back_head ];
    var_0["melee_exo_prone_left_head"] = [ %npc_sp_exo_melee_prone_left_head ];
    var_0["melee_exo_prone_right_head"] = [ %npc_sp_exo_melee_prone_right_head ];
    var_0["melee_exo_front_lower"] = [ %stand_death_crotch ];
