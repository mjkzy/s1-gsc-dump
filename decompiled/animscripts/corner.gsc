...
mainloopstart()
{
    ...
    if ( self.havegonetocover )
    {
        if ( isdefined( self.animarchetype ) && self.animarchetype == "s1_soldier" )
        {
            if ( var_0 == "crouch_l" || var_0 == "crouch_r" )
                var_0 = "crouch";
        }
    ...
    else
    {
        ...
        if ( self.a.pose == var_0 )
        {
            if ( isdefined( self.cover ) && isdefined( self.cover.hidestate ) && self.cover.hidestate == "back" )
                var_2 = animscripts\utility::animarray( "alert_idle_back" );
            else
                var_2 = animscripts\utility::animarray( "alert_idle" );

            gotocover( var_2, 0.3, 0.4 );
        }
        else
        {
            if ( isdefined( self.animarchetype ) && self.animarchetype == "s1_soldier" )
            {
                if ( var_0 == "crouch_l" )
                {
                    var_1 = animscripts\utility::lookupanim( "combat", "trans_to_crouch_l" );
                    var_0 = "crouch";
                }
                else if ( var_0 == "crouch_r" )
                {
                    var_1 = animscripts\utility::lookupanim( "combat", "trans_to_crouch_r" );
                    var_0 = "crouch";
                }
            }
