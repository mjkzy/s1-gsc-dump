...
trackloop( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        {
            var_32 = self.angles[2] * -1;
            var_33 = var_30 * cos( var_32 ) - var_31 * sin( var_32 );
            var_34 = var_30 * sin( var_32 ) + var_31 * cos( var_32 );
            var_30 = var_33;
            var_31 = var_34;
            var_30 = clamp( var_30, self.downaimlimit, self.upaimlimit );
            var_31 = clamp( var_31, self.leftaimlimit, self.rightaimlimit );
        }
        ...
        var_35 = squared( var_11 );
        var_9 = self.relativedir;
        var_36 = self.movemode != "stop" || !var_8;

        if ( var_36 )
        {
            var_37 = var_31 - var_5;

            if ( squared( var_37 ) > var_35 )
            {
        ...
        var_5 = var_31;
        var_6 = var_30;
        trackloop_setanimweights( var_0, var_1, var_2, var_3, var_4, var_30, var_31 );
        wait 0.05;
    }
}
