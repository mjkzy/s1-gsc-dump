...
_id_1DDA( var_0, var_1 )
{
    ...
    if ( var_0 < -60 && var_0 > -120 )
        var_2 = level._id_78A9[self._id_0C72]["turn_left_90"];

    if ( var_0 > 60 && var_0 < 120 )
        var_2 = level._id_78A9[self._id_0C72]["turn_right_90"];

    if ( isdefined( var_2 ) && animscripts\move::_id_66D1( var_2 ) )
        return var_2;
    else
        return undefined;
}
...
_id_1DA4( var_0, var_1 )
{
    ...
    if ( var_0 < -22.5 )
    {
        ...
        else if ( var_0 > -112.5 )
        {
            ...
            var_3 = animscripts\utility::_id_711B( %civilian_run_hunched_turnl90_slide, %civilian_run_hunched_turnl90_stumble );
        }
        else if ( var_0 > -157.5 )
            var_2 = %civilian_run_upright_turnl135;
        else
    ...
    else if ( var_0 > 22.5 )
    {
        ...
        else if ( var_0 < 112.5 )
        {
            ...
            var_3 = animscripts\utility::_id_711B( %civilian_run_hunched_turnr90_slide, %civilian_run_hunched_turnr90_stumble );
        }
        else if ( var_0 < 157.5 )
            var_2 = %civilian_run_upright_turnr135;
        else
    ...
    if ( isdefined( var_3 ) && randomint( 3 ) < 2 && animscripts\move::_id_66D1( var_3 ) )
        return var_3;
