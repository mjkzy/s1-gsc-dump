...
shootuntilshootbehaviorchange()
{
    ...
    for (;;)
    {
        ...
        {
            var_2 = animscripts\shared::decidenumshotsforburst();

            if ( var_2 == 1 )
                fireuntiloutofammo( animscripts\utility::animarraypickrandom( "single" ), 1, var_2 );
            else
                fireuntiloutofammo( animscripts\utility::animarray( self.shootstyle + var_2 ), 1, var_2 );
        }
...
fireuntiloutofammointernal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = 0;
    var_6 = animhasnotetrack( var_1, "fire" );
    ...
    while ( var_5 < var_3 && var_3 > 0 )
    {
        ...
        if ( !var_6 || var_3 == 1 && self.shootstyle == "single" )
