...
main( var_0, var_1, var_2 )
{
    ...
    maps\_vehicle::build_light( var_2, "cockpit_blue_cargo01", "tag_light_cargo01", "vfx/lights/air_light_cockpit_red", "interior", 0.0 );
    maps\_vehicle::build_light( var_2, "cockpit_blue_cockpit01", "tag_light_cockpit01", "vfx/lights/air_light_cockpit_blue", "interior", 0.0 );
    maps\_vehicle::build_light( var_2, "wingtip_green", "tag_light_L_wing", "vfx/lights/air_light_wingtip_red", "running", var_4 );
    maps\_vehicle::build_light( var_2, "wingtip_red", "tag_light_R_wing", "vfx/lights/air_light_wingtip_red", "running", var_4 );
    maps\_vehicle::build_light( var_2, "white_blink_tail", "tag_light_tail", "vfx/lights/air_light_wingtip_red", "running", var_4 );
