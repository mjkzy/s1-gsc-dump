...
snd_sniper_drone_constructor()
{
    ...
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "sniper_drone_hover_spd2vol", [ [ 0, 1.0 ], [ 30, 0.5 ] ] );
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "sniper_drone_hover_spd2pch", [ [ 0, 1.0 ], [ 30, 1.2 ] ] );
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "sniper_drone_fly_spd2vol", [ [ 7, 0.0 ], [ 8, 1.0 ], [ 30, 1.0 ] ] );
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "sniper_drone_fly_spd2pch", [ [ 8, 1.0 ], [ 30, 1.1 ] ] );
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "sniper_drone_look_spd2vol", [ [ 0.09, 0.0 ], [ 0.1, 1.0 ], [ 1.0, 1.0 ] ] );
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "sniper_drone_look_hover_spd2vol", [ [ 2, 1.0 ], [ 8, 0 ] ] );
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "sniper_drone_no_duck_envelope", [ [ 0.0, 1.0 ], [ 1.0, 1.0 ] ] );
    ...
    soundscripts\_audio_vehicle_manager::avm_begin_state_group( "look", "state_idle", "to_state_idle", 50, 1.0 );
...
sniper_drone_condition_callback_to_state_hover( var_0, var_1 )
{
    var_2 = var_0["speed"];
...
sniper_drone_condition_callback_to_state_flying( var_0, var_1 )
{
    var_2 = var_0["speed"];
...
sniper_drone_condition_callback_to_state_idle( var_0, var_1 )
{
    var_2 = var_0["look"];
    var_3 = var_0["speed"];
...
sniper_drone_condition_callback_to_state_looking( var_0, var_1 )
{
    var_2 = var_0["look"];
    var_3 = var_0["speed"];
