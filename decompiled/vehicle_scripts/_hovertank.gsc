...
hovertank_hud_init( var_0 )
{
    ...
    if ( var_1 )
    {
        ...
        {
            var_4.hudelem_x = var_4.hudelem_x * 0.8;
            var_4.hudelem_y = var_4.hudelem_y * 0.8;
    ...
    if ( var_1 )
    {
        ...
        if ( !var_2 )
            var_13 = var_13 * 0.888889;
    }
    else if ( !var_2 )
        var_13 = var_13 * 0.833333;
...
hoverscreen_hit( var_0, var_1 )
{
    ...
    for ( var_5 = 0; var_5 < 5; var_5++ )
    {
        ...
        level.huditem["hovertank_hit01"][var_0].alpha = level.huditem["hovertank_hit01"][var_0].alpha * var_1;
        wait 0.05;
    }
...
weapon_ammo_bar_reload( var_0, var_1 )
{
    ...
    while ( var_6 < var_7 )
    {
        level.weapon_ammo_bar_value[var_0] = level.weapon_ammo_bar_value[var_0] + var_5;
        var_6 = var_6 + var_4;
        wait( var_4 );
    }
...
monitor_player_damage()
{
    ...
    for (;;)
    {
        ...
        if ( !level.player.death_invulnerable_activated )
            level.player_ugv_health = level.player_ugv_health - var_1;
    }
}
...
update_trophy_reload_progress_bar()
{
    ...
    while ( var_2 < var_0 && isdefined( self ) )
    {
        ...
        self.trophyammo = self.trophyammo + self.trophy_cost / var_0 * var_3;
        var_2 = var_2 + var_3;
        wait( var_3 );
    }
