...
fire_burst( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    while ( var_0 > 0 )
    {
        ...
        if ( isdefined( self.attack_accuracy ) )
            var_5 = var_5 * self.attack_accuracy;
...
death_plummet()
{
    ...
    for ( var_4 = ( 0, 0, -980 ); var_1 < 5; var_1 = var_1 + 0.05 )
    {
        wait 0.05;
        ...
        var_0.origin = var_6;
        var_0.angles = var_0.angles + ( 0, 5, 0 );
    }
...
death_rocket_out_of_control( var_0 )
{
    ...
    for ( var_31 = ( 0, 0, -980 ); var_28 < 5 && !var_20; var_28 = var_28 + 0.05 )
    {
        wait 0.05;
        ...
        foreach ( var_7 in level.flying_attack_drones )
        {
            if ( self != var_7 && isdefined( self.current_air_space ) && isdefined( var_7.current_air_space ) )
            {
                if ( self.current_air_space == var_7.current_air_space )
                {
                    ...
                    {
                        var_2++;
                        var_3 = var_3 - 0.5 * ( 90 - var_9 ) * var_8 / var_9;
                    }
                    else if ( var_9 > 150 )
                    {
                        var_4++;
                        var_5 = var_5 + 0.5 * ( var_9 - 150 ) * var_8 / var_9;
                    }
                }
            }
        }
