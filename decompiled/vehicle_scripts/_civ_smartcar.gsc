...
{
    maps\_vehicle::build_template( "civ_smartcar", var_0, var_1, var_2 );
    ...
    maps\_vehicle::build_light( var_2, "taillight_scroll_right", "tag_brakelight_right", "vfx/lights/veh_smartcar_signal_light_back_rt", "taillights" );
    maps\_vehicle::build_light( var_2, "taillight_scroll_left", "tag_brakelight_left", "vfx/lights/veh_smartcar_signal_light_back_lt", "taillights" );
    maps\_vehicle::build_light( var_2, "frontsignal_right", "tag_headlight_right", "vfx/lights/veh_smartcar_signal_light_front_rt", "frontlights" );
    maps\_vehicle::build_light( var_2, "frontsignal_left", "tag_headlight_left", "vfx/lights/veh_smartcar_signal_light_front_lt", "frontlights" );
    maps\_vehicle::build_light( var_2, "brakelight_set", "tag_origin", "vfx/lights/veh_smartcar_stop_light", "brakelights" );
