...
calculate_tactical_score( var_0, var_1 )
{
    ...
    var_3 = var_3 + evaluate_tactical_too_close( var_0, var_2, level.drone_tactical_picker_data.eval_too_close_range );
    var_3 = var_3 + evaluate_tactical_in_front_of_enemy( var_0, var_2 );
    var_3 = var_3 + evaluate_tactical_above_player( var_0, var_2 );
    var_3 = var_3 * evaluate_tactical_los( var_0, var_2 );
    var_3 = var_3 * evaluate_tactical_in_front_of_volume( var_1, var_2 );
    return var_3 / 4;
}
...
update_tactical()
{
    ...
    if ( isdefined( level.drone_test_points ) )
        var_1 = var_1 + level.drone_test_points.size;
...
calculate_flock_goal_positions()
{
    ...
    foreach ( var_1 in level.flying_attack_drones )
    {
        ...
        foreach ( var_9 in level.flying_attack_drones )
        {
            ...
            {
                var_3++;
                var_4 = var_4 - 0.5 * ( 90 - var_11 ) * var_10 / var_11;
                continue;
            }
            ...
            {
                var_5++;
                var_6 = var_6 + 0.5 * ( var_11 - 150 ) * var_10 / var_11;
            }
        }
...
sort_drone_moves()
{
    ...
    foreach ( var_2 in level.flying_attack_drones )
    {
        ...
        var_2.time_before_move = var_2.time_before_move - 0.05;
    ...
    foreach ( var_2 in level.flying_attack_drones )
    {
        ...
        var_2.time_before_move = var_2.time_before_move + var_5;
    }
}
...
sort_drone_attacks()
{
    ...
    foreach ( var_2 in level.flying_attack_drones )
    {
        ...
        var_2.time_before_attack = var_2.time_before_attack - 0.05;
        var_0 maps\_sarray::sarray_push( var_2 );
    }
    ...
    foreach ( var_2 in level.flying_attack_drones )
    {
        ...
        var_2.time_before_attack = var_2.time_before_attack + var_5;
    }
}
...
calculate_dodge_positions( var_0, var_1 )
{
    ...
    var_2 = var_2 / level.flying_attack_drones.size;
