...
snd_init_x4_walker_wheels_turret_closed()
{
    ...
    soundscripts\_snd::snd_message( "snd_register_vehicle", "x4walker_wheels_turret_closed", ::snd_x4walker_wheels_turret_constructor );
}

snd_start_x4_walker_wheels_turret_closed( var_0 )
{
    ...
    var_2 = spawnstruct();
    var_2.preset_name = "x4walker_wheels_turret_closed";
...
{
    soundscripts\_audio_vehicle_manager::avm_begin_preset_def( "x4walker_wheels_turret_closed" );
    ...
    soundscripts\_audio_vehicle_manager::avm_add_param_map_env( "pitch", "x4_turret_rot_slow_vel2pit", "x4_turret_rot_slow_vel2pit" );
    soundscripts\_audio_vehicle_manager::avm_end_param_map();
    soundscripts\_audio_vehicle_manager::avm_begin_param_map( "x4wwt_gun_yaw_rate2", 1.0, 1.0 );
    soundscripts\_audio_vehicle_manager::avm_add_param_map_env( "volume", "x4_veh_speed_to_turret_rot_gate", "x4_veh_speed_to_turret_rot_gate" );
    soundscripts\_audio_vehicle_manager::avm_end_param_map();
    soundscripts\_audio_vehicle_manager::avm_end_loop_def();
    ...
    soundscripts\_audio_vehicle_manager::avm_end_param_map();
    soundscripts\_audio_vehicle_manager::avm_begin_param_map( "x4wwt_gun_pitch_rate2", 1.0, 1.0 );
    ...
    soundscripts\_audio_vehicle_manager::avm_end_state_def();
    soundscripts\_audio_vehicle_manager::avm_end_state_group();
    soundscripts\_audio_vehicle_manager::avm_begin_state_group( "turret_rotate", "state_turret_rotate_accel", "to_state_turret_rotate_accel", 50, 1.0 );
    ...
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "x4_startup_duck_envelope", [ [ 0.0, 0.0 ], [ 1.0, 0.5 ], [ 1.6, 1.0 ] ] );
    soundscripts\_audio_vehicle_manager::avm_add_envelope( "xwalk_shutoff_duck_envelope", [ [ 0.0, 1.0 ], [ 0.16, 0.4 ], [ 1.1, 0.0 ] ] );
    soundscripts\_audio_vehicle_manager::avm_end_preset_def();
}

x4wwt_condition_callback_to_state_off( var_0, var_1 )
{
    return 1;
}

x4wwt_condition_callback_to_state_enter_vehicle( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["x4wwt_player_driver"];
...
x4wwt_condition_callback_to_state_exit_vehicle( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["x4wwt_player_driver"];
...
x4wwt_condition_callback_to_state_startup( var_0, var_1 )
{
    var_1.g_xwalk_pitched_hard = 0;
    var_1.g_xwalk_was_stopped = 1;
    var_1.g_xwalk_time_started_to_move = 0;
    return 1;
}

x4wwt_condition_callback_to_state_shutoff( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["x4wwt_player_driver"];
...
x4wwt_condition_callback_to_state_idle( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["speed"];
...
x4wwt_condition_callback_to_state_start_move( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["speed"];
    ...
    else
    {
        ...
        if ( var_1.g_xwalk_pitched_hard == 1 && var_4 > 0 )
        {
            var_5 = gettime() - var_1.start_move.strain_accel_last_trigger;

            if ( var_5 > 4000 )
            {
                var_2 = 1;
                var_1.g_xwalk_time_started_to_move = gettime();
                var_1.start_move.acceltime = 0;
                var_1.start_move.accelerating = 0;
                var_1.start_move.time_accel = 0;
                var_1.g_xwalk_pitched_hard = 0;
        ...
        else if ( var_1.start_move.time_accel > 400 && var_4 > 0.4 )
        {
            var_2 = 1;
            var_1.g_xwalk_time_started_to_move = gettime();
            var_1.start_move.acceltime = 0;
...
x4wwt_condition_callback_to_state_moving( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["speed"];
...
x4wwt_condition_callback_to_state_breaking( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["speed"];
    var_4 = var_0["pitch"];
    var_5 = gettime() - var_1.g_xwalk_time_started_to_move;
...
x4wwt_condition_callback_to_state_stopped( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0["speed"];
...
x4wwt_condition_callback_to_state_destruct( var_0, var_1 )
{
    return 0;
}

x4wwt_condition_callback_to_state_wheels_neutral( var_0, var_1 )
{
    return 0;
}

x4wwt_condition_callback_to_state_wheels_bump_impact( var_0, var_1 )
{
    var_2 = [ "zv_front_left", "zv_front_right", "zv_rear_left", "zv_rear_right" ];
    var_3 = [];
    var_3["zv_front_left"] = var_0["x4wwt_zvelocity_front_left"];
    var_3["zv_front_right"] = var_0["x4wwt_zvelocity_front_right"];
    var_3["zv_rear_left"] = var_0["x4wwt_zvelocity_rear_left"];
    var_3["zv_rear_right"] = var_0["x4wwt_zvelocity_rear_right"];
    var_4 = var_0["speed"];
    var_5 = 0;
...
x4wwt_condition_callback_to_state_turret_rotate( var_0, var_1 )
{
    var_2 = 0;
    return var_2;
}

x4wwt_condition_callback_to_state_turret_stopped( var_0, var_1 )
{
    var_2 = 0;
    return var_2;
}

x4wwt_condition_callback_to_state_turret_rotate_accel( var_0, var_1 )
{
    var_2 = 0;
    var_3 = abs( var_0["x4wwt_gun_yaw_rate"] );
    var_4 = var_0["speed"];
...
x4wwt_condition_callback_to_state_turret_rotate_decel( var_0, var_1 )
{
    var_2 = 0;
    return var_2;
}

x4wwt_condition_callback_to_state_turret_elevate( var_0, var_1 )
{
    var_2 = 0;
    return var_2;
}
...
x4wwt_input_callback_wheel_zvelocity( var_0 )
{
    var_1 = soundscripts\_audio_vehicle_manager::avmx_get_vehicle_entity();
    var_2 = var_1 vehicle_scripts\_x4walker_wheels_turret_closed::get_wheel_velocity( var_0 );
    var_3 = var_2[2];
    return var_3;
}
...
x4wwt_input_callback_gun_pitch_rate()
{
    ...
    var_1 = var_0 vehicle_scripts\_x4walker_wheels_turret_closed::get_gun_pitch_rate();
    return var_1;
}
...
{
    var_0 = soundscripts\_audio_vehicle_manager::avmx_get_vehicle_entity();
    var_1 = var_0 vehicle_scripts\_x4walker_wheels_turret_closed::get_gun_yaw_rate();
    return var_1;
}
