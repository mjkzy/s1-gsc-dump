...
fake_drone_death( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_15 = 0; var_15 < var_5; var_15 = var_15 + 0.05 )
    {
        if ( !isdefined( self ) )
            return;

        var_9 = var_9 + var_7 * 0.05;

        if ( var_15 < var_4 )
            var_9 = var_9 + var_8 * 0.05;

        var_16 = min( var_6 * lengthsquared( var_9 ) * 0.05, length( var_9 ) );
        var_9 = var_9 - vectornormalize( var_9 ) * var_16;
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            if ( isdefined( level.snake_swarm_speed_scale ) )
                var_7 = var_7 * level.snake_swarm_speed_scale;
            ...
            var_1 = var_1 + vectornormalize( var_8 ) * var_9;
...
snake_choose_next_point( var_0, var_1 )
{
    ...
    foreach ( var_17 in var_0 )
    {
        ...
        var_18 = var_18 + ( vectordot( var_19, var_21 ) + 1 ) / 2 * var_5;
        var_22 = var_17.origin - level.player.origin;
        var_23 = vectornormalize( var_22 );
        var_18 = var_18 + ( vectordot( var_23, var_13 ) + 1 ) / 2 * var_7;
        var_18 = var_18 - distance( var_1.origin, var_17.origin ) * var_6;
        var_18 = var_18 - distance( level.player.origin, var_17.origin ) * var_8;
        var_18 = var_18 + vectorcross( vectornormalize( self.snake_points_center - self.origin ), var_21 )[2] * var_9;

        if ( isdefined( self.snake_goal_origin ) )
            var_18 = var_18 - distance( self.snake_goal_origin, var_17.origin ) * var_10;

        if ( isdefined( var_1 ) && isdefined( var_1.went_thither ) && var_1.went_thither == var_17 && gettime() - var_1.went_thither_time < var_12 )
            var_18 = var_18 + randomfloat( var_11 );
