...
{
    maps\_vehicle::build_template( "civ_domestic_sportscar_01", var_0, var_1, var_2 );
...
setanims()
{
    ...
    var_0[0].idle = %civ_domestic_sportscar_01_driver_idle;
    var_0[1].idle = %civ_domestic_sportscar_01_passenger_idle;
    return var_0;
}
