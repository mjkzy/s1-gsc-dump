...
mimic_player_move( var_0, var_1, var_2, var_3 )
{
    ...
    var_15 = var_15 * var_0.move_scale;
    ...
    else
    {
        ...
        var_1.vel = var_1.vel + var_28 * var_23;
    }
...
mobile_cover_dummy_player_think()
{
    ...
    if ( var_6 > var_7 && var_9 > 0 )
    {
        ...
        {
            self.accumulated_restore = self.accumulated_restore + abs( var_9 );
            self.dummy_player.vel = ( 0, 0, 0 );
...
mobile_cover_link_think_angle_controller()
{
    ...
    for (;;)
    {
        ...
        var_26 = var_26 * maps\_shg_utility::linear_map_clamp( length( var_15 ), 10, 50, 1, 0 );
...
player_ads_think()
{
    ...
    for (;;)
    {
        ...
        {
            self.blend = self.blend + var_0;

            if ( var_5 )
                var_3 = 1;
        }
        else
            self.blend = self.blend + var_1;
