...
{
    maps\_vehicle::build_template( "civ_domestic_bus", var_0, var_1, var_2 );
    ...
    maps\_vehicle::build_light( var_2, "brakelight_set", "tag_origin", "vfx/lights/veh_civ_domestic_bus_stop_light", "brakelights" );
