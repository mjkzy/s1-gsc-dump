...
avmx_launch_state_machines( var_0 )
{
    ...
    foreach ( var_10, var_4 in var_2.state_data.state_groups )
    {
        ...
        var_1 thread avmx_state_enter_action_function( var_8, var_9 );
    }
}

avmx_state_enter_action_function( var_0, var_1 )
{
    var_2 = self;
    var_3 = var_2 avmx_get_instance_preset();
    var_4 = var_0.ps_item;
    var_5 = var_2 avmx_get_vehicle_entity();
    level endon( "msg_snd_vehicle_stop" );
    level endon( "msg_snd_vehicle_stop_" + avmx_get_instance_name() );
    var_5 endon( "death" );
    var_0.start_time = gettime();
    var_2 avmx_state_enter_action_init_data( var_0, var_1 );
    var_2 avmx_state_enter_action_play_oneshots( var_0, var_1 );
    var_2 avmx_state_enter_action_play_loops( var_0, var_1 );

    if ( isdefined( var_1.ps_item.init_state_callback ) )
        var_2 [[ var_1.ps_item.init_state_callback ]]( var_2.user_data );
    ...
    for (;;)
    {
        ...
        {
            var_2 avmx_map_io( var_1 );
            var_2 [[ var_1.ps_item.in_state_callback ]]( var_1.curr_io.smoothed_input, var_2.user_data );
        }

        foreach ( var_12 in var_4.transitions )
        {
            var_13 = var_12[0];
            var_14 = var_12[1];
            var_15 = var_12[2];
            var_16 = var_2 avmx_get_instance_state_struct( var_13 );
            var_17 = var_2 avmx_get_behavior_instance_struct( var_14 );
            var_18 = var_16.ps_item;
            var_19 = var_17.ps_item;

            if ( gettime() - var_16.start_time < var_18.min_retrigger_time )
                continue;

            var_2 avmx_map_io( var_17, var_10 );
            var_20 = var_2 avmx_state_condition_function( var_16, var_17 );
            ...
            if ( var_20 )
            {
                if ( !isdefined( var_6 ) || var_18.priority > var_6.ps_item.priority )
                {
                    var_6 = var_16;
                    var_7 = var_17;
                    var_8 = var_9;
        ...
        var_10 = gettime();
        var_22 = distance2d( var_2.veh_ent.origin, level.player.origin );
        ...
        if ( var_22 < 400 )
            ...
            var_23 = 1.0 + 9.0 * ( var_22 - 400 ) / 1100;

        wait(0.1 * var_23);
    }

    var_2 avmx_set_behavior_oneshot_overrides( var_7, var_8 );
    var_24 = var_2 avmx_get_behavior_restricted_oneshots( var_7 );
    var_25 = var_24.size > 0;
    var_2 thread avmx_state_exit_action_function( var_1, var_25 );
    var_2 thread avmx_state_enter_action_function( var_6, var_7 );
}
