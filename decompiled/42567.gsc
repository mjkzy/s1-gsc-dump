...
snd_start_x4_walker_wheels_turret( var_0 )
{
    ...
    var_2 = spawnstruct();
    var_2.preset_name = "x4walker_wheels_turret";
...
x4wwt_input_callback_wheel_zvelocity( var_0 )
{
    ...
    var_2 = var_1 vehicle_scripts\_x4walker_wheels_turret::get_wheel_velocity( var_0 );
    var_3 = var_2[2];
    return var_3;
}
...
x4wwt_input_callback_gun_pitch_rate()
{
    ...
    var_1 = var_0 vehicle_scripts\_x4walker_wheels_turret::get_gun_pitch_rate();
    return var_1;
}
...
{
    var_0 = soundscripts\_audio_vehicle_manager::avmx_get_vehicle_entity();
    var_1 = var_0 vehicle_scripts\_x4walker_wheels_turret::get_gun_yaw_rate();
    return var_1;
}
