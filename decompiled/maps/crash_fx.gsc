...
playersnowfootstepscrash()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 == "left" )
        {
            var_1 = self.origin - ( anglestoforward( self.angles )[0] * 48, anglestoforward( self.angles )[1] * 48, 0 ) + ( anglestoright( self.angles )[0] * -6, anglestoright( self.angles )[1] * -6, 0 );
            var_2 = self.origin - ( anglestoforward( self.angles )[0] * 48, anglestoforward( self.angles )[1] * 48, 5 ) + ( anglestoright( self.angles )[0] * -6, anglestoright( self.angles )[1] * -6, 0 );
            var_0 = "right";
        }
        else
        {
        ...
        if ( !common_scripts\utility::flag( "hide_player_snow_footprints" ) )
        {
            if ( distance( self getvelocity(), ( 0, 0, 0 ) ) <= 154 )
                playfx( common_scripts\utility::getfx( "footstep_snow_small" ), var_3["position"], var_3["normal"], var_4 + ( 0, 180, 0 ) );

            if ( distance( self getvelocity(), ( 0, 0, 0 ) ) > 154 )
                playfx( common_scripts\utility::getfx( "footstep_snow" ), var_3["position"], var_3["normal"], var_4 + ( 0, 180, 0 ) );
        }
    }
}
...
skyjack_drone_fx()
{
    var_0 = common_scripts\utility::getfx( "crash_drone_main_engine" );
    var_1 = common_scripts\utility::getfx( "drone_chute_thruster" );
    playfxontag( var_0, self, "tag_engine" );
    self waittillmatch( "single anim", "end" );
    wait 0.7;
    stopfxontag( var_0, self, "tag_engine" );
    self waittillmatch( "single anim", "jets_on" );
    playfxontag( var_0, self, "tag_engine" );
    waitframe();
    playfxontag( var_1, self, "tag_engine_r" );
    playfxontag( var_1, self, "tag_engine_l" );
    common_scripts\utility::flag_wait( "skyjack_end_heavy_clouds" );
    wait 3.25;
    stopfxontag( var_0, self, "tag_engine" );
    stopfxontag( var_1, self, "tag_engine_r" );
    stopfxontag( var_1, self, "tag_engine_l" );
}

skyjack_atlas_jet_fx()
{
    var_0 = common_scripts\utility::getfx( "jet_thruster_atlasplane_left" );
    var_1 = common_scripts\utility::getfx( "jet_thruster_atlasplane_right" );
    var_2 = common_scripts\utility::getfx( "crash_atlas_jet_exterior_lights" );
    var_3 = common_scripts\utility::getfx( "crash_atlas_jet_ext_leftwing_lights" );
    var_4 = common_scripts\utility::getfx( "crash_atlas_jet_ext_rightwing_lights" );
    var_5 = common_scripts\utility::getfx( "crash_slice_device_laser_cut_ft" );
    var_6 = common_scripts\utility::getfx( "crash_slice_device_laser_cut_bk" );
    playfxontag( var_0, self, "TAG_LT_WING_EXHAUSE_FX" );
    playfxontag( var_1, self, "TAG_RT_WING_EXHAUSE_FX" );
    waitframe();
    playfxontag( var_2, self, "body_animate_jnt" );
    waitframe();
    playfxontag( var_3, self, "body_animate_jnt" );
    playfxontag( var_4, self, "body_animate_jnt" );
    self waittillmatch( "single anim", "activate" );
    playfxontag( var_6, self, "TAG_FX_LT_WING_LASER_BK" );
    playfxontag( var_5, self, "TAG_FX_LT_WING_LASER_FT" );
    self waittillmatch( "single anim", "end_front" );
    stopfxontag( var_5, self, "TAG_FX_LT_WING_LASER_FT" );
    self waittillmatch( "single anim", "end_back" );
    wait 0.2;
    killfxontag( var_6, self, "TAG_FX_LT_WING_LASER_BK" );
    self waittillmatch( "single anim", "begin_explosion" );
    stopfxontag( var_0, self, "TAG_LT_WING_EXHAUSE_FX" );
    stopfxontag( var_1, self, "TAG_RT_WING_EXHAUSE_FX" );
    wait 0.1;
    stopfxontag( var_3, self, "body_animate_jnt" );
    stopfxontag( var_4, self, "body_animate_jnt" );
    wait 0.1;
    stopfxontag( var_2, self, "body_animate_jnt" );
}

skyjack_charge_fx()
{
    var_0 = common_scripts\utility::getfx( "crash_slice_laser_beam" );
    var_1 = common_scripts\utility::getfx( "crash_slice_device_plant" );
    self waittillmatch( "single anim", "bolt_anchors" );
    playfxontag( var_1, self, "J_Bolt_FL" );
    playfxontag( var_1, self, "J_Bolt_FR" );
    playfxontag( var_1, self, "J_Bolt_KL" );
    playfxontag( var_1, self, "J_Bolt_KR" );
    self waittillmatch( "single anim", "activate" );
    playfxontag( var_0, self, "Tag_FX_Panel_L" );
    playfxontag( var_0, self, "Tag_FX_Panel_R" );
    self waittillmatch( "single anim", "end_front" );
    stopfxontag( var_0, self, "Tag_FX_Panel_L" );
    self waittillmatch( "single anim", "end_back" );
    stopfxontag( var_0, self, "Tag_FX_Panel_R" );
    playfxontag( common_scripts\utility::getfx( "crash_slice_device_cutting_explosions" ), self, "tag_body" );
}

skyjack_wing_explosion()
{
    var_0 = level.skyjack_plane common_scripts\utility::spawn_tag_origin();
...
skyjack_plane_contrails()
{
    var_0 = level.skyjack_plane common_scripts\utility::spawn_tag_origin();
    var_1 = level.skyjack_plane common_scripts\utility::spawn_tag_origin();
    var_0.origin = level.skyjack_plane gettagorigin( "tag_rt_wing_light_fx" );
    ...
    while ( !common_scripts\utility::flag( "skyjack_end_heavy_clouds" ) )
    {
        if ( level.fastcloudlevel > 0 )
            playfx( level._effect["wing_top_contrail"], var_1.origin, ( 1, 1, 0.1 ) );
...
treadfx_override()
{
    var_0 = "vfx/treadfx/heli_dust_snow";
    maps\_treadfx::setallvehiclefx( "script_vehicle_littlebird_sentinel", var_0 );
}
...
{
    var_0 = getent( "overlook_smoke", "targetname" );
    var_1 = var_0 common_scripts\utility::spawn_tag_origin();
    var_2 = playfxontag( level._effect["smoke_pillar_overlook"], var_1, "tag_origin" );
    common_scripts\utility::flag_wait( "lake_start" );
    common_scripts\_exploder::exploder( 8420 );
    stopfxontag( level._effect["smoke_pillar_overlook"], var_1, "tag_origin" );
}
