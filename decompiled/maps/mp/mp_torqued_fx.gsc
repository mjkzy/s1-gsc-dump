...
{
    waitframe();
    var_0 = getentarray( "window_broken", "targetname" );
...
{
    wait 0.25;
    var_0 = getglassarray( "coffee_windows_back" );

    foreach ( var_2 in var_0 )
    {
        var_3 = ( -1115.0, 478.0, 1059.0 );
        var_4 = getglassorigin( var_2 );
        var_5 = var_4 - var_3;
        destroyglass( var_2, var_5 );
    }
}
...
{
    wait 10.5;
    var_0 = getglassarray( "coffee_windows_front" );

    foreach ( var_2 in var_0 )
    {
        var_3 = ( -1124.0, -91.0, 951.0 );
        var_4 = getglassorigin( var_2 );
        var_5 = var_4 - var_3;
        destroyglass( var_2, var_5 );
    }
...
{
    wait 10.6;
    var_0 = getglassarray( "trq_windows_front" );

    foreach ( var_2 in var_0 )
    {
        var_3 = ( -602.0, 158.0, 930.0 );
        var_4 = getglassorigin( var_2 );
        var_5 = var_4 - var_3;
        destroyglass( var_2, var_5 );
    }
...
{
    wait 0.4;
    var_0 = getglassarray( "boardstore_windows_back" );

    foreach ( var_2 in var_0 )
    {
        var_3 = ( 487.0, 253.0, 1143.0 );
        var_4 = getglassorigin( var_2 );
        var_5 = var_4 - var_3;
        destroyglass( var_2, var_5 );
    }
...
{
    wait 10.9;
    var_0 = getglassarray( "boardstore_windows_front" );

    foreach ( var_2 in var_0 )
    {
        var_3 = ( 400.0, 128.0, 1060.0 );
        var_4 = getglassorigin( var_2 );
        var_5 = var_4 - var_3;
        destroyglass( var_2, var_5 );
    }
...
{
    wait 12.2;
    var_0 = getglassarray( "lodge_windows_front" );

    foreach ( var_2 in var_0 )
    {
        var_3 = ( 1566.0, 243.0, 947.0 );
        var_4 = getglassorigin( var_2 );
        var_5 = var_4 - var_3;
        destroyglass( var_2, var_5 );
    }
