...
main()
{
    ...
    maps\mp\_compass::_id_831E( "compass_map_mp_zombie_ark" );
...
zombiearkrunsharktrigger( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( maps\mp\zombies\_util::_id_508F( var_2.jumpedtheshark ) )
            continue;

        if ( !var_2 isjumping() && !var_2 ishighjumping() )
            continue;

        if ( var_1 && !maps\mp\zombies\_util::_id_508F( level.zmbsharktriggeractive ) )
            continue;
...
zombiearkrunboatsway()
{
    ...
    for (;;)
    {
        ...
        level.swayent _meth_82B5( ( var_0, 0, 0 ), var_1, var_1 * 0.5, var_1 * 0.5 );
        wait(var_1);
        level.swayent _meth_82B5( ( 0 - var_0, 0, 0 ), var_1, var_1 * 0.5, var_1 * 0.5 );
        wait(var_1);
    }
}
...
zombiearkapplyswayentforconditions()
{
    ...
    else if ( maps\mp\zombies\_util::_id_508F( self.boatswaydisabled ) )
        self _meth_8091( undefined );
    else
        self _meth_8091( level.swayent );
}
...
{
    level endon( "game_ended" );
    level.swayent = spawn( "script_model", ( 0.0, 0.0, 0.0 ) );
...
zombiearkassignzombieclientid()
{
    ...
    for ( var_0 = 0; var_0 < 4; var_0++ )
    {
        ...
        {
            if ( !isdefined( var_3 ) || _func_294( var_3 ) || var_3 == self )
                continue;
...
zmbteleportgrenadefindzonecustom( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && _func_22A( var_2, var_3 ) )
        return "cargo_bay";
}
...
killglass()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in level.players )
        {
            ...
            if ( maps\mp\zombies\_util::_id_508F( var_6.validnotmoving ) )
            {
                foreach ( var_4 in var_0 )
                {
...
spawnpatchclipfixes()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 68.0, -773.0, 1088.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 68.0, -773.0, 1344.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1168.0, -1898.0, 1456.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1168.0, -1874.0, 1456.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1168.0, -1852.0, 1456.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1168.0, -1178.0, 1456.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1168.0, -1154.0, 1456.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1168.0, -1132.0, 1456.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1634.5, 1281.0, 928.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( -1891.0, 1075.0, 824.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( -1891.0, 1075.0, 867.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -924.0, 338.0, 1267.5 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -924.0, 338.0, 1203.5 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -924.0, 338.0, 1159.5 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2532.0, 961.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2526.0, 961.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2532.0, 1025.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2526.0, 1025.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2532.0, 1089.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2526.0, 1089.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2532.0, 1147.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 264.0, 2526.0, 1147.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -74.5, 864.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -94.5, 864.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -74.5, 928.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -94.5, 928.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -74.5, 992.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -94.5, 992.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -74.5, 1056.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1434.0, -94.5, 1056.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 1088.0, 768.0, 848.0 ), ( 0.0, 225.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 1088.0, 64.0, 848.0 ), ( 0.0, 315.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 316.0, 619.0, 1030.0 ), ( 360.0, 228.599, 46.1996 ) );
}
        ...
        if ( self.currentzone == "sidebay" )
        {
            ...
            if ( self.origin[2] >= 1073 && self.origin[2] <= 1075 )
            {
                if ( self.origin[0] >= -1080 && self.origin[0] <= -970 && self.origin[1] >= -1985 && self.origin[1] <= -1975 )
                    self _meth_82F1( ( 0.0, -200.0, 0.0 ) );
            }

            if ( distancesquared( self.origin, ( -1136.0, -1982.0, 1095.0 ) ) < 144 )
                self _meth_82F1( ( 0.0, -200.0, 0.0 ) );
        }
        else if ( self.currentzone == "armory" )
        {
            if ( distancesquared( self.origin, ( -1036.0, 1057.0, 1127.0 ) ) < 144 )
            {
                var_2 = self _meth_8387();

                if ( isdefined( var_2 ) && abs( var_2.origin[2] - self.origin[2] ) > 120 )
                {
                    var_3 = vectornormalize( ( var_2.origin - self.origin ) * ( 1.0, 1.0, 0.0 ) );
                    self _meth_82F1( var_3 * 100 );
                }
            }
        }
        else if ( self.currentzone == "rearbay" )
        {
            if ( distancesquared( self.origin, ( -757.0, -1167.0, 879.0 ) ) < 144 )
                self _meth_82F1( ( -200.0, 0.0, 0.0 ) );

            if ( distancesquared( self.origin, ( -867.0, -2016.0, 1120.0 ) ) < 144 )
                self _meth_82F1( ( 200.0, 0.0, 0.0 ) );
        }
    }
}
