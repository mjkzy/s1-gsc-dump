...
main()
{
    ...
    maps\mp\_compass::_id_831E( "compass_map_mp_zombie_lab" );
...
zombiestuckspotfix01()
{
    ...
    var_0 = spawn( "trigger_radius", ( -956.0, 3572.0, 68.0 ), 0, 164, 128 );

    for (;;)
    {
        var_0 waittill( "trigger", var_1 );

        if ( isdefined( var_1 ) && !_func_294( var_1 ) && isalive( var_1 ) && isagent( var_1 ) && !isdefined( var_1.object_avoid ) && isdefined( var_1.team ) && var_1.team == level._id_32C5 )
        {
            var_1 _meth_8543( 1 );
...
zombielabfixupminimapcorners()
{
    ...
    var_0[0].origin = ( -4608.0, 6912.0, 192.0 );
    var_0[1].origin = ( 3072.0, -768.0, 128.0 );
}

zombielabpatchclip()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( 185.0, 1627.0, 136.0 ), ( 0.0, -42.7, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( 348.0, 3126.0, 180.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( 348.0, 3146.0, 180.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 1355.0, 1095.0, 170.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 988.0, 1287.0, 144.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 785.0, 1089.0, 144.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 703.0, 1373.0, 104.0 ), ( 0.0, -45.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( -1009.0, 3372.0, 253.0 ), ( -5.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 1094.5, 3422.5, 392.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -571.5, 2502.5, 192.0 ), ( 0.0, 45.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 878.0, 1988.5, 324.0 ), ( 0.0, 90.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 1586.5, 1152.0, 336.0 ), ( 5.0, 45.0, 0.0 ) );
...
zombielabpatchshove( var_0, var_1 )
{
    if ( var_0 )
    {
        if ( self.currentzone == "military" && distancesquared( self.origin, ( -1845.12, 2704.0, 267.125 ) ) < 16 )
            self _meth_82F1( ( 100.0, 0.0, 0.0 ) );
    ...
    else if ( var_1 )
    {
        ...
        {
            var_3 = ( 112.0, 1543.0, 272.0 );
            var_4 = vectornormalize( ( self.origin - var_3 ) * ( 1.0, 1.0, 0.0 ) );
        ...
        else if ( self.currentzone == "experimentation" && distancesquared( self.origin, ( 265.649, 3985.21, 291.625 ) ) < 64 )
        {
            ...
            if ( isdefined( var_2 ) )
            {
                var_5 = vectornormalize( ( var_2.origin - self.origin ) * ( 1.0, 1.0, 0.0 ) );
...
biochamber()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( var_2 maps\mp\_movers::_id_7A53() )
            var_2 connectpaths();

        var_2 moveto( var_2.origin + ( 0.0, 0.0, 132.0 ), 2 );
    }

    foreach ( var_6 in var_4 )
    {
        if ( var_6 maps\mp\_movers::_id_7A53() )
            var_6 connectpaths();

        var_6 moveto( var_6.origin - ( 0.0, 0.0, 132.0 ), 2 );
    }
...
playexosuitvoattractor()
{
    ...
    for (;;)
    {
        ...
        {
            if ( maps\mp\zombies\_util::_id_508F( var_6.exosuitonline ) )
                continue;
        ...
        if ( isplayer( var_0 ) )
        {
            ...
            foreach ( var_3 in var_1 )
            {
                ...
                if ( var_4 < 100 )
                {
                    ...
                    if ( isdefined( var_5 ) )
                    {
                        var_6 = vectornormalize( ( var_5.origin - var_0.origin ) * ( 1.0, 1.0, 0.0 ) );
...
{
    if ( maps\mp\zombies\_util::_id_508F( level.incinerator_active ) )
    {
