...
gator_collision_attach( var_0, var_1 )
{
    ...
    var_0.angles = self.angles + ( 0.0, 90.0, 0.0 );
    ...
    if ( var_1 )
    {
        ...
        var_5 linkto( self, var_2, ( 14.0, -20.0, -7.0 ), ( 0.0, 0.0, 0.0 ) );
...
{
    if ( isdefined( var_0._id_8C1A ) && isdefined( var_0._id_8B2C ) )
    {
...
arm_debug_draw()
{
    ...
    {
        thread maps\mp\_utility::drawsphere( self.origin, 16, 1, ( 1.0, 0.0, 0.0 ) );
        wait 0.1;
    }
}
...
trap_gator_gib_death()
{
    ...
    level waittill( "gator_killed" );
    self hide();
    playfx( common_scripts\utility::getfx( "dlc_gator_death" ), var_0.origin + ( 0.0, 0.0, 32.0 ) );
...
trap_gator_radius_damage( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( isplayer( var_3 ) )
        {
            ...
            continue;
        else if ( isdefined( var_3._id_001D ) && var_3._id_001D == level._id_6D6C )
            continue;
...
{
    waitframe();
    var_1 = vectornormalize( ( self.origin - var_0 ) * ( 1.0, 1.0, 0.0 ) );
