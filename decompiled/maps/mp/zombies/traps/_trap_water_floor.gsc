...
trapwaterfloorlogic()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_4 in var_2 )
        {
            ...
            if ( maps\mp\zombies\_util::_id_508F( var_4.inpain ) || maps\mp\zombies\_util::_id_508F( var_4.flungbywatertrap ) )
                continue;
        ...
        {
            if ( !isalive( var_7 ) || maps\mp\zombies\_util::_id_5175( var_7 ) )
                continue;
...
trapwaterlaunch( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_0 dodamage( var_5, var_3 + ( 0.0, 0.0, -1.0 ), self.owner, undefined, "MOD_EXPLOSIVE", "zombie_water_trap_mp" );

        if ( isalive( var_0 ) && _func_2D9( var_0 ) && !var_0 maps\mp\agents\_scripted_agent_anim_util::isstatelocked() && !var_0 maps\mp\agents\humanoid\_humanoid_util::_id_50EA() && isdefined( var_0.agent_type ) && var_0.agent_type != "zombie_dog" && var_0.agent_type != "ranged_elite_soldier" && var_0.agent_type != "ranged_elite_soldier_goliath" )
