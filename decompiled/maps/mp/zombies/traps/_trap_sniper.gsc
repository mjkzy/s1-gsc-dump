...
spawnsniperent( var_0, var_1 )
{
    ...
    var_2._id_8C1A = var_0.origin;
    var_2._id_8B2C = var_0.angles;
...
findvalidtargets( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( var_4._id_001D == level._id_6D6C || maps\mp\zombies\_util::_id_508F( var_4.inspawnanim ) )
...
sniperthink( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        playfx( common_scripts\utility::getfx( "trap_sniper_tracer" ), var_2, var_5, ( 0.0, 0.0, 1.0 ) );
...
sniper_trap_audio( var_0 )
{
    ...
    playsoundatpos( ( 2508.0, -514.0, 555.0 ), "sniper_servo_start_left" );
    playsoundatpos( ( 3779.0, -2179.0, 555.0 ), "sniper_servo_start_right" );
    var_0 waittill( "snipers_off" );
    playsoundatpos( var_0.origin, "sniper_stop_front" );
    playsoundatpos( ( 2508.0, -514.0, 555.0 ), "sniper_servo_stop_left" );
    playsoundatpos( ( 3779.0, -2179.0, 555.0 ), "sniper_servo_stop_right" );
    waitframe();
    var_1 delete();
}
