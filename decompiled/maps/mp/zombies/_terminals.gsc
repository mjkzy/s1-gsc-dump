...
getterminalhintstring( var_0 )
{
    ...
    var_4 = maps\mp\zombies\_util::_id_508F( self.terminaldisabled );
    ...
    switch ( self.itemtype )
    {
        ...
        case "host_cure":
            ...
            else if ( maps\mp\zombies\_util::_id_508F( self.terminalrunning ) )
...
getterminalsecondaryhintstring( var_0 )
{
    ...
    switch ( self.itemtype )
    {
        ...
        case "exo_tacticalArmor":
            ...
            return getitemloccost( self.itemtype );
        case "host_cure":
            if ( var_1 && !( perkterminalcoolingdown() || maps\mp\zombies\_util::_id_508F( self.terminalrunning ) ) )
            {
                self.showtokenstring = getitemcost( self.itemtype ) > 0;
                return getitemloccost( self.itemtype );
            }
...
initterminals( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        var_7._id_0255 = var_5 getterminallight();
...
atmterminalroundupdate( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( var_0[var_8].trigger._id_0014 )
                continue;
...
atmterminalthink()
{
    ...
    for (;;)
    {
        ...
        {
            var_1 maps\mp\gametypes\zombies::_id_41FB( "atm", undefined, 1 );
...
atmjackpot()
{
    ...
    for ( var_5 = 0; var_5 < 100; var_5++ )
    {
        foreach ( var_7 in level.players )
        {
            ...
            var_7 maps\mp\gametypes\zombies::_id_41FB( "atm_jackpot" );
        }
...
perkterminallighton()
{
    if ( isdefined( self._id_0255 ) )
        self._id_0255 _meth_8044( ( 0.501, 1.0, 1.0 ) );
}

perkterminallightoff()
{
    if ( isdefined( self._id_0255 ) )
        self._id_0255 _meth_8044( ( 1.0, 0.0, 0.0 ) );
}
...
{
    if ( isdefined( self._id_0255 ) && isdefined( self._id_0255.lightonintensity ) && isdefined( self._id_0255.ison ) && !self._id_0255.ison )
    {
        self._id_0255 _meth_81DF( self._id_0255.lightonintensity );
        self._id_0255.ison = 1;
    }
}

perkterminalcuremodellightoff()
{
    if ( isdefined( self._id_0255 ) && isdefined( self._id_0255.lightoffintensity ) && isdefined( self._id_0255.ison ) && self._id_0255.ison )
    {
        self._id_0255 _meth_81DF( self._id_0255.lightoffintensity );
        self._id_0255.ison = 0;
    }
}
...
perkterminalupdatehostcure()
{
    ...
    if ( isdefined( self.curemodel ) && isdefined( self.curemodel.target ) )
    {
        ...
        {
            self.curemodel._id_0255 = var_0;
            self.curemodel._id_0255.lightonintensity = self.curemodel._id_0255 _meth_81DE();
            self.curemodel._id_0255.lightoffintensity = 0.1;
            self.curemodel._id_0255.ison = 1;
...
perkterminalupdatehostcureicon()
{
    ...
    for (;;)
    {
        ...
        if ( maps\mp\zombies\_util::_id_508F( self.terminaldeactivated ) )
            continue;
