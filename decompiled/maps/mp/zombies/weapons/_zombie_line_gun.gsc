...
init()
{
    ...
    level.linegun._id_0103 = "iw5_linegundamagezm_mp";
    level.linegun._id_5A2D = 5000;
    level.linegun._id_5F71 = 450;
    level.linegun.startoffset = ( 30.0, 0.0, 0.0 );
    level.linegun.hipfireangles = ( 3.0, 3.0, 20.0 );
    level.linegun.damage = 1200;
    level.linegun._id_2673 = 0;
    ...
    level.damageweapontoweapon[level.linegun._id_0103] = level.linegun.name;
...
firelinegun()
{
    ...
    var_10 = var_8 + var_7 * level.linegun._id_5A2D;
    var_11 = var_8;
    var_12 = undefined;
    var_13 = self;
    var_14 = 1;
    ...
    while ( var_15 < 3 )
    {
        ...
        if ( isdefined( var_12["glass"] ) )
        {
            ...
            var_17 = var_16 / level.linegun._id_5F71;
            thread lineguntouchglass( var_12["glass"], var_6, var_17 );
            continue;
        }

        var_18 = var_12["entity"];
        var_19 = isdefined( var_18 ) && maps\mp\zombies\_util::_id_508F( var_18.linegunignore );
    ...
    var_22 = var_20 / level.linegun._id_5F71;
...
linegundamage( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_6 maps\mp\agents\humanoid\_humanoid_util::_id_50EA() )
    ...
    foreach ( var_13 in var_4 )
    {
        ...
        if ( distancesquared( var_15, var_17 ) > squared( level.linegun._id_5F71 / 20 ) )
            continue;
    ...
    foreach ( var_13 in var_3 )
    {
        ...
        var_13 dodamage( level.linegun.damage, var_17, var_2, var_2, "MOD_RIFLE_BULLET", level.linegun._id_0103, var_24 );
