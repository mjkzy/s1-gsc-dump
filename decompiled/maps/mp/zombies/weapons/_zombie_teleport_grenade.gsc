...
doteleport( var_0, var_1 )
{
    ...
    if ( maps\mp\zombies\_util::gameflagexists( "sq_plinko" ) && maps\mp\_utility::gameflag( "sq_plinko" ) && isdefined( var_3 ) && isdefined( var_3.script_noteworthy ) && issubstr( var_3.script_noteworthy, "gate_" ) )
        return;
    else if ( isdefined( var_3 ) && maps\mp\zombies\_util::_id_508F( var_3.noteleportgrenade ) )
        return;

    if ( !isdefined( self ) || maps\mp\zombies\_util::_id_5175( self ) || !isalive( self ) )
        return;
...
playerfixgoingunderwater()
{
    if ( isdefined( self.underwatermotiontype ) )
    {
        ...
        playfx( level._effect["water_splash_emerge"], self.origin, anglestoforward( ( 0, self.angles[1], 0 ) + ( 270.0, 180.0, 0.0 ) ) );

        if ( maps\mp\zombies\_util::_id_508F( self._id_519C ) )
        {
            self stopshellshock();
...
{
    if ( !isdefined( var_0 ) || !isagent( var_0 ) || !isalive( var_0 ) || !isdefined( var_0.team ) || var_0.team != level._id_32C5 || !isdefined( var_0.agent_type ) )
        return;
...
teleporttrace( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in level._id_655A )
    {
        var_6 = var_3 * 2;
        var_7 = var_6 * var_6;
