...
trap_init()
{
    if ( isdefined( self._id_7977 ) )
        self.cost = self._id_7977;
    else
        self.cost = 500;
...
trap_laser_move( var_0 )
{
    ...
    var_1 = 60;
    var_2 = 15;
    var_0.origin = var_0._id_8C1A;
    var_0.angles = var_0._id_8B2C;
    var_3 = 0;
...
trap_damage_trigger_watch( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0._id_7977 ) )
        var_5 *= var_0._id_7977;

    var_6 = 20;

    if ( isdefined( var_0._id_7977 ) )
        var_6 /= var_0._id_7977;

    if ( level.currentgen )
    {
        if ( isdefined( var_0._id_7A71 ) )
        {
            var_6 *= var_0._id_7A71;
            var_5 = int( var_5 / var_0._id_7A71 );
        }
    }
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_9 ) )
        {
            ...
            if ( isdefined( level.modplayertrapdmg ) && isdefined( var_0._id_7977 ) )
                var_9.nexttrapdamage = gettime() + 200 * var_0._id_7977;

            var_9 dodamage( var_6, var_9.origin, undefined, undefined, "MOD_TRIGGER_HURT" );
            continue;
        }

        if ( isdefined( var_9._id_001D ) && var_9._id_001D == level._id_6D6C )
        {
            if ( isdefined( var_0.script_parameters ) && var_0.script_parameters == "no_player_damage" )
                continue;
...
trap_distraction( var_0 )
{
    for (;;)
    {
        self waittill( "active" );
        var_1 = spawn( "script_model", var_0.origin );
        var_1._id_4414 = var_1.origin;
        var_1.team = level._id_6D6C;

        if ( isdefined( var_0._id_7977 ) )
            var_1.maxcount = var_0._id_7977;
...
audio_trap_fx( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && soundexists( var_3 ) )
    {
        if ( isdefined( var_1 ) && maps\mp\zombies\_util::getzombieslevelnum() > 2 )
            ...
            maps\mp\_audio::_id_8730( var_3, var_2 );
    }
...
trap_zomboni( var_0 )
{
    ...
    var_1 _meth_8139( level._id_6D6C );
    ...
    foreach ( var_17 in var_15 )
    {
        ...
        {
            case "clip":
                var_17._id_9A52 = ::trap_zomboni_unresolved_collision;
                var_17.zomboni = var_1;
                var_17.noturretplacement = 1;
                var_1._id_1F96 = var_17;
                var_17 linkto( var_1 );
                continue;
            case "mantle":
                var_1.mantle = var_17;
            ...
            case "door":
                ...
                var_17.open_origin = var_17.close_origin + ( 0.0, 0.0, 60.0 );
                var_1._id_2D68[var_1._id_2D68.size] = var_17;
                continue;
            default:
                continue;
        }
...
{
    var_2 = [];
    var_3 = [ ( -16.0, 16.0, 56.0 ), ( 0.0, 16.0, 56.0 ), ( 18.0, 16.0, 56.0 ), ( -16.0, -22.0, 56.0 ), ( 0.0, -22.0, 56.0 ), ( 18.0, -22.0, 56.0 ), ( -16.0, -60.0, 56.0 ), ( 0.0, -60.0, 56.0 ), ( 18.0, -60.0, 56.0 ) ];
    ...
    {
        var_8 = spawnstruct();
        var_8.origin = var_5 + rotatevector( var_7, var_0.angles + ( 0.0, -90.0, 0.0 ) );
...
{
    self._id_9A55 = trap_zomboni_get_unresolved_collision_locs( self.zomboni, var_0 );
...
trap_zomboni_attack_ent_debug( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( !maps\mp\zombies\_util::_id_508F( level.trap_zomboni_attack_ent_debug ) )
            continue;
...
trap_zomboni_stop( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_3 in level.players )
        {
            ...
            if ( isdefined( var_4 ) && var_4 == var_0._id_1F96 )
            {
                var_1 = 1;
                break;
            }
...
trap_zomboni_zombies_attack( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in level.characters )
        {
            ...
            if ( var_5 maps\mp\agents\humanoid\_humanoid_util::_id_50EA() )
                continue;

            if ( !isdefined( var_5._id_0143 ) )
                continue;

            if ( var_5._id_0143 != var_0 )
            {
                if ( !isplayer( var_5._id_0143 ) )
                    continue;

                if ( !trap_zomboni_is_player_on_zomboni( var_5._id_0143, var_0 ) )
                    continue;
            }
    ...
    switch ( var_0 )
    {
        case "hit":
            ...
            foreach ( var_6 in level.players )
            {
                ...
                if ( isdefined( var_7 ) && var_7 == self.zomboni._id_1F96 )
                {
            ...
            foreach ( var_6 in var_4 )
            {
                ...
                if ( isdefined( self._id_5B83 ) )
                    var_12 = self._id_5B83;

                if ( isalive( var_6 ) )
                    maps\mp\agents\humanoid\_humanoid_melee::_id_2CF2( var_6, var_12, "MOD_IMPACT" );
            }
...
trap_zomboni_notetracks( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            case "door_open":
                foreach ( var_3 in var_0._id_2D68 )
...
trap_zomboni_animated_distraction( var_0, var_1 )
{
    var_2 = spawnstruct();
    var_2.origin = var_0;
    var_2._id_4414 = var_0;
    var_2.team = level._id_6D6C;
...
trap_zomboni_play_churn_fx( var_0 )
{
    ...
    if ( !maps\mp\zombies\_util::_id_508F( var_0.churn_fx ) )
...
{
    if ( maps\mp\zombies\_util::_id_508F( var_1.zomboni_death ) )
        return 1;
...
trap_zomboni_zombie_death_notetracks( var_0, var_1, var_2, var_3 )
{
    switch ( var_0 )
    {
        case "remove_head":
            ...
            maps\mp\zombies\_mutators::mutilate( self.missingbodyparts | var_4, 1, 1, ( 0.0, 0.0, 1.0 ), 0 );
            break;
        case "remove_arms":
            ...
            maps\mp\zombies\_mutators::mutilate( self.missingbodyparts | var_7, 1, 1, ( 0.0, 0.0, 1.0 ), 0 );
            break;
        case "remove_legs":
            ...
            maps\mp\zombies\_mutators::mutilate( self.missingbodyparts | var_10, 1, 1, ( 0.0, 0.0, 1.0 ), 0 );
            break;
        default:
            break;
    }
...
trap_zomboni_process_path( var_0, var_1 )
{
    ...
    while ( isdefined( var_1 ) )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            switch ( var_9.script_noteworthy )
            {
                case "door":
                    ...
                    var_9.open_origin = var_9.close_origin + ( 0.0, 0.0, 60.0 );
                    continue;
                case "distraction":
                    var_9._id_0014 = 0;
                    continue;
        ...
        var_0._id_66C9[var_0._id_66C9.size] = var_1;

        if ( isdefined( var_1.script_noteworthy ) )
        {
            var_1._id_6173 = strtok( var_1.script_noteworthy, "," );
            var_0.notify_path_nodes[var_0.notify_path_nodes.size] = var_1;

            foreach ( var_13 in var_1._id_6173 )
            {
                switch ( var_13 )
                {
                    case "door_close":
...
trap_zomboni_path_notify( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_3 in var_1._id_6173 )
        {
            switch ( var_3 )
            {
                case "door_open":
...
trap_zomboni_distraction( var_0, var_1 )
{
    ...
    self._id_4414 = self.origin;
    self.team = level._id_6D6C;
