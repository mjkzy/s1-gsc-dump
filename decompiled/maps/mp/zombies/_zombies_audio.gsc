...
player_movement_tracking()
{
    ...
    for (;;)
    {
        ...
        if ( !var_0 && maps\mp\zombies\_util::_id_508F( self.exosuitonline ) && self ishighjumping() )
        {
            wait 0.2;
        ...
        else if ( !var_1 && maps\mp\zombies\_util::_id_508F( self.exosuitonline ) && self ishighjumping() && self getvelocity()[2] >= 0 )
        {
            var_3 = self geteye();
...
player_zone_tracking()
{
    ...
    for (;;)
    {
        ...
        if ( var_1.size > 0 )
        {
            ...
            {
                if ( isdefined( var_2.power_switch ) && !common_scripts\utility::flag( var_2.power_switch._id_79CE ) && ( !isdefined( var_2.nextpoweroffvotime ) || gettime() > var_2.nextpoweroffvotime ) )
                {
                    var_0 = var_2;
...
zombie_behind_vox()
{
    ...
    for (;;)
    {
        ...
        {
            if ( !isdefined( var_1[var_3] ) || !isdefined( var_1[var_3].agent_type ) || !isdefined( var_1[var_3]._id_0143 ) || var_1[var_3]._id_0143 != self )
                continue;
            ...
            {
                var_6 = _id_4174( var_1[var_3].origin );
...
{
    var_1 = var_0;
    var_2 = self.angles[1] - _id_416E( var_1 );
...
oh_shit_vox()
{
    ...
    for (;;)
    {
        ...
        for ( var_9 = 0; var_9 < var_6.size; var_9++ )
        {
            ...
            var_12 = isdefined( var_10._id_0143 ) && var_10._id_0143 == self || !isdefined( var_10._id_0143 );
...
create_and_play_dialog( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( maps\mp\zombies\_util::_id_508F( self.dontspeak ) )
        return 0;

    if ( maps\mp\zombies\_util::isplayerinfected( self ) && var_1 != "infected" && var_1 != "sq" )
        return 0;

    if ( !isdefined( self._id_51B0 ) )
        self._id_51B0 = 0;

    if ( maps\mp\zombies\_util::_id_508F( self._id_51B0 ) )
        return 0;
    ...
    if ( !isdefined( level.vox.speaker[self.zmbvoxid]._id_09D6[var_0] ) || !isdefined( level.vox.speaker[self.zmbvoxid]._id_09D6[var_0][var_1] ) )
        return 0;
    ...
    var_8 = level.vox.speaker[self.zmbvoxid]._id_09D6[var_0][var_1];

    if ( isplayer( self ) || maps\mp\zombies\_util::_id_508F( self.fakeplayer ) )
    {
        if ( self.sessionstate != "playing" )
            return 0;

        if ( maps\mp\zombies\_util::_id_5175( self ) && var_1 != "revive_down" && var_1 != "revive_up" && var_1 != "bonus_line_over" )
            return 0;
...
{
    return arenearbyspeakersactive() && !maps\mp\zombies\_util::_id_508F( self.ignorenearbyspkrs ) && var_0 != "global_priority" && var_0 != "exert" && var_0 != "conversation" && var_0 != "ignore_nearby" && var_0 != "sq";
}
...
player_stop_speaking()
{
    ...
    if ( maps\mp\zombies\_util::_id_508F( self._id_51B0 ) && isdefined( self.speakingline ) )
    {
...
player_zombie_kill_vox( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !isdefined( var_3 ) || maps\mp\zombies\_util::_id_508F( self.force_wait_on_kill_line ) )
        return;
...
playertryzombiekillvo( var_0, var_1, var_2, var_3 )
{
    ...
    if ( maps\mp\zombies\_util::_id_508F( var_3.dismember_crawl ) && create_and_play_dialog( var_4, "crawler" ) )
        return "crawler";
...
player_hurt( var_0, var_1, var_2 )
{
    ...
    else if ( isdefined( var_0 ) && isai( var_0 ) )
    {
        ...
        if ( var_1 < self.health )
        {
            ...
            if ( maps\mp\zombies\_util::_id_508F( var_0.dismember_crawl ) )
...
player_track_ammo_count()
{
    ...
    for (;;)
    {
        ...
        if ( !playerammolow( var_2 ) || maps\mp\zombies\_util::_id_5175( self ) )
            continue;
...
playerammolow( var_0 )
{
    ...
    else if ( maps\mp\zombies\_util::isrippedturretweapon( var_0 ) && maps\mp\killstreaks\_rippedturret::_id_6CBC() )
    {
        var_2 = maps\mp\killstreaks\_rippedturret::_id_6CAB();
        var_3 = maps\mp\killstreaks\_rippedturret::_id_3EEE( var_0 );
        return var_2 / var_3 < 0.05;
    }
    else
...
playerammoout()
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( maps\mp\zombies\_util::isrippedturretweapon( var_3 ) && maps\mp\killstreaks\_rippedturret::_id_6CBC() )
        {
            var_4 = maps\mp\killstreaks\_rippedturret::_id_6CAB();
...
arenearbyspeakersactive()
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( isplayer( var_5 ) )
        {
            if ( var_5.sessionstate != "playing" || maps\mp\zombies\_util::_id_5175( var_5 ) )
                continue;
        }
        else
        {
        ...
        if ( maps\mp\zombies\_util::_id_508F( var_5._id_51B0 ) && !maps\mp\zombies\_util::_id_508F( var_5.ignorenearbyspkrs ) )
        {
...
zmbvoxadd( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !isdefined( self.speaker[var_0]._id_09D6[var_1] ) )
        self.speaker[var_0]._id_09D6[var_1] = [];

    self.speaker[var_0]._id_09D6[var_1][var_2] = var_3;
...
playwaveintermissiondialog()
{
    if ( level.players.size == 1 || !isdefined( level.vox.speaker["player"]._id_09D6["conversation"] ) )
        return 0;

    foreach ( var_1 in level.zmwaveintermissiondialog )
    {
        if ( dialogcanplay( var_1 ) && _id_6A3D( var_1 ) )
        {
    ...
    foreach ( var_1 in level.zmwaveintermissiondialog )
    {
        if ( !var_1._id_0014 && createdialog( var_1 ) )
        {
            if ( _id_6A3D( var_1 ) )
            {
                dialogincrement( var_1 );
...
dialogcanplay( var_0 )
{
    return var_0._id_0014 && var_0.nextround <= level.wavecounter && dialogcharactersactive( var_0 );
}
...
_id_6A3D( var_0 )
{
    ...
    if ( !isdefined( level.vox.speaker["player"]._id_09D6["conversation"][var_1] ) )
    {
...
zmplaydamagesound( var_0 )
{
    ...
    if ( !maps\mp\zombies\_util::_id_508F( self.isexerting ) )
    {
...
playerexert( var_0 )
{
    if ( maps\mp\zombies\_util::_id_508F( self._id_51B0 ) || maps\mp\zombies\_util::_id_508F( self.isexerting ) )
        return 0;
...
{
    if ( !maps\mp\zombies\_util::_id_508F( self.force_wait_on_buy_line ) )
    {
