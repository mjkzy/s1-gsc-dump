...
add_sidequest_icon( var_0, var_1 )
{
    ...
    self.sidequest_icons[var_1] = create_icon( var_2._id_4B4D[var_1], var_3 + self.sidequest_icons.size * 34, var_4 );
}
...
display_stage_title( var_0 )
{
    ...
    var_1.y = 300;
    var_1.og_scale = 1;
    var_1.color = ( 128.0, 0.0, 0.0 );
    var_1.alpha = 0;
    var_1.fontstyle3d = "shadowedmore";
    var_1 settext( self._id_9396 );
...
{
    return maps\mp\zombies\_util::_id_508F( level.zombie_sidequest_previously_completed[var_0] );
}
