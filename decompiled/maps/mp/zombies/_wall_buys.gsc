    ...
    else
    {
        if ( isdefined( var_0._id_79CE ) )
        {
            if ( maps\mp\zombies\_util::isusetriggerprimary( var_0 ) && !maps\mp\zombies\_util::iszombieequipment( var_1 ) && isdefined( var_0.script_noteworthy ) )
            {
                var_7 = level.wallbuyweapons.size;
                level.wallbuyweapons[var_7]["baseName"] = var_0.script_noteworthy + "_mp";
                level.wallbuyweapons[var_7]["displayModel"] = var_0._id_79CE;
            }
        }
...
hasfullammo( var_0, var_1 )
{
    ...
    if ( var_0 getweaponammostock( var_1 ) < _func_1E1( var_1, var_0 ) )
        return 0;
...
magicboxmapcurrentthink( var_0 )
{
    for (;;)
    {
        ...
        self._id_24E0 show();
        self._id_24E0.origin = var_0.origin;
        common_scripts\utility::flag_waitopen( var_0.script_flag_true );
    }
}
...
removemagicboxweapon( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
        level.magicboxweapons = maps\mp\zombies\_util::_id_0CFA( level.magicboxweapons, var_1 );
}
...
magicboxthink()
{
    ...
    foreach ( var_2 in level.magicboxlocations )
    {
        ...
        if ( isdefined( var_2.modelent ) && isdefined( var_2.modelent.target ) )
        {
            ...
            {
                var_2._id_0255 = var_3;
                var_2._id_0255.lightonintensity = var_2._id_0255 _meth_81DE();
                var_2._id_0255.lightoffintensity = 0.1;
            }
        }
        ...
        if ( isdefined( var_2._id_79CE ) )
            common_scripts\utility::flag_init( var_2._id_79CE );
    }
    ...
    foreach ( var_2 in level.magicboxlocations )
    {
        if ( isdefined( var_2.script_noteworthy ) && var_2.script_noteworthy == "start_location" )
        {
            var_0 = var_2;
            var_0._id_0014 = 1;
            var_2 activatemagicboxeffects( var_2.modelent, var_2._id_0255 );
        ...
        var_2 deactivatemagicboxeffects( var_2.modelent, var_2._id_0255 );
    }
    ...
    for (;;)
    {
        ...
        if ( var_7.size > 0 )
        {
            var_0 deactivatemagicboxeffects( var_0.modelent, var_0._id_0255 );
            ...
            var_0 activatemagicboxeffects( var_0.modelent, var_0._id_0255 );
...
watchmagicboxtrigger( var_0, var_1 )
{
    ...
    var_7.angles = var_6 + ( 0.0, 90.0, 0.0 );
    ...
    for (;;)
    {
        ...
        if ( !var_12 && !isdefined( self.deactivated ) )
        {
            ...
            var_0._id_560C = var_18["baseName"];
            level.magicboxuses++;
            ...
            if ( isdefined( var_10 ) )
            {
                ...
                else if ( var_22 == "trigger" && maps\mp\_utility::isreallyalive( var_10 ) && !maps\mp\zombies\_util::_id_5175( var_10 ) )
                {
...
selectmagicboxweapon( var_0, var_1 )
{
    ...
    foreach ( var_14, var_10 in level.magicboxweapons )
    {
        ...
        if ( var_1._id_560C == var_10["baseName"] )
            var_11 = 0;
...
{
    if ( !isdefined( self.modelent ) || !isdefined( self.modelent.target ) || isdefined( self.modelent._id_0255 ) )
        return;
    ...
    {
        self.modelent._id_0255 = var_0;
        self.modelent._id_0255.lightonintensity = self.modelent._id_0255 _meth_81DE();
        self.modelent._id_0255.lightoffintensity = 0.1;
        self.modelent._id_0255.ison = 1;
    }
}

weaponlevelboxturnonlight()
{
    if ( isdefined( self.modelent._id_0255 ) && isdefined( self.modelent._id_0255.lightoffintensity ) && isdefined( self.modelent._id_0255.ison ) && !self.modelent._id_0255.ison )
    {
        self.modelent._id_0255 _meth_81DF( self.modelent._id_0255.lightonintensity );
        self.modelent._id_0255.ison = 1;
    }
}
...
weaponlevelboxturnofflight()
{
    if ( isdefined( self.modelent._id_0255 ) && isdefined( self.modelent._id_0255.lightoffintensity ) && isdefined( self.modelent._id_0255.ison ) && self.modelent._id_0255.ison )
    {
        self.modelent._id_0255 _meth_81DF( self.modelent._id_0255.lightoffintensity );
        self.modelent._id_0255.ison = 0;
    }
}
...
{
    return !isspecialweaponbox( self ) && var_0._id_A2E3[var_1]["level"] >= 20 || isspecialweaponbox( self ) && var_0._id_A2E3[var_1]["level"] >= 25;
}
...
weaponlevelboxthink()
{
    ...
    for (;;)
    {
        ...
        if ( isspecialweaponbox( self ) && var_2._id_A2E3[var_11]["level"] != 20 )
        {
        ...
        if ( level.nextgen )
        {
            ...
            var_15.angles = var_0 - ( 0.0, 90.0, 0.0 );
        ...
        if ( isspecialweaponbox( self ) )
            ...
            setweaponlevel( var_2, var_10, var_2._id_A2E3[var_11]["level"] + 1 );

        var_2 thread maps\mp\zombies\_zombies_audio::playerweaponupgrade( isspecialweaponbox( self ), var_2._id_A2E3[var_11]["level"] );
        var_2.numupgrades++;
        wait 1.2;

        if ( isdefined( var_2 ) )
        {
            if ( var_2._id_A2E3[var_11]["level"] > 19 )
            {
...
giveweaponlevelachievement( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( var_0._id_A2E3[var_4]["level"] < 20 )
            return;
    }
...
getupgradeweaponname( var_0, var_1 )
{
    ...
    if ( maps\mp\zombies\_util::haszombieweaponstate( var_0, var_3 ) && var_0._id_A2E3[var_3]["level"] > 0 )
    {
        var_4 = var_0._id_A2E3[var_3]["level"];
