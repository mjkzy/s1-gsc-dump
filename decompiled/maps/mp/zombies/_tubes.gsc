...
init()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        foreach ( var_7 in var_5 )
        {
            ...
            {
                case "door_rotate":
                    var_2._id_2D3F = var_7;
                    var_2._id_2D3F linktargets();
                    var_2._id_2D3F.closeangles = var_7.angles;
                    var_2._id_2D3F.openangles = var_7.angles + ( 0.0, 180.0, 0.0 );
                    continue;
                case "trigger":
                    var_2.trigger = var_7;
                    continue;
                case "start":
                    var_2._id_8B1A = var_7;
                    var_2.startend = common_scripts\utility::getstruct( var_2._id_8B1A.target, "targetname" );
                    var_2.endstart = common_scripts\utility::getstruct( var_2.startend.target, "targetname" );
                    var_2._id_311B = common_scripts\utility::getstruct( var_2.endstart.target, "targetname" );
                    continue;
                default:
                    continue;
            }
...
runtube()
{
    ...
    if ( isdefined( self._id_2D3F ) )
    {
        var_2 = 0.5;
        self._id_2D3F _meth_82B5( self._id_2D3F.openangles, var_2 );
        wait(var_2);
    }
    ...
    for (;;)
    {
        ...
        if ( isdefined( self._id_2D3F ) )
            self._id_2D3F _meth_82B5( self._id_2D3F.closeangles, var_0 );
        ...
        var_4 moveto( self._id_8B1A.origin, var_0 );
        wait(var_0);
        ...
        if ( isdefined( self._id_2D3F ) )
            self._id_2D3F _meth_82B5( self._id_2D3F.openangles, var_0 );
...
endtube( var_0, var_1, var_2 )
{
    ...
    var_3 = distance( var_0.origin, self._id_311B.origin ) / var_2;
    var_0 moveto( self._id_311B.origin, var_3, var_3, 0 );
    thread maps\mp\mp_zombie_h2o_aud::sndtubeend( self._id_311B.origin, var_1 );
    var_4 = anglesdelta( var_0.angles, self._id_311B.angles );

    if ( var_4 > 0 )
        var_0 _meth_82B5( self._id_311B.angles, var_3 );
