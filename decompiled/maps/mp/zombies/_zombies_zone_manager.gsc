...
iszoneenabled( var_0 )
{
    return isdefined( level.zone_data.zones ) && isdefined( level.zone_data.zones[var_0] ) && level.zone_data.zones[var_0]._id_501B;
}
...
getzoneconnectionlength( var_0, var_1 )
{
    ...
    while ( var_2.size > 0 )
    {
        ...
        var_2 = maps\mp\zombies\_util::_id_0CFA( var_2, 0 );
        ...
        foreach ( var_7 in var_3.adjacent_zones )
        {
            ...
            if ( var_7.is_connected )
            {
                ...
                if ( var_10 >= 0 )
                    var_2 = maps\mp\zombies\_util::_id_0CFA( var_2, var_10 );
...
ispathnodeinanyzone( var_0 )
{
    foreach ( var_2 in level.zone_data.zones )
    {
        foreach ( var_4 in var_2.volumes )
        {
            ...
            if ( _func_22A( var_0.origin + ( 0.0, 0.0, 20.0 ), var_4 ) )
                return 1;
        }
    }
...
getlocationzone( var_0 )
{
    foreach ( var_2 in level.zone_data.zones )
    {
        foreach ( var_4 in var_2.volumes )
        {
            ...
            if ( _func_22A( var_0 + ( 0.0, 0.0, 20.0 ), var_4 ) )
                return var_2.zone_name;
        }
    }
...
calculaterandomspawnpoint( var_0, var_1 )
{
    ...
    for ( var_4 = []; var_2.size > 0; var_4 = [] )
    {
        ...
        var_2 = maps\mp\zombies\_util::_id_0CFA( var_2, var_5 );
