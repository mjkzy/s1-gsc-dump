...
init()
{
    level._id_0897["zombie_host"] = level._id_0897["zombie"];
    level._id_0897["zombie_host"]["think"] = level._id_0897["zombie_generic"]["think"];
    level._id_0897["zombie_host"]["spawn"] = ::spawn_zombie_host;
...
{
    self [[ level._id_0897["zombie"]["spawn"] ]]( var_0, var_1, var_2 );
