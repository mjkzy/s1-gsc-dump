...
tryuseremoteturret( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        level.turretsinworld[var_4 _meth_81B1()] = var_4;
        return 1;
    }
    else
        return 0;
...
deleteaftertime( var_0 )
{
    ...
    {
        level.turretsdeployed--;
        level.turretsinworld[self _meth_81B1()] = undefined;
        deathsoundsandfx();
        self delete();
    }
}
...
turret_setactive()
{
    ...
    if ( !isdefined( self.aiclip ) && isdefined( level.sentry_ai_clip ) )
    {
        ...
        self.aiclip _meth_80B1( "tag_origin" );
        self.aiclip _meth_8278( level.sentry_ai_clip );
        self.aiclip _meth_8446( self, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    }
    else if ( isdefined( self.aiclip ) )
        self.aiclip _meth_82BE();
...
updatedisruptorbuff( var_0 )
{
    ...
    self _meth_8051( var_0.damageperstep, self.origin, var_1, undefined, "MOD_TRIGGER_HURT", "remote_energy_turret_mp", "none" );
