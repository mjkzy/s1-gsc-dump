...
init()
{
    level._id_0897["zombie_generic"] = level._id_0897["zombie"];
    level._id_0897["zombie_generic"]["think"] = ::zombie_generic_think;
...
zombie_generic_moan()
{
    ...
    for (;;)
    {
        ...
        while ( isdefined( self._id_24C6 ) && ( distancesquared( self.origin, self._id_24C6.origin ) > 10000 && distancesquared( self.origin, self._id_24C6.origin ) <= 40000 ) )
        {
...
_id_8736( var_0, var_1, var_2 )
{
    thread _id_8737( var_0, var_1, var_2 );
}

_id_8737( var_0, var_1, var_2 )
{
