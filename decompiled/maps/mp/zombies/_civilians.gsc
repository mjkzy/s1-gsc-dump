...
init()
{
    ...
    level._id_0897["zombie_civilian"] = level._id_0897["player"];
    level._id_0897["zombie_civilian"]["onAIConnect"] = ::oncivaiconnect;
    level._id_0897["zombie_civilian"]["on_killed"] = ::oncivkilled;
    level._id_0897["zombie_civilian"]["on_damaged"] = ::oncivdamaged;
    level._id_0897["zombie_civilian"]["on_damaged_finished"] = ::oncivdamagefinished;
    level._id_0897["zombie_civilian"]["spawn"] = ::onzombiecivilianspawn;
    level._id_0897["zombie_civilian"]["think"] = ::zombiecivilianthink;
...
spawncivilian( var_0, var_1 )
{
    ...
    foreach ( var_10 in level.players )
    {
        ...
        var_8.headicon = var_8 maps\mp\_entityheadicons::setheadicon( var_10, "hud_waypoint_survivor", ( 0.0, 0.0, 16.0 ), 4, 4, undefined, undefined, undefined, 1, undefined, 0 );
    }
    ...
    {
        var_14 = maps\mp\zombies\_util::spawnscriptagent( level.civ_extract.spawnpoint, var_2, level._id_6D6C );
        ...
        var_15 = maps\mp\zombies\_util::_id_4056();
        ...
        var_14._id_5B83 = var_2._id_5B83;
...
zombiecivilianthink()
{
    ...
    var_2 = spawn( "script_model", self.targetextractpoint.origin + ( 0.0, 0.0, 2.0 ) );
...
attempttomeleeenemy()
{
    ...
    {
        self._id_24C6 = self.nearbyenemy;
        self.hastraversed = 1;
...
{
    if ( maps\mp\zombies\_util::_id_5164( var_1 ) )
        return;
