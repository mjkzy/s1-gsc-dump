...
zombies_make_objective( var_0 )
{
    ...
    objective_add( self.objid, "invisible", ( 0.0, 0.0, 0.0 ) );
...
getzombieweaponlevel( var_0, var_1 )
{
    ...
    return var_0._id_A2E3[var_2]["level"];
}
...
requestzombieagent( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_2 = maps\mp\agents\_agent_common::_id_214C( var_0, var_1 );
...
spawnbotagent( var_0, var_1, var_2 )
{
    ...
    var_3 maps\mp\agents\_agents::_id_88BC( var_0.origin, var_0.angles );
    return var_3;
}
...
spawnscriptagent( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.script_animation ) )
    {
        ...
        var_5 = isdefined( var_0._id_79F8 ) && var_0._id_79F8 == "ignoreRealign";
...
onscriptagentkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    {
        if ( self._id_02A6 == "run" || self._id_02A6 == "sprint" )
            var_9 = "death_full_body_run";
        else
            var_9 = "death_full_body_stand";
    }
    else if ( self._id_09A3 == "idle" || self._id_09A3 == "melee" )
        var_9 = "death_stand";
    else
        var_9 = "death_" + self._id_02A6;
    ...
    {
        self.bypasscorpse = 1;
        playfx( common_scripts\utility::getfx( "zombie_death_vaporize" ), self.origin + ( 0.0, 0.0, 30.0 ) );
    }
...
delayphysicsexplosionragdoll( var_0, var_1 )
{
    ...
    var_2 = var_1.origin + ( 0.0, 0.0, 30.0 );
    wait 0.1;
...
shouldimmediateragdoll()
{
    ...
    if ( !self isonground() || _id_508F( self.inairforleap ) )
        return 1;

    if ( _id_508F( self.neverimmediatelyragdoll ) )
        return 0;

    if ( isdefined( self.ragdollimmediately ) && self.ragdollimmediately )
        return 1;

    return self._id_09A3 == "traverse" || self._id_09A3 == "scripted";
}

canragdoll( var_0 )
{
    if ( _id_508F( self.noragdollondeath ) )
        return 0;
...
getragdollwaittime( var_0 )
{
    ...
    if ( self._id_09A3 == "traverse" || self._id_09A3 == "scripted" )
        return var_1;
...
shouldignoreent( var_0 )
{
    ...
    if ( _id_508F( var_0.zombiesignoreme ) && !_id_508F( self.ignorescamouflage ) )
        return 1;
    ...
    if ( _id_508F( var_0.iszomboni ) && istrapresistant() )
        return 1;
...
enemykilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    level thread maps\mp\gametypes\zombies::_id_1C67( var_1, self, var_3, var_4 );
...
setcharacteraudio( var_0, var_1 )
{
    ...
    switch ( var_0 )
    {
        ...
        case 2:
            ...
            break;
        case 3:
            if ( getzombieslevelnum() < 3 || _id_508F( var_1 ) )
            {
...
_entitytrackfx( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_5.id == var_0 && var_5.tagname == var_1 && var_5._id_0410 == var_2 )
        {
            var_3 = 1;
            break;
        }
...
startfxforlatejoiner( var_0 )
{
    ...
    if ( _id_508F( var_0.laterjoinereffects ) )
        return;
...
has_entered_game()
{
    return _id_508F( self.hastraversed );
}
...
recordmatchdataforroundend( var_0 )
{
    ...
    foreach ( var_7 in level.roundsupplydrops )
    {
        ...
        foreach ( var_10 in level._id_2385["airdrop_assault"] )
        {
...
watchtokenuseentwait( var_0 )
{
    ...
    for (;;)
    {
        if ( _id_508F( var_0.tokenbuttonpressed ) && _id_508F( self.tokenstringvisible ) && isplayeruseent( var_0, self ) && var_0 maps\mp\gametypes\zombies::hastoken( self.tokencost ) )
        {
            if ( !isdefined( var_1 ) )
            {
...
getarrayofoffscreenagentstorecycle( var_0 )
{
    ...
    foreach ( var_8 in var_0 )
    {
        ...
        if ( isdefined( var_10 ) )
        {
            ...
            {
                if ( getnodesintrigger( var_10, var_4, 1 ) )
                {
                    var_9 = 0;
                    break;
                }
...
iszombieshardmode()
{
    return _id_508F( game["start_in_zmb_hard_mode"] );
}

_id_2B16()
{
    if ( !isdefined( level._id_2B16 ) )
        level._id_2B16 = 0;
...
enablekillstreaks()
{
    if ( !isdefined( level._id_2B16 ) )
        level._id_2B16 = 0;
    else if ( level._id_2B16 > 0 )
        level._id_2B16--;
}

arekillstreaksdisabled()
{
    return isdefined( level._id_2B16 ) && level._id_2B16 > 0;
}
