...
mutatoraciddotzonespawner()
{
    ...
    for (;;)
    {
        ...
        if ( self._id_09A3 == "traverse" || !isdefined( self._id_5154 ) || isdefined( self._id_4FAA ) && self.acidpools < 10 )
            continue;

        var_0 = bullettrace( self.origin, self.origin - ( 0.0, 0.0, 32.0 ), 0, self );
        ...
        self.acidpools++;
        var_1 = spawn( "script_model", var_0["position"] + ( 0.0, 0.0, 8.0 ) );
...
mutatoracidtriggerthink( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_1 ) && !maps\mp\zombies\_util::_id_5175( var_1 ) )
        {
...
mutatoracidtriggerthink_cg( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( !maps\mp\zombies\_util::_id_5175( var_3 ) && distance( var_3.origin, var_0 ) < 48 )
            {
