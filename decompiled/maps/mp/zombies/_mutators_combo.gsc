...
mutatorcomboarmoremzkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( self.hashelmet ) && isdefined( self._id_01EA ) )
    {
        self._id_01EA unlink();
        self._id_01EA setmodel( "zombie_helmet_collision" );
        self._id_01EA _meth_82C2( self._id_01EA.origin, ( randomintrange( -5, 5 ), randomintrange( -5, 5 ), randomintrange( -5, 5 ) ) );
    }
}
...
mutatorcomboaddhelmet()
{
    ...
    var_3 linkto( self, var_0, ( -0.2, -0.45, -4.7 ), ( 0.0, 90.0, 0.0 ) );
    thread mutatorcombohelmetdetach( var_3 );
    self waittill( "death" );
    self.hashelmet = undefined;
    self._id_01EA = undefined;
...
mutatorcombohelmetdetach( var_0 )
{
    ...
    physicsexplosionsphere( var_0.origin - ( 0.0, 0.0, 2.0 ), 16, 1, 5 );
