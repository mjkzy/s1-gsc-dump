...
main()
{
    ...
    maps\mp\_compass::_id_831E( "compass_map_mp_torqued" );
    ...
    _id_A75F::init();
    level._id_65AB = "mp_torqued_osp";
    level._id_65A9 = "mp_torqued_osp";
    level._id_A197 = "mp_torqued_osp";
    level._id_A18C = "mp_torqued_osp";
    level._id_9F74 = "mp_torqued_osp";
    level._id_9F73 = "mp_torqued_osp";
    ...
    level._id_6573 = ::torquedpaladinoverrides;
...
scriptkilltrigger()
{
    thread spawnkilltriggerthink( ( -876.0, -2008.0, 641.379 ), 128, 128 );
}
...
movewarbirdspawn()
{
    var_0 = ( 2372.0, 612.0, 2164.0 );
    var_1 = ( 2152.0, 634.0, 2164.0 );
...
torqued_avalanche_setup()
{
    ...
    level thread maps\mp\_dynamic_events::_id_2FE6( ::torqued_avalanche_start, ::torqued_avalanche_reset, ::torqued_avalanche_end );
...
torqued_show_solid()
{
    ...
    {
        if ( isdefined( self._id_659D ) )
        {
            self dontinterpolate();
            self.origin = self._id_659D;
        }
    }
...
torqued_hide_notsolid()
{
    if ( !isdefined( self.oldcontents ) )
    {
        ...
        self dontinterpolate();
        self._id_659D = self.origin;
        self.origin += ( 0.0, 0.0, -2000.0 );
    }
...
hordeavalanchekilleverything( var_0 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        foreach ( var_15 in level._id_49C1 )
        {
        ...
        if ( isdefined( level.carepackages ) )
        {
            foreach ( var_18 in level.carepackages )
            {
                ...
                {
                    if ( var_18._id_2383 == "juggernaut" )
                        var_18 maps\mp\killstreaks\_juggernaut::_id_2851();
                    else if ( !isdefined( var_18.en_route_in_air ) || !var_18.en_route_in_air )
                        var_18 maps\mp\killstreaks\_airdrop::_id_2847();
...
merry_go_round_setup()
{
    ...
    for (;;)
    {
        var_0 rotatevelocity( ( 0.0, -10.0, 0.0 ), var_4 );
        wait(var_4);
    }
}
...
aud_avalanche_setup()
{
    ...
    thread maps\mp\_audio::_id_8730( "mp_torqued_ty_initial_hit", ( 532.0, 2030.0, 1881.0 ) );
    var_0 = thread maps\mp\_audio::_id_873B( "mp_torqued_rumble_lp", ( 532.0, 2030.0, 1881.0 ), "aud_avalanche_stop" );
    var_1 = thread maps\mp\_audio::_id_8730( "mp_torqued_avalance_main", ( 532.0, 2030.0, 1881.0 ) );
    var_2 = thread maps\mp\_audio::_id_8730( "mp_torqued_avalanche_bg", ( 532.0, 2030.0, 1881.0 ) );
    ...
    level waittill( "avalanche_stop" );
    thread maps\mp\_audio::_id_8730( "mp_torqued_avalanche_wall_crash_01", ( 532.0, 2030.0, 1881.0 ) );
    thread maps\mp\_audio::_id_8730( "mp_torqued_avalanche_rockslide_02", ( 532.0, 2030.0, 1881.0 ) );
...
{
    var_0 = 2;
    thread maps\mp\_audio::_id_8730( "mp_torqued_avalance_alarm", ( 0.0, 0.0, 0.0 ) );
    wait(var_0);
    thread maps\mp\_audio::_id_8730( "mp_torqued_avalance_alarm", ( 0.0, 0.0, 0.0 ) );
    wait(var_0);
    thread maps\mp\_audio::_id_8730( "mp_torqued_avalance_alarm", ( 0.0, 0.0, 0.0 ) );
...
treetipstuck_makeskypillar()
{
    ...
    {
        maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( -987, 1495, var_0 ), ( 0.0, 0.0, 0.0 ) );
        var_0 += 32;
    }
}
...
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( -1311.0, -1075.0, 1016.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( -1311.0, -1203.0, 1016.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( -1319.0, -1038.0, 968.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( -1319.0, -1070.0, 968.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( -1319.0, -1102.0, 968.0 ), ( 0.0, 0.0, 0.0 ) );
}

cornercollisionspawngifts()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1449.26, -527.981, 908.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1449.26, -527.981, 868.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1436.74, -518.019, 868.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1436.74, -518.019, 908.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -1449.26, -527.981, 908.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -1449.26, -527.981, 868.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -1436.74, -518.019, 868.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -1436.74, -518.019, 908.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_64_64", ( -1449.26, -527.981, 908.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_64_64", ( -1449.26, -527.981, 868.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_64_64", ( -1436.74, -518.019, 868.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_64_64", ( -1436.74, -518.019, 908.0 ), ( 0.0, 38.4979, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1444.13, -534.904, 956.81 ), ( 0.0, 38.4979, 26.2994 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1431.03, -524.403, 956.814 ), ( 0.0, 38.4979, 26.2994 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1432.14, -549.74, 1021.44 ), ( 0.0, 38.4979, 26.2994 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -1419.04, -539.239, 1021.43 ), ( 0.0, 38.4979, 26.2994 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -1444.13, -534.904, 956.81 ), ( 0.0, 38.4979, 26.2994 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -1431.03, -524.403, 956.814 ), ( 0.0, 38.4979, 26.2994 ) );
    spawngift( "trq_holiday_gift_boxes_01_snow_red", ( -1452.0, -512.0, 834.0 ), ( 0.0, 37.9999, 0.0 ) );
    spawngift( "trq_holiday_gift_boxes_01_snow", ( -1449.0, -515.0, 870.0 ), ( 360.0, 37.9998, -3.80005 ) );
    spawngift( "trq_holiday_gift_boxes_01_snow_red", ( -1449.0, -515.0, 905.0 ), ( 360.0, 37.9998, -3.80005 ) );

    if ( level.nextgen )
    {
        spawngift( "trq_holiday_gift_boxes_sm_02_red_snow", ( -1449.43, -526.952, 942.026 ), ( 0.0, 37.0, 0.0 ) );
        spawngift( "trq_holiday_gift_boxes_sm_02_red_snow", ( -1449.4, -527.0, 956.0 ), ( 0.0, 37.0, 0.0 ) );
        spawngift( "trq_holiday_gift_boxes_sm_02_blue_snow", ( -1447.4, -507.0, 942.0 ), ( 0.0, 217.3, 0.0 ) );
    }
    else
    {
        spawngift( "trq_holiday_gift_boxes_sm_02", ( -1449.43, -526.952, 942.026 ), ( 0.0, 37.0, 0.0 ) );
        spawngift( "trq_holiday_gift_boxes_sm_02", ( -1449.4, -527.0, 956.0 ), ( 0.0, 37.0, 0.0 ) );
        spawngift( "trq_holiday_gift_boxes_sm_02", ( -1447.4, -507.0, 942.0 ), ( 0.0, 217.3, 0.0 ) );
    }
}
...
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1051.0, -1496.0, 724.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1051.0, -1591.0, 724.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -931.0, -1567.0, 746.0 ), ( 0.0, 180.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( -931.0, -1520.0, 746.0 ), ( 0.0, 180.0, 0.0 ) );
}

playerweirdjitteravalanchearea()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -336.0, 742.0, 1014.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -336.0, 998.0, 1014.0 ), ( 90.0, 0.0, 0.0 ) );
}

nosightclipwall()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_nosight_16_128_128", ( -1082.0, -534.0, 932.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_nosight_16_128_128", ( -1210.0, -534.0, 932.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_nosight_16_128_128", ( -1338.0, -534.0, 932.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_128_128", ( -1082.0, -534.0, 932.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_128_128", ( -1210.0, -534.0, 932.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_128_128", ( -1338.0, -534.0, 932.0 ), ( 0.0, 270.0, 0.0 ) );
}

vehicleclipdoors()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_256_256", ( 963.0, 482.0, 986.0 ), ( 0.0, 299.2, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_256_256", ( -2078.0, 572.0, 960.0 ), ( 0.0, 351.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_256_256", ( -2118.0, 319.0, 960.0 ), ( 0.0, 351.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_128_128", ( 980.0, 498.0, 1044.0 ), ( 0.0, 300.0, 0.0 ) );
}

addpropforbadtreeclip()
{
    var_0 = spawn( "script_model", ( -594.0, 547.0, 1061.0 ) );
    var_0 setmodel( "trq_holiday_gift_boxes_01_snow_red" );
    maps\mp\_utility::spawnpatchclip( "patchclip_nosight_32_32_32", ( -594.0, 549.0, 1077.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_64_64", ( -604.0, 533.0, 1064.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_64_64", ( -585.0, 533.0, 1064.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_item_16_64_64", ( -595.0, 533.0, 1064.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_32_32_32", ( -594.0, 549.0, 1077.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_32_32_32", ( -594.0, 549.0, 1077.0 ), ( 0.0, 0.0, 0.0 ) );
}

playerclipoverhang()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1460.0, -658.0, 1312.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1460.0, -882.0, 1312.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1288.0, -520.0, 1308.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1092.0, -518.0, 1308.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1348.0, -518.0, 1308.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1468.0, -638.0, 1308.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1468.0, -894.0, 1308.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( -560.0, 440.0, 1400.0 ), ( 0.0, 45.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( -640.0, 440.0, 1400.0 ), ( 0.0, 135.0, 0.0 ) );
}

playerclipsnowguard()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 112.0, -901.0, 1316.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 132.0, -820.0, 1348.0 ), ( 0.0, 315.3, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 132.0, -820.0, 1284.0 ), ( 0.0, 315.3, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 181.0, -799.0, 1348.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 181.0, -799.0, 1284.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1056.0, -520.0, 1388.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1056.0, -520.0, 1644.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1312.0, -520.0, 1388.0 ), ( 0.0, 270.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -1312.0, -520.0, 1644.0 ), ( 0.0, 270.0, 0.0 ) );
}
