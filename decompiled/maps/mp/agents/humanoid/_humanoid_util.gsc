...
validatemeleesectors( var_0 )
{
    ...
    if ( !isdefined( self.meleesectors[var_0] ) )
    {
        ...
        for ( var_1 = 0; var_1 < getnummeleesectors(); var_1++ )
        {
            ...
            self.meleesectors[var_0][var_1]._id_627A = var_1;
        }
    }
}
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        for ( var_5 = undefined; !isdefined( var_4 ) && var_3 <= 1500; var_3 += 500 )
        {
            ...
            if ( isdefined( level.nearestnodetounreachabledronesearchheight ) )
                var_6 = getnodesinradiussorted( self.distractiondrone._id_4414, var_3, var_2, level.nearestnodetounreachabledronesearchheight );
            else
                var_6 = getnodesinradiussorted( self.distractiondrone._id_4414, var_3, var_2 );
            ...
            foreach ( var_9 in var_6 )
            {
                ...
                {
                    if ( !isdefined( var_7 ) || getnodesintrigger( var_9, var_7, 1 ) )
                    {
                        var_4 = var_9;
                        break;
                    }
        ...
        for ( var_18 = var_13; var_18 != var_14; var_18 += var_15 )
        {
            ...
            if ( !isdefined( var_12 ) && gettime() - var_9.timestamp >= self.meleesectorupdatetime )
            {
                if ( isdefined( level.trycalculatesectororigin ) && isdefined( level.trycalculatesectororigin[self.agent_type] ) )
                    [[ level.trycalculatesectororigin[self.agent_type] ]]( var_9, var_4, self._id_0E47, self.radius );
                else
                    trycalculatesectororigin( var_9, var_4, self._id_0E47, self.radius );
            }
            ...
            if ( !isdefined( var_12 ) && isdefined( var_9.origin ) )
            {
                ...
                if ( !isalive( var_9.claimer ) || !isdefined( var_9.claimer._id_24C6 ) || var_9.claimer._id_24C6 != var_0 || var_9.claimer == self || var_6 < var_20 )
                {
...
trycalculatesectororigin( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_0.origin = meleesectortargetposition( var_1, var_0._id_627A, var_2 );
...
{
    return maps\mp\zombies\_util::_id_508F( self.hashumanoidexoabilities );
}
...
setup_humanoid_exo_combat()
{
    ...
    var_1 = maps\mp\zombies\_util::_id_5682( var_0, 0.35, 0.55 );
    var_2 = maps\mp\zombies\_util::_id_5682( var_0, 0.06, 0.12 );
...
withinmeleeradius()
{
    ...
    var_0 = distancesquared( self.origin, self._id_24C6.origin ) <= getmeleeradiussq();
    return var_0;
}

withinmeleeradiusbase()
{
    var_0 = distancesquared( self.origin, self._id_24C6.origin ) <= self.meleeradiusbasesq;

    if ( !var_0 && ( isplayer( self._id_24C6 ) || isagent( self._id_24C6 ) ) && isalive( self._id_24C6 ) )
    {
        var_1 = self._id_24C6 _meth_8557();

        if ( isdefined( var_1 ) && isdefined( var_1.targetname ) && var_1.targetname == "care_package" )
            var_0 = distancesquared( self.origin, self._id_24C6.origin ) <= self.meleeradiusbasesq * 4;
    }

    if ( !var_0 && isplayer( self._id_24C6 ) && maps\mp\zombies\_util::_id_508F( self._id_24C6.isinexploitspot ) )
    {
