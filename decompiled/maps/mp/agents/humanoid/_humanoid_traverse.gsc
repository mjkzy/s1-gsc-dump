...
_id_2D85()
{
    ...
    if ( var_0._id_0047 == "bot_walk_forward" )
    {
        ...
        maps\mp\agents\_scripted_agent_anim_util::_id_6A24( self._id_02A6, randomint( self _meth_83D6( self._id_02A6 ) ), self.moveratescale, var_3 );
    }
    else
    {
        var_6 = undefined;
        var_6 = level.zombietraverseanims[self._id_8A3A][var_0._id_0047];
        ...
        if ( isdefined( level.zombietraverseanimchance[self._id_8A3A][var_6] ) )
        {
            var_8 = randomfloat( 1.0 );

            for ( var_9 = 0; var_9 < level.zombietraverseanimchance[self._id_8A3A][var_6].size; var_9++ )
            {
                var_10 = level.zombietraverseanimchance[self._id_8A3A][var_6][var_9];
        ...
        var_4 = ( var_2[0], var_2[1], 0 );
        var_5 = vectortoangles( var_4 );
        var_11 = issubstr( var_0._id_0047, "jump_across" );
        var_12 = ( var_6 == "traverse_boost" || issubstr( var_0._id_0047, "boost_jump_across" ) ) && self._id_8A3A == "humanoid";
        ...
        var_16 = maps\mp\agents\_scripted_agent_anim_util::_id_3EFB( var_2, var_15 );
        ...
        if ( maps\mp\zombies\_util::getzombieslevelnum() >= 3 && var_11 && abs( var_2[2] ) < 48 )
        {
            ...
            self _meth_8395( var_16._id_A3A8, 1 );
            ...
            self _meth_8395( var_16._id_A3A8, 0 );
        ...
        else if ( var_2[2] > 16 )
        {
            if ( var_15[2] > 0 )
            {
                if ( var_12 )
                {
                    self _meth_8395( var_16._id_A3A8, var_16.z );
                ...
                else
                {
                    ...
                    if ( var_18.size > 0 )
                    {
                        ...
                        if ( !var_17 && length2dsquared( var_27 ) < 0.5625 * length2dsquared( var_28 ) )
                            var_16._id_A3A8 = 0.75;

                        var_29 = var_15 - var_26;
                        var_30 = ( var_29[0] * var_16._id_A3A8, var_29[1] * var_16._id_A3A8, var_29[2] * var_16.z );
                        ...
                        var_36 = var_16;
                        var_16 = maps\mp\agents\_scripted_agent_anim_util::_id_3EFB( var_35, var_34, 1 );
...
traverse_lerp_z_over_time( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        var_6 = maps\mp\zombies\_util::_id_5682( var_5, var_0, var_1 );
