...
main()
{
    ...
    maps\mp\_compass::_id_831E( "compass_map_mp_liberty" );
    thread _id_830B();
    ...
    game["defenders"] = "axis";
    level._id_65AB = "mp_liberty_osp";
    level._id_65A9 = "mp_liberty_osp";
    level._id_2F3B = "mp_liberty_drone";
    level._id_2F12 = "mp_liberty_drone";
    level._id_A197 = "mp_liberty_warbird";
    level._id_A18C = "mp_liberty_warbird";
...
_id_2FEB()
{
    ...
    playsoundatpos( ( 0.0, 0.0, 0.0 ), "mp_liberty_alarm_start" );
    wait 6;
    ...
    physicsjolt( var_2.origin, 512, 256, ( 0.0, -0.4, 0.1 ) );
    ...
    level thread common_scripts\_exploder::_id_06F5( 2 );
    var_0 _meth_82B5( ( 0.0, 0.0, -80.0 ), 15, 4, 4 );
    var_1 _meth_82B5( ( 0.0, 0.0, 80.0 ), 15, 4, 4 );
    ...
    for ( var_10 = 0; var_10 < var_9.size; var_10++ )
    {
        if ( isdefined( var_9[var_10].targetname ) && var_9[var_10].targetname == "care_package" )
            var_9[var_10] maps\mp\killstreaks\_airdrop::_id_2847();

        if ( isdefined( var_9[var_10].classname ) && var_9[var_10].classname == "misc_turret" )
            var_9[var_10] notify( "death" );
    }

    thread maps\mp\_audio::_id_8730( "mp_lib_monkey_doors_full", var_0.origin );
    thread maps\mp\_audio::_id_8730( "mp_lib_monkey_doors_bed", var_0.origin );
    thread maps\mp\_audio::_id_8730( "dynwarn_liberty_doors_opening", ( 216.0, 179.0, 545.0 ) );
    wait 12;
    var_11 = getent( "physicsJolt2", "targetname" );
    physicsjolt( var_11.origin, 512, 256, ( 0.0, -0.4, 0.1 ) );
    maps\mp\_audio::_id_8730( "dynwarn_liberty_doors_open", ( 216.0, 179.0, 545.0 ) );
    wait 2;
}
...
_id_2FEA()
{
    ...
    var_0 = getent( "ape_door", "targetname" );
    var_1 = getent( "ape_door2", "targetname" );
    var_0 _meth_82B5( ( 0.0, 0.0, -80.0 ), 1 );
    var_1 _meth_82B5( ( 0.0, 0.0, 80.0 ), 1 );
    thread disconnectnodes();
}
...
{
    wait 240.0;
    common_scripts\utility::play_sound_in_space( "dynwarn_liberty_doors_1min", ( 216.0, 179.0, 545.0 ) );
}
...
aud_pa_system_announcements_decon()
{
    ...
    {
        wait(var_0);
        thread common_scripts\utility::play_sound_in_space( "dynwarn_liberty_decon", ( 2149.0, 28.0, 347.0 ) );
        wait 4;
    }
}
...
aud_pa_system_announcements_vessel()
{
    ...
    {
        wait(var_0);
        thread common_scripts\utility::play_sound_in_space( "dynwarn_liberty_vessel", ( -337.0, 2701.0, 427.0 ) );
        wait 7;
    }
}
...
aud_pa_system_announcements_medzone()
{
    ...
    {
        wait(var_0);
        thread common_scripts\utility::play_sound_in_space( "dynwarn_liberty_medzone", ( 286.0, -681.0, 439.0 ) );
        wait 10;
    }
}
