...
boat_explosion_stern()
{
    ...
    wait(var_0);
    start_fx_exploder();
    level thread common_scripts\_exploder::_id_06F5( 11 );
    finish_fx_exploder();
}
...
car_explosion()
{
    ...
    wait(var_0);
    start_fx_exploder();
    level thread common_scripts\_exploder::_id_06F5( 21 );
    finish_fx_exploder();
}
...
bus_explosion()
{
    ...
    wait(var_0);
    start_fx_exploder();
    level thread common_scripts\_exploder::_id_06F5( 22 );
    finish_fx_exploder();
}

_id_17F8( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 23, var_0 );
...
car_explosion_bridge()
{
    ...
    wait(var_0);
    start_fx_exploder();
    level thread common_scripts\_exploder::_id_06F5( 24 );
    finish_fx_exploder();
}
...
rock_explosion_bridge()
{
    ...
    wait(var_0);
    start_fx_exploder();
    level thread common_scripts\_exploder::_id_06F5( 25 );
    finish_fx_exploder();
}

bridge_rubble( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 31, var_0 );
}

vista_smoke( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 32, var_0 );
}

rain_splashes( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 33, var_0 );
}
...
{
    level thread common_scripts\_exploder::_id_06F5( 30 );
    wait 2;
    _func_292( 30 );
}
