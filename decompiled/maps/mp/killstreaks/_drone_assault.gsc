...
init()
{
    ...
    level.killstreakfuncs["assault_ugv"] = ::_id_98A3;
    ...
    thread maps\mp\killstreaks\_assaultdrone_ai::_id_0D47();
...
_id_3F6D( var_0 )
{
    ...
    if ( common_scripts\utility::array_contains( var_0, "mp_terrace" ) )
    {
        ...
        var_4 = maps\mp\killstreaks\_drone_common::_id_2F0A();
...
_id_82FE( var_0, var_1, var_2, var_3 )
{
    ...
    var_0.empgrenaded = 0;
    var_0._id_259B = 1.0;
    var_0 thread maps\mp\gametypes\_damage::setentitydamagecallback( var_0.maxhealth, undefined, ::_id_644C, maps\mp\killstreaks\_aerial_utility::_id_47D3, 1 );
    var_0 ghost();
    thread maps\mp\killstreaks\_drone_common::_id_2F27( var_0, var_0._id_4721 );

    if ( var_0._id_4721 )
        thread maps\mp\killstreaks\_drone_common::_id_2EFF( var_0, var_0._id_4721 );
    ...
    if ( !var_0.hasaioption )
    {
        ...
        thread maps\mp\killstreaks\_assaultdrone_ai::_id_09A1( var_0 );
    ...
    if ( !var_0._id_5FCF )
    {
        thread maps\mp\killstreaks\_drone_common::_id_6CB7( var_0, "assault_drone_exhaust", "TAG_EXHAUST_REAR", "assaultDroneHunterKiller" );
        thread maps\mp\killstreaks\_drone_common::_id_6CB7( var_0, "assault_drone_exhaust_bottom", "tag_exhaust_lt" );
        thread maps\mp\killstreaks\_drone_common::_id_6CB7( var_0, "assault_drone_exhaust_bottom", "tag_exhaust_rt" );
    }
    ...
    _id_0D55( var_0 );
    thread maps\mp\killstreaks\_drone_common::_id_9B62( var_0, common_scripts\utility::getfx( "assault_drone_marker" ) );
