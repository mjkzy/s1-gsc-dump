...
streak_init()
{
    ...
    level._id_598A = &"MP_BLACKBOX_MAP_KILLSTREAK_PICKUP";
...
setcreature()
{
    ...
    self.radar_highlight.color = ( 1.0, 0.015, 0.015 );
...
alien_mode_overdrive_on()
{
    ...
    if ( isdefined( level.ishorde ) && level.ishorde )
    {
        ...
        self.movespeedscaler = min( level._id_1E3A[var_0]["speed"] + 0.25, 10 );
    }

    maps\mp\gametypes\_weapons::updatemovespeedscale();
    thread maps\mp\_adrenaline::_id_536F();
}
...
alien_mode_overdrive_off()
{
    ...
    {
        var_0 = self getclientomnvar( "ui_horde_player_class" );
        self.movespeedscaler = level._id_1E3A[var_0]["speed"];
    }
...
alien_mode_unlimited_ammo()
{
    ...
    for (;;)
    {
        ...
        self setweaponammostock( var_0, weaponinventorytype( var_0 ) );
    }
}
