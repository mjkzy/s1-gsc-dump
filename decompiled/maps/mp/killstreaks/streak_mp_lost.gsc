...
tryusecleaningdrone( var_0, var_1 )
{
    ...
    for ( var_7 = 0; var_7 < level.cleaningdronemaxperplayer; var_7 = var_7 + 1 )
    {
...
createcleaningdrone( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_10 linktosynchronizedparent( var_9.modelbase, "tag_origin", ( -40, 0, 10 ), ( 0, 0, 0 ) );
...
cleaningdrone_spawnanim( var_0 )
{
    ...
    self.modelbase linktosynchronizedparent( self, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
}
