...
swarm_spawn()
{
    ...
    level.swarm_planemodel.minimapicon linktosynchronizedparent( level.swarm_planemodel, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    level.swarm_planemodel.fxent = level.swarm_planemodel common_scripts\utility::spawn_tag_origin();
    level.swarm_planemodel.fxent linktosynchronizedparent( level.swarm_planemodel, "tag_origin", ( 0, 0, -800 ), ( 0, 0, 0 ) );
...
setrandomswarmstartposition()
{
    ...
    level.swarm_planemodel.origin = level.swarm_planemodel.origin - vectornormalize( -1 * anglestoright( level.swarm_planemodel gettagangles( "tag_origin" ) ) ) * var_1;
    level.swarm_planemodel.origin = level.swarm_planemodel.origin + ( 0, 0, var_0 );
...
moveswarmtodestination( var_0 )
{
    ...
    if ( isdefined( level.swarm_planemodel.owner ) )
    {
        ...
        level.swarm_planemodel.closeflightsound linktosynchronizedparent( level.swarm_planemodel, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    ...
    level.swarm_planemodel.farflightsound linktosynchronizedparent( level.swarm_planemodel, "tag_origin", ( 0, 0, 0 ), ( 0, 0, 0 ) );
