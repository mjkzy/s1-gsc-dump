...
main()
{
    ...
    maps\mp\_compass::_id_831E( "compass_map_mp_clowntown3" );
    _id_A75F::init();
    ...
    if ( !( var_0 == "twar" || var_0 == "sd" || var_0 == "sr" ) )
        level thread maps\mp\_dynamic_events::_id_2FE6( ::clowntown_dynamic_event );

    setdvar( "sm_minSpotLightScore", 0.0007 );
    level._id_65AB = "mp_clowntown3_osp";
    level._id_65A9 = "mp_clowntown3_osp";
    level._id_A197 = "mp_clowntown3_osp";
    level._id_A18C = "mp_clowntown3_osp";
    level._id_9F74 = "mp_clowntown3_osp";
    level._id_9F73 = "mp_clowntown3_osp";
...
rotating_bed_setup()
{
    ...
    var_1 rotatevelocity( ( 0.0, -10.0, 0.0 ), var_2 );
}
...
bomb_fires( var_0 )
{
    ...
    bomb_fx_start();
    radiusdamage( level.launch_point.origin + ( 0.0, 0.0, 20.0 ), 20, 50, 40 );
...
bomb_fuse_default()
{
    ...
    _func_071( "iw5_dlcgun12loot8_mp", self.visuals[0].origin, ( 0.0, 0.0, 0.0 ), 0 );
    thread bomb_cleanup();
}
...
ct_vista_cars()
{
    level endon( "game_ended" );
    var_0 = ( 33.0, 62.0, -3.0 );
    var_1 = ( 33.0, -105.0, -3.0 );
    level.car01 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car02 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car03 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car04 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car05 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car06 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car07 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car08 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car09 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car10 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car11 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car12 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car13 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car14 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car15 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car16 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car17 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car18 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car19 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car20 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
    level.car21 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car22 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car23 = spawncar( var_1, ( 0.0, 252.0, 0.0 ) );
    level.car24 = spawncar( var_0, ( 0.0, 252.0, 0.0 ) );
...
{
    maps\mp\_audio::_id_8730( "ct3_cannon_shot_music", level.launch_point.origin );
    maps\mp\_audio::_id_8730( "mp_anr_clown_dyn_welcome", level.launch_point.origin );
}

aud_event_sign_mech_idle()
{
    wait 1.5;
    maps\mp\_audio::_id_873B( "ct3_cannon_idle_mech_lp", level.launch_point.origin, "aud_stop_mech_loop" );
}

aud_event_sign_hat_off( var_0 )
{
    maps\mp\_audio::_id_8730( "ct3_cannon_mech_start", level.launch_point.origin, var_0 );
    maps\mp\_audio::_id_8730( "ct3_cannon_shot_fireworks", level.launch_point.origin, var_0 );
    maps\mp\_audio::_id_8730( "ct3_cannon_shot_music", level.launch_point.origin, var_0 );
    maps\mp\_audio::_id_8730( "mp_anr_clown_dyn_carnival", level.launch_point.origin );
}
...
{
    maps\mp\_audio::_id_8731( "ct3_cannon_mech_end", level.launch_point.origin, 0.55, var_0 );
    maps\mp\_audio::_id_8730( "mp_anr_clown_dyn_carnival", level.launch_point.origin );
}
