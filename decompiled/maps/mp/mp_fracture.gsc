...
main()
{
    ...
    _id_A75F::init();
    _id_A75F::init();
    maps\mp\_compass::_id_831E( "compass_map_mp_cargoship2" );
    game["attackers"] = "allies";
    game["defenders"] = "axis";
    level.goliath_bad_landing_volumes = [];
    precachemodel( "genericprop" );
    precacherumble( "cgo_event_rumble_loop" );
    level._id_65AB = "mp_fracture_osp";
    level._id_65A9 = "mp_fracture_osp";
    level._id_2F3B = "mp_fracture_drone";
    level._id_2F12 = "mp_fracture_drone";
    level._id_A197 = "mp_fracture_warbird";
    level._id_A18C = "mp_fracture_warbird";
    ...
    level _id_2FE7();
    level thread maps\mp\_dynamic_events::_id_2FE6( ::handleiceberglanebreakup, ::handleiceberglanereset, ::handleiceberglanebreakupend );
...
setupicebergbonelist()
{
    var_0 = [ setupbonestruct( "chunk_A", ( 2340.0, 971.0, -440.139 ), 1 ), setupbonestruct( "A_container_01_red", ( 1977.2, 724.165, -307.299 ), 1 ), setupbonestruct( "A_container_01_orange", ( 1631.0, 714.695, -182.16 ), 1 ), setupbonestruct( "chunk_B", ( 1052.38, 1040.26, -138.983 ), 0 ), setupbonestruct( "B_snowcat", ( 162.003, 746.972, -384.812 ), 1 ), setupbonestruct( "B_container_01_liteblue1", ( -1540.0, 780.63, -416.497 ), 1 ), setupbonestruct( "chunk_C", ( 227.0, 1128.54, -402.207 ), 1 ), setupbonestruct( "chunk_D", ( -561.0, 1029.83, -122.877 ), 0 ), setupbonestruct( "chunk_E", ( -1963.0, 1031.29, -384.02 ), 1 ) ];
...
setupiceberglane()
{
    level.iceberglanemodel = spawn( "script_model", ( 0.0, 0.0, 0.0 ) );
    level.iceberglanemodel setmodel( "cgo_iceberg_lane" );
    level.iceberglanemodel.angles = ( 0.0, -90.0, 0.0 );
...
prepareiceberganimation( var_0 )
{
    ...
    var_0.animproxy scriptmodelplayanimdeltamotion( var_0._id_0C72 );
...
setupbonestruct( var_0, var_1, var_2 )
{
    ...
    var_3._id_0C72 = "cgo_iceberg_lane_collapse_" + var_0;
    var_3.xmodelname = "cgo_iceberg_lane_" + var_0;
    var_3._id_31BB = var_1;
...
playicebergchunks1()
{
    ...
    var_0 = spawnfx( common_scripts\utility::getfx( "mp_cgo_iceberg_foam_1" ), ( 2322.8, 1093.73, -73.7358 ), anglestoforward( ( 270.0, 0.0, 178.0 ) ), anglestoup( ( 270.0, 0.0, 178.0 ) ) );
    triggerfx( var_0 );
    wait 3;
...
playicebergchunks2()
{
    ...
    var_0 = spawnfx( common_scripts\utility::getfx( "mp_cgo_iceberg_foam_1" ), ( -1236.57, 973.315, -78.0 ), anglestoforward( ( 270.0, 0.0, 173.0 ) ), anglestoup( ( 270.0, 0.0, 173.0 ) ) );
    triggerfx( var_0 );
    wait 4;
...
playicebergchunks3()
{
    ...
    var_0 = spawnfx( common_scripts\utility::getfx( "mp_cgo_iceberg_foam_1" ), ( 498.966, 1091.24, -78.0 ), anglestoforward( ( 270.0, 0.0, 173.0 ) ), anglestoup( ( 270.0, 0.0, 173.0 ) ) );
    triggerfx( var_0 );
    wait 3;
...
{
    var_0 = ( -1236.57, 973.315, -78.0 );
    thread common_scripts\utility::play_sound_in_space( "iceberg_full_event", var_0 );
}

aud_iceberg_sequence_03()
{
    var_0 = ( 498.966, 1091.24, -78.0 );
    thread common_scripts\utility::play_sound_in_space( "iceberg_full_event", var_0 );
}
...
{
    wait 4;
    thread maps\mp\_audio::_id_8730( "mp_fracture_ty_initial_hit", ( 0.0, 0.0, 0.0 ) );
...
icebergtriggershakethink()
{
    ...
    for (;;)
    {
        while ( !self isonground() || !isdefined( self _meth_83ED() ) )
            waitframe();
...
connectenttoanimproxy( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        var_4 linktosynchronizedparent( var_0.animproxy );
...
handleiceberglanebreakupend()
{
    ...
    foreach ( var_1 in level.icebergbonelist )
        var_1.animproxy.origin = var_1._id_31BB;
...
{
    if ( self.origin[1] > 480.0 && !( isdefined( self._id_52A5 ) && self._id_52A5 ) )
    {
