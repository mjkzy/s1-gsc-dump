...
main()
{
    ...
    maps\mp\_compass::_id_831E( "compass_map_mp_urban" );
    game["attackers"] = "allies";
    game["defenders"] = "axis";
    level._id_6573 = ::urbancustomospfunc;
    level._id_655B = ::urbanvulcancustomfunc;
    level._id_731E = 20000;
...
urbancustomospfunc()
{
    ...
    level._id_6574._id_89DC = 9275;
    level._id_6574._id_8A00 = 6000;
    level._id_6574._id_03E3 = 246;
...
{
    if ( level.nextgen )
        level._id_655C.spawnpoint = ( 300.0, 0.0, 0.0 );
    else
        level._id_655C.spawnpoint = ( 300.0, 0.0, 800.0 );
}
...
lockdownevent()
{
    ...
    level thread maps\mp\_dynamic_events::_id_2FE6( ::_id_33D4, ::_id_33D3 );
...
{
    wait 0.5;
    playsoundatpos( ( -142.0, 6.0, 2550.0 ), "mp_anr_urb_dyn_off_r" );
    wait 3;
    playsoundatpos( ( -142.0, 6.0, 2550.0 ), "mp_anr_urb_dyn_off_spn_r" );
}
...
playannouncementlockdownvo()
{
    ...
    {
        wait 8.0;
        playsoundatpos( ( -142.0, 6.0, 2550.0 ), "mp_anr_urb_dyn_on_r" );
        wait 2.0;
        playsoundatpos( ( -142.0, 6.0, 2550.0 ), "mp_anr_urb_dyn_on_spn_r" );
    }
    else
    {
        wait 0.5;
...
urbandoorsopen()
{
    ...
    var_1 = var_0.startorg + ( 0.0, 0.0, -98.0 );
...
urbanlockdown()
{
    ...
    urbanblockerssolid();
    common_scripts\_exploder::_id_06F9( 50 );
...
urbanreleaselockdown()
{
    ...
    common_scripts\_exploder::_id_06F9( 20 );
}
...
urbananimateriders()
{
    ...
    waitframe();
    var_7 linktosynchronizedparent( var_5, "tag_driver", ( 0.0, 0.0, 0.0 ), ( 0.0, 90.0, 0.0 ) );
    var_8 linktosynchronizedparent( var_6, "tag_driver", ( 0.0, 0.0, 0.0 ), ( 0.0, 90.0, 0.0 ) );
    wait 1;
...
urbanpatchwarbird()
{
    ...
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 147.0, 1524.0, 4400.0 ), ( 467.0, 1524.0, 4400.0 ) );
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 129.0, -11.0, 4372.0 ), ( 449.0, -11.0, 4372.0 ) );
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 772.0, 1692.0, 4400.0 ), ( 1028.0, 1692.0, 4400.0 ) );
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 1252.0, 1156.0, 4404.0 ), ( 1508.0, 1156.0, 4404.0 ) );
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 1424.0, -1368.0, 4360.0 ), ( 1508.0, -1368.0, 4360.0 ) );
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 428.0, -1992.0, 4400.0 ), ( 748.0, -1992.0, 4400.0 ) );
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 148.0, -1556.0, 4392.0 ), ( 468.0, -1556.0, 4392.0 ) );
    maps\mp\killstreaks\_aerial_utility::patchheliloopnode( ( 544.5, -1392.0, 4384.0 ), ( 864.5, -1392.0, 4384.0 ) );
}

urbanpatchclip()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -354.0, -1280.0, 2688.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -354.0, -1024.0, 2688.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -354.0, -768.0, 2688.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -354.0, 768.0, 2688.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -354.0, 1024.0, 2688.0 ), ( 0.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( -354.0, 1280.0, 2688.0 ), ( 0.0, 0.0, 0.0 ) );
}
