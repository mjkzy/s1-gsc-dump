...
main()
{
    ...
    level._id_5985 = ::customkillstreakfunc;
    maps\mp\_compass::_id_831E( "compass_map_mp_spark" );
...
vistadroppods()
{
    ...
    if ( level.sparkdroppods.size == 0 )
    {
        ...
        {
            var_5 = spawn( "script_model", ( 0.0, 0.0, -10000.0 ) );
    ...
    foreach ( var_7 in level.sparkdroplocations )
    {
        ...
        var_7._id_311B = var_8.origin;
        var_9 = vectornormalize( var_7.origin - var_8.origin );
        var_7._id_8B1A = var_8.origin + var_9 * var_0;
        var_7._id_8CF9 = vectortoangles( var_9 ) + ( 270.0, 0.0, 0.0 );
    }
    ...
    for (;;)
    {
        ...
        level thread _id_37E1( var_11, var_12 );
    }
}
...
_id_37E1( var_0, var_1 )
{
    ...
    var_0.origin = var_3._id_8B1A;
    var_0.angles = var_3._id_8CF9;
    var_0 moveto( var_3._id_311B, var_2, var_2, 0 );
    wait(var_2);
    killfxontag( common_scripts\utility::getfx( "mp_spark_drop_pod" ), var_0, "tag_fx" );
    var_0 stoploopsound();
    playfx( common_scripts\utility::getfx( "mp_spark_drop_pod_impact" ), var_3._id_311B );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            else
            {
                ...
                self lightsetoverridedisableforplayer( 0.5 );
            }
        }
...
patchclip()
{
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -63.0, 165.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( 212.0, 129.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( 493.0, 125.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( 819.0, 216.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( 819.0, 1082.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( 496.0, 1170.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( 209.0, 1168.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
    maps\mp\_utility::spawnpatchclip( "patchclip_vehicle_16_64_64", ( -57.0, 1128.0, 896.0 ), ( 90.0, 0.0, 0.0 ) );
}
