...
{
    var_0 = spawn( "script_origin", ( 3761.0, -2060.0, 143.0 ) );
    var_0 playloopsound( "water_main_spray" );
    var_1 = spawn( "script_origin", ( 3602.0, -2074.0, -23.0 ) );
    var_1 playloopsound( "water_main_splash" );
    var_2 = spawn( "script_origin", ( 415.0, -5346.0, 170.0 ) );
...
civilian_extraction_success_stinger()
{
    for (;;)
    {
        ...
        playsoundatpos( ( 0.0, 0.0, 0.0 ), "zmb_civ_extract_success" );
    }
}
...
civilian_extraction_fail_stinger()
{
    for (;;)
    {
        ...
        playsoundatpos( ( 0.0, 0.0, 0.0 ), "zmb_civ_extract_fail" );
    }
}
