...
sortdroplocations()
{
    ...
    foreach ( var_3 in level.players )
    {
        ...
        var_1++;
        var_0 = var_0 + ( var_3.origin[0], var_3.origin[1], var_3.origin[2] );
    }
...
getsupportbarsize()
{
    ...
    var_3 = var_3 + 800 * level.hordedifficultylevel;
...
getplayerdamagescale()
{
    ...
    var_1 = var_1 + 0.15 * level.hordedifficultylevel;
    var_1 = var_1 + 0.3 * ( level.hordelevelflip - 1 );
    return var_1;
}
...
modifyplayerdamagehorde( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isplayer( var_0 ) || maps\mp\gametypes\_horde_util::isonhumanteam( var_0 ) )
    {
        ...
        if ( issubstr( var_5, "em1" ) )
            var_3 = var_3 * var_0.energydmgmod;
...
givepointsforevent( var_0, var_1, var_2 )
{
    ...
    level.currentpointtotal = level.currentpointtotal + var_3;
    level notify( "pointsEarned" );
