...
main()
{
    ...
    level._id_2559 = maps\mp\zombies\killstreaks\_zombie_killstreaks::airdropcustomfunc;
    ...
    level.bot_killstreak_setup_func = maps\mp\zombies\killstreaks\_zombie_killstreaks::_id_167A;
    ...
    level.hurttriggerfunc = ::_id_4B09;
...
_id_4DF7()
{
    ...
    level._id_0314["ammo"]["func"] = ::_id_0B7A;
    level._id_0314["ammo"]["fx"] = "pickup_maxammo";
    level._id_0314["insta_kill"]["func"] = ::instakillpickup;
    level._id_0314["insta_kill"]["fx"] = "pickup_instakill";
    level._id_0314["double_points"]["func"] = ::doublepointspickup;
    level._id_0314["double_points"]["fx"] = "pickup_doublepoints";
    level._id_0314["fire_sale"]["func"] = ::firesalepickup;
    level._id_0314["fire_sale"]["fx"] = "pickup_firesale";
    level._id_0314["nuke"]["func"] = ::nukepickup;
    level._id_0314["nuke"]["fx"] = "pickup_nuke";
    level._id_0314["trap"]["func"] = ::trappickup;
    level._id_0314["trap"]["fx"] = "pickup_trap";
    prespawnpickupents();
    randomizepickuplist();
...
spawnpickupent()
{
    ...
    var_0 ghost();
    var_0.inuse = 0;
    var_0.trigger = spawn( "trigger_radius", ( 0.0, 0.0, 0.0 ), 0, 32, 32 );
...
randomizepickuplist()
{
    ...
    foreach ( var_2, var_1 in level._id_0314 )
...
_id_401C()
{
    var_0 = maps\mp\zombies\_util::_id_4056() + 1;
...
initzombiesettings()
{
    ...
    level.lastenemydeathpos = ( 0.0, 0.0, 0.0 );
    level.zombiegamepaused = 0;
    level.doorsopenedbitmask = 0;
    level._id_6E22 = [];
    level._id_6E22["damage_body"] = 10;
    level._id_6E22["damage_head"] = 10;
    level._id_6E22["kill_trap"] = 10;
    level._id_6E22["kill_limb"] = 50;
    level._id_6E22["kill_streak"] = 40;
    level._id_6E22["kill_body"] = 60;
    level._id_6E22["kill_head"] = 100;
    level._id_6E22["kill_melee"] = 130;
    level._id_6E22["power_on"] = 100;
    level._id_6E22["atm"] = 100;
    level._id_6E22["atm_jackpot"] = 10;
    level._id_6E22["cure"] = 100;
    level._id_6E22["crate"] = 500;
    level._id_6E22["nuke"] = 400;
    level._id_6E22["reward_bronze"] = 500;
    level._id_6E22["reward_silver"] = 1000;
    level._id_6E22["reward_gold"] = 2000;
    level._id_6E22["breach_fix"] = 200;
...
playermonitorlastgroundpos()
{
    ...
    for (;;)
    {
        if ( maps\mp\zombies\_util::getzombieslevelnum() == 4 && maps\mp\zombies\_util::_id_508F( self._id_4FAA ) )
        {
            waitframe();
            continue;
        }

        if ( self isonground() && !maps\mp\zombies\_util::_id_508F( self.disabletombstonedropinarea ) )
...
givemoney( var_0 )
{
    ...
    self._id_6E25[self._id_6E25.size] = var_1;
...
weaponleveldisplay( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = var_0._id_A2E3[var_2]["level"];
...
zombiegameclass()
{
    ...
    self.pers["lastClass"] = "";
    self.pers["gamemodeLoadout"] = level.modeloadouts[level._id_6D6C];
...
playerinvinciblefromcrateorpowerup( var_0, var_1, var_2 )
{
    if ( maps\mp\zombies\_util::iscrategodmode( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            if ( maps\mp\zombies\_util::_id_508F( var_1.iszomboni ) )
                return 0;
...
calculatefriendlyfirerounddamage( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else
    {
        ...
        if ( isdefined( var_2._id_A2E3 ) && isdefined( var_2._id_A2E3[var_5] ) && isdefined( var_2._id_A2E3[var_5]["level"] ) )
            var_8 = var_2._id_A2E3[var_5]["level"];
...
modifyplayerdamagezombies( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( var_10 )
    {
        if ( isdefined( var_0._id_4254 ) && var_0._id_4254 )
            return 0;
    ...
    if ( isdefined( level.defusedamagemultiplier ) && maps\mp\zombies\_util::_id_508F( var_0.isdefusing ) && isai( var_2 ) && !_func_2D9( var_2 ) )
    ...
    if ( isplayer( var_0 ) )
    {
        ...
        if ( maps\mp\zombies\_util::_id_508F( var_0.enteringgoliath ) )
            return 0;
    ...
    if ( isai( var_0 ) && !isplayer( var_0 ) && isai( var_2 ) )
    {
        ...
        if ( isdefined( var_0.agent_type ) && var_0.agent_type == "sq_character" && var_0._id_4254 )
            return 0;
        ...
        if ( maps\mp\zombies\_util::_id_508F( var_0.nodamageself ) && var_0 == var_2 )
            return 0;
    }
    ...
    if ( isdefined( var_2 ) && isplayer( var_2 ) && isai( var_0 ) && !isplayer( var_0 ) )
    {
        ...
        if ( maps\mp\zombies\_util::haszombieweaponstate( var_2, var_12 ) )
        {
            ...
            if ( isdefined( var_2._id_A2E3[var_12]["weapon_level_increase"] ) )
                var_16 = var_2._id_A2E3[var_12]["weapon_level_increase"];

            var_9 = int( var_9 + var_9 * var_16 * ( var_2._id_A2E3[var_12]["level"] - 1 ) );
        }
        ...
        if ( maps\mp\zombies\_util::_id_508F( var_0.inairforleap ) )
            var_9 *= 2;

        if ( isdefined( level.zombie_rewards ) )
        {
            if ( isdefined( level.laststandupgrade ) && level.laststandupgrade == 1 && maps\mp\zombies\_util::_id_5175( var_2 ) )
                var_9 *= 4;
        }
        ...
        if ( !maps\mp\zombies\_util::ispendingdeath( var_0 ) )
            var_2 _id_41FA( var_0, var_9, var_4, var_5, var_6, var_7, var_8, 0 );
...
zmdamageignoresarmor( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        if ( maps\mp\zombies\_util::_id_508F( var_0.iszomboni ) )
            return 1;

        if ( maps\mp\zombies\_util::_id_508F( var_0.is_door ) )
            return 1;
    }
...
_id_5EAA( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( !isagent( var_0 ) )
                var_0 setclientomnvar( "ui_zm_award_points", var_0._id_6E25[var_0._id_6E25.size - 1] );
...
{
    if ( !maps\mp\zombies\_util::_id_508F( self.laststand ) && !maps\mp\zombies\_util::_id_508F( self.infected ) )
    {
...
dropweaponfordeathzombies( var_0, var_1, var_2 )
{
    ...
    var_6.visuals linkto( var_6, "j_dogtag", ( 0.0, 0.0, -12.0 ), ( 0.0, 0.0, 0.0 ) );
...
calculatezombiehealth( var_0 )
{
    ...
    var_1 = int( var_1 * var_0._id_4780 );
...
revivedownedplayers()
{
    foreach ( var_1 in level.players )
    {
        ...
        else if ( maps\mp\zombies\_util::_id_5175( var_1 ) )
...
{
    if ( !maps\mp\zombies\_util::_id_508F( level.pickupdebugprint ) )
        return;
...
_id_1C67( var_0, var_1, var_2, var_3 )
{
    ...
    if ( maps\mp\zombies\_util::_id_508F( var_1.killedbynuke ) )
        return;

    if ( maps\mp\zombies\_util::_id_508F( var_1.nopickups ) )
        return;
...
{
    if ( isdefined( level.zone_data ) && maps\mp\zombies\_zombies_zone_manager::ispointinanyzone( var_1 + ( 0.0, 0.0, 1.0 ) ) )
        createpickup( var_0, var_1, var_2 );
    else
    {
        var_3 = common_scripts\utility::random( level.players );
        [[ level._id_0314[var_0]["func"] ]]( var_3 );
    }
}

createpickup( var_0, var_1, var_2 )
{
    var_3 = level._id_0314[var_0]["model"];
    var_4 = level._id_0314[var_0]["func"];
    var_5 = level._id_0314[var_0]["icon"];
    var_6 = level._id_0314[var_0]["fx"];
    var_7 = level._id_0314[var_0]["outline"];
    level._id_251E++;
    ...
    spawnpickupmodel( var_1 + ( 0.0, 0.0, 22.0 ), var_3, var_5, var_6, var_4, undefined, var_7 );
}
...
spawnpickupmodel( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_9 = maps\mp\gametypes\_gameobjects::createuseobject( level._id_6D6C, var_8, var_7, ( 0.0, 0.0, 16.0 ), 1 );
    var_10 = var_0;
    ...
    if ( isdefined( var_2 ) && var_2 != "" )
        var_9.icon = var_8 maps\mp\_entityheadicons::setheadicon( level._id_6D6C, var_2, ( 0.0, 0.0, 30.0 ), 14, 14, undefined, undefined, undefined, undefined, undefined, 0 );
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        var_9.visuals[0].origin = var_10 + ( 0.0, 0.0, -12.0 );
        var_9._id_3B21 = level._effect[var_3];
        var_9.fxtag = "j_dogtag";
        playfxontag( var_9._id_3B21, var_9.visuals[0], var_9.fxtag );
    }
    else
        var_9 thread _id_6810();

    var_9 thread _id_6815();
}
...
_id_6813()
{
    ...
    for (;;)
    {
        if ( isdefined( self._id_3B21 ) )
            stopfxontag( self._id_3B21, self.visuals[0], self.fxtag );
        ...
        if ( isdefined( self._id_3B21 ) )
            playfxontag( self._id_3B21, self.visuals[0], self.fxtag );
        else if ( isdefined( self.visuals ) && isdefined( self.visuals[0] ) )
            self.visuals[0] show();
...
_id_73CD( var_0 )
{
    ...
    if ( isdefined( var_0._id_3B21 ) )
        stopfxontag( var_0._id_3B21, var_0.visuals[0], var_0.fxtag );

    var_0.trigger.origin -= ( 0.0, 0.0, -10000.0 );
    wait 1;
...
activatemaxammo()
{
    foreach ( var_1 in level.players )
    {
        if ( maps\mp\zombies\_util::_id_5164( var_1 ) && maps\mp\_utility::isreallyalive( var_1 ) )
        {
...
turnonfiresalemachine( var_0 )
{
    ...
    if ( !var_0._id_0014 )
    {
        var_0 maps\mp\zombies\_wall_buys::activatemagicboxeffects( var_0.modelent, var_0._id_0255 );
        level thread maps\mp\zombies\_wall_buys::watchmagicboxtrigger( var_0, 1 );
    }
    else if ( var_0._id_5154 )
    {
        while ( var_0._id_5154 )
            wait 0.05;
...
turnofffiresalemachine( var_0 )
{
    ...
    if ( !var_0._id_0014 )
    {
        ...
        var_0 maps\mp\zombies\_wall_buys::deactivatemagicboxeffects( var_0.modelent, var_0._id_0255 );
...
activatenukepickup( var_0 )
{
    ...
    {
        if ( var_6._id_001D == level._id_6D6C )
            continue;
...
showteamsplashzombies( var_0 )
{
    foreach ( var_2 in level.players )
    {
        if ( maps\mp\zombies\_util::_id_5164( var_2 ) && maps\mp\_utility::isreallyalive( var_2 ) )
...
playerdoem1logic( var_0 )
{
    ...
    {
        if ( maps\mp\zombies\_util::playerhasem1ammoinfo() && maps\mp\zombies\_util::playergetem1ammo() <= 0 && !playerhasem1() && !maps\mp\zombies\_util::_id_5175( self ) )
...
playersetupem1ammo()
{
    ...
    for (;;)
    {
        ...
        if ( self isswitchingweapon() || !issubstr( var_1, "iw5_em1zm_mp" ) || !self _meth_812D() || self _meth_84E0() )
        {
            waitframe();
            continue;
        }
