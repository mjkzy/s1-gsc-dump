    ...
    for (;;)
    {
        ...
        switch ( level.currentroundnumber )
        {
            ...
            case 3:
                continue;
            case 4:
                var_0 = "coop_gdn_enemyk9units";
                break;
            case 5:
                var_0 = "coop_gdn_enemydrones";
                break;
            case 6:
                continue;
            case 7:
                var_0 = "coop_gdn_hostileemtroops";
                break;
            case 8:
                var_0 = "coop_gdn_teambeadvisedenemiesareusing";
                break;
            case 9:
                continue;
            case 10:
                var_0 = "coop_gdn_incomingmechs";
                break;
            case 11:
            ...
            case 13:
                continue;
            case 14:
                var_0 = "coop_gdn_enemydronehandlers";
                break;
            case 15:
                var_0 = "coop_gdn_warbird_inc";
                break;
            case 16:
                continue;
            case 17:
                var_0 = "coop_gdn_enemydronesintheair";
                break;
            case 18:
                var_0 = "coop_gdn_wereseeingmicrodronesignature";
                break;
            case 19:
                continue;
            case 20:
            ...
            case 24:
                continue;
            default:
                var_0 = hordegetroundstartline();
                break;
        }

        if ( level.currentroundnumber < 26 )
            thread hordeleaderdialogallplayers( var_0, "horde", 1 );
...
{
    var_0 = level.hordedialog["round_begin"][level.roundstartlineindex];
...
hordevolaststand()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 >= level.hordedialog["laststand"].size - 1 )
            var_0 = 0;
        else
            var_0++;

        var_1 = level.hordedialog["laststand"][var_0];

        foreach ( var_3 in level.players )
            var_3 maps\mp\_utility::leaderdialogonplayer( var_1, "horde", 1 );
...
hordeleaderdialogallplayers( var_0, var_1, var_2, var_3 )
{
    level endon( "game_ended" );
    ...
    foreach ( var_5 in level.players )
        var_5 maps\mp\_utility::leaderdialogonplayer( var_0, var_1, var_2 );
}
