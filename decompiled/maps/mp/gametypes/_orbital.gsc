...
initializeoribtalmode()
{
    ...
    switch ( var_0 )
    {
        case "mp_refraction":
            ...
            level.orbital_ships.cameraview["allies"].angles += ( 0.0, 220.0, 0.0 );
            ...
            level.orbital_ships.cameraview["axis"].angles += ( 0.0, 330.0, 0.0 );
            ...
            level.orbital_ships.ship["allies"].angles += ( 0.0, 220.0, 0.0 );
            level.orbital_ships.ship["allies"] linktosynchronizedparent( level.orbital_ships.cameraview["allies"], "", ( 0.0, 0.0, 80.0 ), ( 0.0, 0.0, 0.0 ) );
            ...
            level.orbital_ships.ship["axis"].angles += ( 0.0, 330.0, 0.0 );
            level.orbital_ships.ship["axis"] linktosynchronizedparent( level.orbital_ships.cameraview["axis"], "", ( 0.0, 0.0, 80.0 ), ( 0.0, 0.0, 0.0 ) );
        ...
        default:
            ...
            level.orbital_ships.center *= ( 1.0, 1.0, 0.0 );
            ...
            level.orbital_ships.cameraview["allies"] setmodel( "tag_player" );
            level.orbital_ships.cameraview["allies"].angles += ( 0.0, 180.0, 0.0 );
            ...
            level.orbital_ships.cameraview["axis"] setmodel( "tag_player" );
            level.orbital_ships.cameraview["axis"].angles += ( 0.0, 0.0, 0.0 );
            level.orbital_ships.cameraview["axis"] linktosynchronizedparent( level.orbital_ships.script_origin );
            level.orbital_ships.cameraview["axis"] hide();
            level.orbital_ships.missilespawn["target"] = spawn( "script_origin", level.orbital_ships.center - ( 0.0, 0.0, 7000.0 ) );
            ...
            level.orbital_ships.ship["allies"] setmodel( "vehicle_ac130_coop" );
            level.orbital_ships.ship["allies"].angles += ( 0.0, 180.0, 0.0 );
            level.orbital_ships.ship["allies"] linktosynchronizedparent( level.orbital_ships.cameraview["allies"], "", ( 0.0, 0.0, 100.0 ), ( 15.0, 0.0, 0.0 ) );
            level.orbital_ships.ship["axis"] = spawn( "script_model", var_7 );
            level.orbital_ships.ship["axis"] setmodel( "vehicle_ac130_coop" );
            level.orbital_ships.ship["axis"].angles += ( 0.0, 0.0, 0.0 );
            level.orbital_ships.ship["axis"] linktosynchronizedparent( level.orbital_ships.cameraview["axis"], "", ( 0.0, 0.0, 100.0 ), ( 15.0, 0.0, 0.0 ) );
...
missileeyes( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_0 maps\mp\gametypes\_damage::addattacker( var_0, var_0, var_0.rocket.killcament, "orbital_drop_pod_mp", 999999, ( 0.0, 0.0, 0.0 ), var_0.origin, "none", 0, "MOD_EXPLOSIVE" );
        var_0 thread unfreezecontrolsdelay( var_5 );
...
droppodspikeimpacts()
{
    ...
    for ( var_3 = 0; var_3 < var_1.size; var_3++ )
    {
        ...
        if ( isdefined( var_6["position"] ) )
            playfx( level.drop_pod_effect["drop_pod_spike_impact"], var_6["position"], anglestoforward( ( 270.0, 0.0, 0.0 ) ) );
    }
}
...
trackrocket( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.trigger.origin = var_5["position"] + ( 0.0, 0.0, -128.0 );
...
droppodbadspawndeathfx()
{
    self endon( "disconnect" );
    self waittill( "death" );
    playfx( level.drop_pod_effect["drop_pod_explode"], self.origin + ( 0.0, 0.0, 10.0 ) );
}
...
createplayerdroppod( var_0 )
{
    ...
    var_1 = var_0 + ( 0.0, 0.0, 32.0 );
    var_2 = var_0 + ( 0.0, 0.0, -1024.0 );
    var_3 = _func_238( var_1, var_2 );
    var_4 = var_3["position"];
    ...
    self.drop_pod.camera.angles = ( 0.0, 0.0, 0.0 );
...
createkillcamentity()
{
    var_0 = ( -512.0, 0.0, 128.0 );
    self.killcament = spawn( "script_model", self.origin );
    self.killcament setscriptmoverkillcam( "explosive" );
    self.killcament linkto( self, "tag_origin", var_0, ( 0.0, 0.0, 0.0 ) );
...
droppodtrophykill( var_0, var_1 )
{
    ...
    playfx( level.sentry_fire, self.origin + ( 0.0, 0.0, 0.0 ), var_0.origin - self.origin, anglestoup( self.angles ) );
...
projectileexplode( var_0, var_1 )
{
    ...
    var_5 maps\mp\gametypes\_damage::addattacker( var_5, var_5, var_5.rocket.killcament, "orbital_drop_pod_mp", 999999, ( 0.0, 0.0, 0.0 ), var_5.origin, "none", 0, "MOD_EXPLOSIVE" );
        ...
        switch ( var_0 )
        {
            case "friendly":
                if ( var_2.team == self.team )
                    var_2 maps\mp\_entityheadicons::setheadicon( self, "ac130_hud_friendly_vehicle_target", ( 0.0, 0.0, 0.0 ), 4, 4, undefined, undefined, undefined, undefined, undefined, 0 );

                continue;
            case "enemy":
                if ( !( var_2.team == self.team ) )
                    var_2 maps\mp\_entityheadicons::setheadicon( self, "hud_fofbox_hostile", ( 0.0, 0.0, 0.0 ), 4, 4, undefined, undefined, undefined, undefined, undefined, 0 );
