...
{
    var_0.hordeheadshots = var_0.hordeheadshots + var_1;
...
awardhorderoundnumber( var_0 )
{
    ...
    else if ( var_1 < 8 )
    {
        ...
        for ( var_4 = 0; var_4 < 4; var_4++ )
            var_3 = var_3 + var_0 gethordeplayerdata( "numWavesCompleted", var_4 );
...
{
    var_0.horde_score = var_0.horde_score + var_1;
...
givegearformapsplayed( var_0 )
{
    ...
    if ( !var_0 gethordeplayerdata( "requirement_unlockedTier2" ) )
    {
        ...
        for ( var_3 = 0; var_3 < 4; var_3++ )
            var_2 = var_2 + var_0 gethordeplayerdata( "numWavesCompleted", var_3 );

        if ( var_1 < 4 )
            var_2 = var_2 + var_0.roundsplayed;
...
hordeupdatenummatches( var_0 )
{
    ...
    {
        var_0.exosurvivalmatches = var_0.exosurvivalmatches + 1;
