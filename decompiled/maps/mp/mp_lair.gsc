...
main()
{
    ...
    maps\mp\_compass::_id_831E( "compass_map_mp_lair" );
    _id_A75F::init();
    level._id_65A9 = "mp_lair_osp";
    level._id_A18C = "mp_lair_warbird";
    level._id_9F73 = "mp_lair_osp";
    ...
    level _id_2FE7();
    level thread maps\mp\_dynamic_events::_id_2FE6( ::startdynamicevent, ::enddynamicevent, ::enddynamicevent );
    level._id_6573 = ::lairpaladinoverrides;
...
_id_2FE7()
{
    ...
    if ( level.gametype == "infect" )
        maps\mp\_dynamic_events::_id_7F59( 0.2 );
    else if ( level.gametype == "twar" )
        maps\mp\_dynamic_events::_id_7F59( 0.25 );
    else if ( level.gametype == "gun" )
        maps\mp\_dynamic_events::_id_7F59( 0.3 );
    else
        maps\mp\_dynamic_events::_id_7F59( 0.4 );
    ...
    for (;;)
    {
        ...
        foreach ( var_8 in level.tesla_towers )
        {
            if ( _func_220( var_8.origin, self.origin ) <= var_6 * var_6 )
            {
                ...
                {
                    var_9 = var_8.origin + ( 0.0, 0.0, 65.0 );
...
tower_lifetime()
{
    ...
    for (;;)
    {
        ...
        var_1 = maps\mp\_audio::_id_873B( "mp_lair_murder_lamp_lp", self.origin, "aud_stop_dynamic_event_loops" );
        var_2 = maps\mp\_audio::_id_873B( "mp_lair_murder_lamp_lp_hi", self.origin, "aud_stop_dynamic_event_loops" );
        self setcandamage( 1 );
        self.health = 99999;
...
start_shock( var_0 )
{
    ...
    var_3 = self.origin + ( 0.0, 0.0, 115.0 );
...
{
    level._id_6574._id_89DC = 9200;
    level._id_6574._id_8A00 = 8000;
    level._id_6574._id_8989 = 182;
}
