...
main()
{
    ...
    level.radioalive = 1;
    level.radioent1 = spawn( "script_origin", ( 21316.0, 853.0, 742.0 ) );
    level.radioent2 = spawn( "script_origin", ( 21316.0, 853.0, 742.0 ) );
    level.radioent3 = spawn( "script_origin", ( 21316.0, 853.0, 742.0 ) );
    level.radioent4 = spawn( "script_origin", ( 21316.0, 853.0, 742.0 ) );
    level.radioent5 = spawn( "script_origin", ( 21316.0, 853.0, 742.0 ) );
    level.radiostate = 1;
    thread radioswitchinit();
    level.customzombiemusicstates = ::customzombiemusicstates;
    level.aud_drunk_ent = spawn( "script_origin", ( 0.0, 0.0, 0.0 ) );
    level.aud_cage_playing = 0;
    level.aud_plinko_moving = 0;
    level.aud_play_stop_sound = 0;
    level.aud_plinko_ent = spawn( "script_origin", ( -128.0, 803.0, 1149.0 ) );
...
grenade_in_hopper()
{
    ...
    playsoundatpos( ( -130.0, 803.0, 1157.0 ), "plinko_gren_in_hopper" );
}
...
gate_moving( var_0, var_1 )
{
    ...
    else if ( var_0 < 1 )
    {
        ...
        {
            playsoundatpos( ( -128.0, 803.0, 1149.0 ), "plinko_hopper_move_start_fast" );
            level.aud_play_stop_sound = 1;
        }
        else
            playsoundatpos( ( -128.0, 803.0, 1149.0 ), "plinko_hopper_move_start" );
...
gate_stopped()
{
    ...
    if ( level.aud_plinko_moving )
    {
        ...
        {
            playsoundatpos( ( -128.0, 803.0, 1149.0 ), "plinko_hopper_move_stop" );
            level.aud_play_stop_sound = 0;
        }
    }
}
...
{
    playsoundatpos( ( -1869.0, 1181.0, 815.0 ), "teleporter_broken" );
}
...
teleporter_place_parts( var_0 )
{
    ...
    wait 1;
    playsoundatpos( ( -1869.0, 1181.0, 815.0 ), "teleporter_repair_progress_" + var_0 );
}

teleporter_repaired()
{
    playsoundatpos( ( -1869.0, 1181.0, 815.0 ), "teleporter_power_on" );
    var_0 = spawn( "script_origin", ( -1869.0, 1181.0, 815.0 ) );
...
{
    if ( var_0 == "reel" )
        playsoundatpos( ( -1647.0, -543.0, 1017.0 ), "ee_fishing_install_reel" );
    else if ( var_0 == "line" )
        playsoundatpos( ( -1647.0, -543.0, 1017.0 ), "ee_fishing_install_line" );
    else if ( var_0 == "hook" )
        playsoundatpos( ( -1647.0, -543.0, 1017.0 ), "ee_fishing_install_hook" );
}

fishing_cast_line()
{
    playsoundatpos( ( -1647.0, -543.0, 1017.0 ), "ee_fishing_cast_line" );
    wait 2;
    playsoundatpos( ( -1715.0, -543.0, 903.0 ), "ee_fishing_cast_splash" );
}

fishing_retrieve_line()
{
    wait 0.5;
    playsoundatpos( ( -1647.0, -543.0, 1017.0 ), "ee_fishing_retrieve_line" );
    wait 1.3;
    playsoundatpos( ( -1715.0, -543.0, 903.0 ), "ee_fishing_retrieve_splash" );
}
...
cage_switch()
{
    playsoundatpos( ( 157.0, 602.0, 890.0 ), "ee_cage_switch_throw" );
}

cage_down()
{
    playsoundatpos( ( 731.0, 420.0, 958.0 ), "ee_shark_cage_lower" );
    playsoundatpos( ( 731.0, 420.0, 793.0 ), "zark_moonpool_doors_open" );
    wait 3.5;
    playsoundatpos( ( 731.0, 420.0, 793.0 ), "ee_shark_cage_splash" );
}
...
cage_up()
{
    if ( level.aud_cage_playing == 0 )
    {
        ...
        playsoundatpos( ( 731.0, 420.0, 958.0 ), "ee_shark_cage_raise" );
        wait 2.5;
        playsoundatpos( ( 731.0, 420.0, 793.0 ), "zark_moonpool_doors_close" );
        wait 5;
        level.aud_cage_playing = 0;
    }
}
