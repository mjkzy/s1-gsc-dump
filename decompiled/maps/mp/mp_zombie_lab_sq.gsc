...
init_sidequest()
{
    ...
    maps\mp\killstreaks\_aerial_utility::_id_5941( "warbird", "vfx/explosion/vehicle_warbird_explosion_midair", maps\mp\killstreaks\_warbird::_id_A18B );
...
playerhasbox()
{
    return maps\mp\zombies\_util::_id_508F( self.hasbox );
}
...
cagewedgelogic( var_0 )
{
    ...
    var_0 moveto( var_0.origin + ( 0.0, 0.0, -100.0 ), 1 );
...
wedgewiggle()
{
    if ( maps\mp\zombies\_util::_id_508F( self.iswiggling ) )
        return;
...
cagewigglelogic()
{
    ...
    for (;;)
    {
        ...
        if ( maps\mp\zombies\_util::_id_508F( level.sq_cage1._id_5154 ) )
            continue;
...
cagelogic( var_0 )
{
    ...
    level.sq_cage1.downposition = level.sq_cage1.upposition + ( 0.0, 0.0, -154.0 );
    level.sq_cage2.downposition = level.sq_cage2.origin;
    level.sq_cage2.upposition = level.sq_cage2.downposition + ( 0.0, 0.0, 154.0 );

    for (;;)
    {
        level.sq_cage1 waittill( "cage1_hit_hard" );

        if ( maps\mp\zombies\_util::_id_508F( level.sq_cage1.iswiggling ) )
        {
...
movecages( var_0 )
{
    ...
    level.sq_cage1._id_5154 = 1;
    level.sq_cage2._id_5154 = 1;
    ...
    wait 2.1;
    level.sq_cage1._id_5154 = 0;
    level.sq_cage2._id_5154 = 0;
...
stage4_force_players_out( var_0 )
{
    ...
    var_5 thread maps\mp\zombies\_teleport::_id_9238( var_0 );
}
...
stage4_trigger_teleporter()
{
    ...
    self._id_8B1A notify( "trigger" );
}

stage4_incinerator_pusher( var_0 )
{
    var_1 = getent( "incinerator_mover", "targetname" );
    var_1._id_8B1A = var_1.origin;
    var_1._id_311B = common_scripts\utility::getstruct( var_1.target, "targetname" ).origin;
    var_1._id_9A52 = ::stage4_force_players_out;
    var_1 moveto( var_1._id_311B, var_0 );
    var_1 playloopsound( "incinerator_room_machine_loop" );
    wait(var_0);
    var_1 stoploopsound();
    wait 3;
    var_1.origin = var_1._id_8B1A;
}
...
stage4_incinerator_ground()
{
    ...
    if ( !isdefined( level.incinerator_key ) )
    {
        ...
        var_6 = spawn( "script_model", var_5 + ( 0.0, 0.0, 1.0 ) );
...
stage5_logic()
{
    ...
    var_1 moveto( var_1.origin + ( 0.0, 40.0, 0.0 ), 3 );
    wait 3.5;
    var_13 = 1;
...
{
    if ( maps\mp\zombies\_util::_id_508F( var_0.failfxon ) )
        return;
...
getterminalusecount()
{
    ...
    foreach ( var_2 in level.players )
    {
        if ( maps\mp\zombies\_util::_id_508F( var_2.usedexoterminalsq ) )
            var_0++;
    }
...
stage11_init()
{
    level._id_47AB = common_scripts\utility::getstructarray( "heli_crash_node", "targetname" );
}
...
stage11_logic()
{
    ...
    level._id_A14E = spawnhelicopter( level.players[0], var_0.origin, ( 0.0, 0.0, 0.0 ), "warbird_player_mp", "vehicle_xh9_warbird_low_cloaked_in_out_mp_cloak" );
    level._id_A14E.team = "allies";
    level._id_A14E._id_47FC = "warbird";
    var_3 = 40;
    level._id_A14E _meth_8283( var_3, var_3 / 4, var_3 / 4 );
    level._id_A14E _meth_825A( 100 );
    level._id_A14E setcandamage( 1 );
    level._id_A14E.health = 9999;
    maps\mp\_utility::incrementfauxvehiclecount();
    level._id_A14E thread warbirdtravellogic( var_0 );
    level._id_A14E thread warbirdmonitorhealth( var_1 );
    var_4 = monitorplayerslogic();
    level._id_A14E warbirdwaitlogic( var_0, var_4 );
    level._id_A14E warbirdtraveltoend( var_1, var_2 );
...
{
    wait 0.75;
    playsoundatpos( ( 433.0, -306.0, 91.0 ), "orbital_pkg_pod_impact" );
}
...
side_quest_end()
{
    ...
    while ( !maps\mp\zombies\_util::_id_508F( level.pickedupbadges ) && !maps\mp\zombies\_util::_id_508F( level.wenttolaststand ) && !maps\mp\zombies\_util::_id_508F( level.cheated ) )
        waitframe();
...
warbirdtraveltoend( var_0, var_1 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_3 ) && var_3 == "timeout" && !maps\mp\zombies\_util::_id_508F( level._id_A14E.iscrashing ) )
        {
    ...
    else
    {
        ...
        thread [[ level._id_0314["nuke"]["func"] ]]( level.players[0] );
...
stage11_end( var_0 )
{
    if ( isdefined( level._id_A14E ) && !maps\mp\zombies\_util::_id_508F( level._id_A14E.iscrashing ) )
    {
        level._id_A14E delete();
...
songstage1_logic()
{
    var_0 = song_fake_use( ( 1690.0, 1401.0, 122.0 ), 1 );
...
songstage2_logic()
{
    var_0 = song_fake_use( ( -508.0, 2318.0, 104.0 ), 2 );
...
songstage3_logic()
{
    var_0 = song_fake_use( ( 238.0, 4044.0, 92.0 ), 3, 100 );
