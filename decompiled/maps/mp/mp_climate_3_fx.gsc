...
{
    vent_steam_fx( var_0 );
    waterfall_start( var_0 );
    machine_window_fx( var_0 );
    clean_water_foam_fx( var_0 );
    fish_school_fx( var_0 );
}

toxic_fx( var_0 )
{
    top_vent_damage_fx( var_0 );
    clear_water_transition_looping_fx( var_0 );
    toxic_vent_steam_fx( var_0 );
    small_toxic_vent_steam_fx( var_0 );
    machine_toxic_window_fx( var_0 );
    vent_firecrawl_fx( var_0 );
    machine_toxic_pipes_fx( var_0 );
    dead_fish_fx( var_0 );
    toxic_waterfall_start( var_0 );
    vent_smoke_damage_fx( var_0 );
    less_freq_electrical_sparks_fx( var_0 );
    water_surface_steam_fx( var_0 );
}
...
water_surface_steam_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 1, var_0 );
}

waterfall_start( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 20, var_0 );
}
...
toxic_waterfall_start( var_0 )
{
    ...
    level thread common_scripts\_exploder::_id_06F5( 21, var_0 );
}
...
dead_fish_fx( var_0 )
{
    ...
    level thread common_scripts\_exploder::_id_06F5( 3, var_0 );
}

machine_window_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 17, var_0 );
}
...
machine_toxic_pipes_fx( var_0 )
{
    ...
    level thread common_scripts\_exploder::_id_06F5( 18, var_0 );
}

machine_toxic_window_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 19, var_0 );
}

fish_school_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 2, var_0 );
}
...
clear_water_transition_looping_fx( var_0 )
{
    ...
    level thread common_scripts\_exploder::_id_06F5( 202, var_0 );
}

vent_steam_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 6, var_0 );
}
...
toxic_vent_steam_fx( var_0 )
{
    ...
    level thread common_scripts\_exploder::_id_06F5( 5, var_0 );
}

small_toxic_vent_steam_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 16, var_0 );
}

top_vent_damage_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 7, var_0 );
}

vent_smoke_damage_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 8, var_0 );
}

vent_metal_shards_fx()
{
    level thread common_scripts\_exploder::_id_06F5( 9 );
}
...
less_freq_electrical_sparks_fx( var_0 )
{
    ...
    level thread common_scripts\_exploder::_id_06F5( 11, var_0 );
}

electrical_arcs_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 12, var_0 );
}

electrical_arc_coils_fx()
{
    level thread common_scripts\_exploder::_id_06F5( 15 );
}

heavy_electrical_sparks_fx()
{
    level thread common_scripts\_exploder::_id_06F5( 13 );
}

vent_firecrawl_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 14, var_0 );
}

clean_water_foam_fx( var_0 )
{
    level thread common_scripts\_exploder::_id_06F5( 203, var_0 );
}
