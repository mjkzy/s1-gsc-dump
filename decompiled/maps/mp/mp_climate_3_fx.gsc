...
water_surface_steam_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 1, var_0 );
}
...
dead_fish_fx( var_0 )
{
    ...
    level thread common_scripts\_exploder::activate_clientside_exploder( 3, var_0 );
}

machine_window_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 17, var_0 );
}
...
machine_toxic_window_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 19, var_0 );
}

fish_school_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 2, var_0 );
}
...
clear_water_transition_looping_fx( var_0 )
{
    ...
    level thread common_scripts\_exploder::activate_clientside_exploder( 202, var_0 );
}

vent_steam_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 6, var_0 );
}
...
small_toxic_vent_steam_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 16, var_0 );
}
...
vent_smoke_damage_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 8, var_0 );
}
...
vent_firecrawl_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 14, var_0 );
}

clean_water_foam_fx( var_0 )
{
    level thread common_scripts\_exploder::activate_clientside_exploder( 203, var_0 );
}
