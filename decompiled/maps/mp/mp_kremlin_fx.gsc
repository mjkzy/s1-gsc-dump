...
laser_grid_a_fx()
{
    ...
    var_0 = ( 360.0, 359.0, 0.0 );
    var_1 = anglestoforward( var_0 );
    var_2 = anglestoup( var_0 );
    var_3 = spawnfx( common_scripts\utility::getfx( "krem_laser_patch_a" ), ( -61.0, 834.0, 139.0 ), var_1, var_2 );
    triggerfx( var_3 );
...
laser_grid_b_fx()
{
    ...
    var_1 = anglestoforward( var_0 );
    var_2 = anglestoup( var_0 );
    var_3 = spawnfx( common_scripts\utility::getfx( "krem_laser_patch_b" ), ( -353.0, -706.0, 156.0 ), var_1, var_2 );
    triggerfx( var_3 );
    level waittill( "minefield_complete" );
    var_3 delete();
}
