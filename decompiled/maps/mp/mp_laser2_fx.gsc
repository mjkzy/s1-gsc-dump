...
setupoceanfoam( var_0 )
{
    var_1 = [ ( -589.197, -1605.05, 233.502 ), ( 270, 0, -90 ), 0, ( -843.596, -1305.72, 258.718 ), ( 270, 0, -90 ), 1, ( 37.7022, -1250.75, 255.878 ), ( 270, 0, -90 ), 2, ( -605.969, -878.506, 254.76 ), ( 270, 0, -90 ), 3, ( -225.131, -725.816, 254.456 ), ( 270, 0, -90 ), 4, ( 503.141, -654.117, 273.566 ), ( 270, 0, -90 ), 5, ( 1366.39, -1202.34, 266.587 ), ( 270, 0, -77 ), 6, ( 2322.31, -81.669, 215.623 ), ( 270, 0, -77 ), 7, ( 3591.37, 752.588, 255 ), ( 270, 0, -58 ), 8 ];

    for ( var_2 = 0; var_2 < var_1.size; var_2 += 3 )
    {
        var_3 = spawnstruct();
        var_3.num = var_1[var_2 + 2];
        var_4 = common_scripts\utility::spawn_tag_origin();
        var_4 show();
        var_4.origin = ( var_1[var_2][0], var_1[var_2][1], var_0.origin[2] );
...
playwaves( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        foreach ( var_5 in level.fx_waves )
        {
            var_5.fxid = var_3;
            thread playfxent( var_5 );
        }
...
{
    wait(var_0.delay);
    playfxontag( common_scripts\utility::getfx( var_0.fxid ), var_0.ent, "tag_origin" );
}

playoceanfoam( var_0, var_1 )
{
    foreach ( var_3 in level.fx_oceanfoam )
    {
        if ( var_3.num == var_1 )
