...
play_exo_room_dialog2()
{
    ...
    var_0 = common_scripts\utility::getstruct( "gideon_fight_distance_check", "targetname" );

    if ( distance2d( var_0.origin, level.gideon.origin ) <= 650 )
...
play_base_soldier_group_dialog()
{
    ...
    var_0 = common_scripts\utility::flag_wait_any_return( "flag_vo_ambient_soldier_group_1", "flag_vo_ambient_soldier_group_2", "flag_vo_ambient_soldier_group_3" );
...
{
    level endon( "training_room_elevator_activated" );
    var_0 = common_scripts\utility::flag_wait_any_return( "flag_vo_shooting_range_result_bad", "flag_vo_shooting_range_result_average", "flag_vo_shooting_range_result_good", "flag_vo_shooting_range_result_excellent", "flag_vo_shooting_range_result_perfect" );
...
{
    level endon( "training_room_elevator_activated" );
    var_0 = common_scripts\utility::flag_wait_any_return( "flag_vo_grenade_range_result_bad", "flag_vo_grenade_range_result_average", "flag_vo_grenade_range_result_good", "flag_vo_grenade_range_result_excellent", "flag_vo_grenade_range_result_perfect" );
    soundscripts\_snd_playsound::snd_play_2d( "rec_cmr1_trainingcomplete" );
    wait 1.6;
...
rec_funeral_part_1_cormack( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_crk_heleavesbehindfamilyfriends", 2.18 );
}

rec_funeral_part_2_cormack( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_crk_imsorrymitchell", 0.12 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_crk_mr", 13.21 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_crk_itwasanunfortunatetragedy", 23.01 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_crk_mrironsmitchellsbeendischarged", 32.06 );
}

rec_funeral_part_2_irons( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_excusemeprivatemitchell", 8.21 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_imsureyouaresergeant", 16.2 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_itwasmorethanunfortunate", 25.04 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_imawareofhisinjuries", 35.16 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_willtoldmewhatkind", 44.14 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_thinkaboutit", 52.12 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_dontletwillsdeathbe", 54.03 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_sergeant", 57.19 );
}

rec_sim_start_joker( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_jkr_okayeveryoneknowswhatto", 6.03, "notify_intro_stealth" );
    thread start_stealth_music( "notify_intro_stealth" );
}

start_stealth_music( var_0 )
{
    level waittill( var_0 );
    soundscripts\_snd::snd_music_message( "start_intro_stealth" );
}

rec_jeep_adr_gdn( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_gdn_jokerwerebringingmitchellover", 1.18 );
    soundscripts\_snd_pcap::snd_pcap_play_radio_vo_30fps( "rec_jkr_yougotitboss", 7.12 );
}

rec_jeep_ride_pt1( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_whatyoureseeingisadvanced", 2.09 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_unlikethegovernmentwedont", 9.24 );
}

rec_jeep_ride_pt2( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_powerisntjustaboutthe", 5.27 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_wedoinafew", 14.06 );
}

rec_jeep_ride_pt3( var_0 )
{
    var_1 = 1.24;
    soundscripts\_snd::snd_music_message( "rec_mus_tour_ride_end", var_1 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_mitchelliknowyourenot", var_1 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_nowgogetthatarm", 9.09, "sound_done_rec_irs_nowgogetthatarm" );
}

rec_sim_reveal_gideon( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_gdn_sloppymitchell", 9.24 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_gdn_reset", 15.06 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_gdn_noexcuseforequipmentfailure", 18.06, "rec_gdn_noexcuseforequipmentfailure_done" );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_gdn_itshisarmsir", 32.03 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_gdn_hesaworkinprogress", 39.24 );
    soundscripts\_snd::snd_music_message( "rec_sim_reveal_gideon" );
}

rec_sim_reveal_irons( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_thatarmsworthmoreto2", 34.21 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_wellkeepworking", 41.06 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_jumpin2", 49.03 );
}

rec_welcometoatlas_gideon( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_gdn_hesgettingtheresir", 2.18 );
}

rec_welcometoatlas_irons( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_lookslikewehavean", 6.12 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "rec_irs_hesreadyforrealwork", 9.24 );
}
