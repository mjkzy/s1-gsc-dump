...
do_tuning()
{
    for (;;)
    {
        ...
        if ( level.player buttonpressed( "BUTTON_LSTICK" ) )
            self.cone_length = self.cone_length - 10.0;
...
do_vehicle_scanner_tuning()
{
    for (;;)
    {
        ...
        if ( level.player buttonpressed( "DPAD_LEFT" ) )
            self.scanner_offset_from_vehicle_facing = self.scanner_offset_from_vehicle_facing - 1.0;
...
attach_scanner_turret()
{
    ...
    for (;;)
    {
        ...
        if ( level.player_is_in_scanner_cone == 1 )
        {
            ...
            for ( var_14 = var_10; var_14 > 0.0; var_14 = var_14 - var_11 )
            {
                var_9 shootturret();
                wait( var_11 );
            }
...
update_scanner_yaw_in_sweep_mode( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else if ( self.scanner_sweep_direction > 0.0 )
    {
        ...
        {
            self.scanner_local_velocity = self.scanner_local_velocity - 0.05 * var_4;
        ...
        {
            self.scanner_local_velocity = self.scanner_local_velocity + 0.05 * var_3;
...
update_scanner_yaw_returning_to_sweep_mode( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_7 > 1 )
        self.scanner_yaw = self.scanner_yaw + 0.05 * var_2;
    else if ( var_7 < -1 )
        self.scanner_yaw = self.scanner_yaw - 0.05 * var_2;
    else
    {
    ...
    if ( var_9 > 1 )
        self.scanner_tilt = self.scanner_tilt + 0.05 * var_4;
    else if ( var_9 < -1 )
        self.scanner_tilt = self.scanner_tilt - 0.05 * var_4;
    else
    {
...
spawn_metrics_death_watcher()
{
    ...
    if ( isdefined( level.spawn_metrics_death_count[var_0] ) )
        level.spawn_metrics_death_count[var_0] = level.spawn_metrics_death_count[var_0] + 1;
    else
...
spawn_metrics_number_spawned( var_0 )
{
    if ( isarray( var_0 ) )
    {
        ...
        foreach ( var_3 in var_0 )
            var_1 = var_1 + spawn_metrics_number_spawned( var_3 );
...
spawn_metrics_number_died( var_0 )
{
    if ( isarray( var_0 ) )
    {
        ...
        foreach ( var_3 in var_0 )
            var_1 = var_1 + spawn_metrics_number_died( var_3 );
...
spawn_metrics_waittill_count_reaches( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in var_1 )
            var_3 = var_3 + spawn_metrics_number_alive( var_5 );
...
spawn_metrics_waittill_deaths_reach( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in var_1 )
            var_3 = var_3 + spawn_metrics_number_died( var_5 );
...
hovertank_setup_hint_data()
{
    ...
    for ( var_3 = 0; var_3 < var_2.size; var_3 = var_3 + 1 )
    {
        var_4 = var_2[var_3];
...
hovertank_hint_enemy_kill_tracking( var_0 )
{
    ...
    if ( var_4 )
    {
        ...
        var_5.kill_counts[var_0] = var_5.kill_counts[var_0] + 1;
        ...
        if ( !var_7 && ( !var_5 || var_6 ) && [[ var_2 ]]() )
        {
            ...
            if ( isdefined( var_3.minimum_in_sights_needed[var_1] ) )
            {
                if ( var_4 - var_3.in_sights_timestamp[var_1] < var_3.thread_delay_s * 1000 )
                    var_3.amount_in_sights[var_1] = var_3.amount_in_sights[var_1] + 1;
                else
                {
...
magic_bullet_strafe( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    for ( var_17 = var_7; var_13 < var_4; var_17 = min( var_24 + var_7, var_5 - var_10 ) )
    {
        ...
        if ( var_6 > 0 )
        {
            ...
            var_20 = var_20 + anglestoforward( var_22 ) * var_21;
        }
