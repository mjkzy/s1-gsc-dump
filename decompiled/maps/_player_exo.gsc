...
overdrive_heatup_internal( var_0 )
{
    ...
    while ( var_2.currenttime < var_2.totaltime )
    {
        ...
        var_2.currenttime = var_2.currenttime + var_3;
        wait( var_3 );
    }
...
player_regen_scale( var_0 )
{
    ...
    self.gs.playerhealth_regularregendelay = self.gs.playerhealth_regularregendelay / var_0;
    self.gs.longregentime = self.gs.longregentime / var_0;
}
...
player_intel_mode_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_2 )
        {
            var_6 = var_6 + level.player setweaponammostock( "flash_grenade_var" );
            var_6 = var_6 + level.player setweaponammostock( "emp_grenade_var" );
            var_6 = var_6 + level.player setweaponammostock( "paint_grenade_var" );
            var_6 = var_6 / 3;
        }
        ...
        if ( var_2 )
        {
            var_7 = var_7 + level.player setweaponammostock( "frag_grenade_var" );
            var_7 = var_7 + level.player setweaponammostock( "contact_grenade_var" );
            var_7 = var_7 + level.player setweaponammostock( "tracking_grenade_var" );
            var_7 = var_7 / 3;
        }
