...
main()
{
    ...
    maps\_grapple::main( "viewbody_sentinel_pilot_mitchell", "viewhands_sentinel_pilot_mitchell" );
    ...
    _func_0D3( "moving_platform_keep_previous", "0" );
...
tff_setup_transitions()
{
    if ( !_func_21E( "df_baghdad_middle_tr" ) )
        thread tff_trans_intro_to_middle();

    if ( !_func_21E( "df_baghdad_outro_tr" ) )
...
tff_trans_intro_to_middle()
{
    ...
    _func_219( "df_baghdad_intro_tr" );
    _func_218( "df_baghdad_middle_tr" );

    while ( !_func_21E( "df_baghdad_middle_tr" ) )
        wait 0.05;
...
tff_trans_middle_to_outro()
{
    ...
    _func_219( "df_baghdad_middle_tr" );
    _func_218( "df_baghdad_outro_tr" );

    while ( !_func_21E( "df_baghdad_outro_tr" ) )
        wait 0.05;
...
create_fx_ent_setup()
{
    ...
    for (;;)
    {
        ...
        var_1 thread maps\_anim::anim_single_solo( var_0, "intro_pod_scene" );
        wait 0.05;
        var_0 _meth_8117( level.scr_anim["pergola"]["intro_pod_scene"], var_3 );
