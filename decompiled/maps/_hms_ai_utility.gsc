...
_updateenemygroupdirection()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_3 in var_0 )
            var_1 = var_1 + vectornormalize( var_3.origin - self.origin );
...
_determineallynodescore( var_0, var_1, var_2 )
{
    ...
    var_3 = var_3 + _evaluatenoderangetoplayer( var_1, var_2 );
    var_3 = var_3 + _evaluatenodeplayervisibility( var_1 );
    return var_3 / 3;
}
...
_determineshotgunnodescore( var_0, var_1, var_2 )
{
    ...
    var_3 = var_3 + _evaluatenodeplayerinradius( var_1 );
    var_3 = var_3 + _evaluatenodeiscover( var_1 );
    var_3 = var_3 + _evaluatenodeisexposed( var_1 );
    var_3 = var_3 + _evaluatenodeinplayerfov( var_1 );
    var_3 = var_3 + _evaluatenodelostoplayer( var_1 );
    var_3 = var_3 + _evaluatenodeattackradius( var_1, var_2 );
    var_3 = var_3 * _evaluatenodeothershotgunnersbest( var_1, var_0 );
    var_3 = var_3 / 7;
    return var_3;
}
...
painmanagement( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        var_4.amount = var_4.amount - var_3;
...
_updatepainamount( var_0 )
{
    for (;;)
    {
        ...
        wait 0.05;
        var_0.amount = var_0.amount + var_1;
    }
}
