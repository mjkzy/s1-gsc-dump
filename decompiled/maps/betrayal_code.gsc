...
confrontation_hudoutline_cleanup()
{
    ...
    for ( var_2 = 0; var_2 < var_1; var_2++ )
    {
        ...
        var_5 = 1.0 / var_1;
        level.chromo_offset = level.chromo_offset - var_4;
        level.hudoutline_conf_intensity = level.hudoutline_conf_intensity - var_5;
...
roof_scene_slide()
{
    ...
    for ( var_4 = 0; var_4 < var_3.size; var_4++ )
    {
        ...
        var_3[var_4].baseaccuracy = var_3[var_4].baseaccuracy / 2;
...
oldtown_dock_mech_damage_function( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( var_1 == level.ilana )
    {
        if ( self.health > 0 && var_0 > self.bullet_resistance )
            self.health = self.health + int( ( var_0 - self.bullet_resistance ) * 0.5 );
    }
}
...
boat_scene_play_target_lock_sound_loop( var_0 )
{
    ...
    for ( var_1 = 0; var_1 < var_0 && !self vehicle_diveboatissubmerged(); var_1 = var_1 + 0.35 )
    {
