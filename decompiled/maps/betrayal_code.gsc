...
climb_scene_finale_setup_people_ents()
{
    ...
    var_0[1] maps\betrayal_anim::assign_cloak_model( "body_hero_cormack_sentinel_covert_cloak" );
    ...
    var_0[4] maps\betrayal_anim::assign_cloak_model( "sentinel_covert_body_a" );
    ...
    var_0[5] maps\betrayal_anim::assign_cloak_model( "sentinel_covert_body_a" );
