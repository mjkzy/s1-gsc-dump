...
{
    playfxontag( common_scripts\utility::getfx( "gun_flash_kva_intro" ), var_0, "TAG_WEAPON_RIGHT" );
...
{
    wait 0.25;
    playfxontag( common_scripts\utility::getfx( "exo_door_impact_kick_dust" ), var_0, "smash_pusher" );
    wait 0.05;
    playfxontag( common_scripts\utility::getfx( "exo_door_hinge_piece" ), var_0, "smash_R" );
    wait 10;
    stopfxontag( common_scripts\utility::getfx( "exo_door_hinge_piece" ), var_0, "smash_R" );
    stopfxontag( common_scripts\utility::getfx( "exo_door_impact_kick_dust" ), var_0, "smash_pusher" );
}

exo_door_break( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "door_exo_breach_impact" ), var_0, "smash_pusher" );
    wait 10;
    stopfxontag( common_scripts\utility::getfx( "door_exo_breach_impact" ), var_0, "smash_pusher" );
}

pigeons_camera_view_zone3000()
{
    common_scripts\utility::flag_wait( "msg_fx_zone2_train_station" );
    var_0 = [ ( -51893.4, 12335.6, 1143.03 ), ( -53287.2, 11359.1, 1244.34 ), ( -52160.6, 11411.6, 1783.72 ), ( -49482.6, 9896.68, 1342.71 ), ( -50370, 10799, 1225 ), ( -53668.5, 9382.25, 1245.96 ), ( -54590.9, 11026.9, 1121.91 ), ( -48566.8, 8800.03, 734.885 ), ( -50364.1, 12368.1, 1106.27 ) ];
    var_1 = [ ( 270, 172.875, 96.1244 ), ( 270, 180, 39.9991 ), ( 270, 180, 43.9992 ), ( 270, 0, 133.999 ), ( 270, 0, 160 ), ( 270, 188.531, 57.4673 ), ( 270, 0, -154.002 ), ( 270, 0, 151.999 ), ( 270, 3.57633, 111.422 ) ];
    thread maps\_shg_fx::start_fx_by_view( "pigeon_flock_vista_runner", var_0, 3, 3, "msg_fx_zone4_government_building", 0, var_1 );
}

player_mag_glove_activate_wallclimb( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "exo_r_gloves_disengage" ), var_0, "J_Wrist_RI" );
    playfxontag( common_scripts\utility::getfx( "exo_l_gloves_disengage" ), var_0, "J_Wrist_LE" );
}

player_mag_glove_off( var_0 )
{
    var_0 endon( "death" );
    ...
    waitframe();
    killfxontag( common_scripts\utility::getfx( "exo_r_gloves_disengage" ), var_0, "J_Wrist_RI" );
    killfxontag( common_scripts\utility::getfx( "exo_l_gloves_disengage" ), var_0, "J_Wrist_LE" );
    waitframe();
    killfxontag( common_scripts\utility::getfx( "exo_r_gloves_engage" ), var_0, "J_Wrist_RI" );
    killfxontag( common_scripts\utility::getfx( "exo_l_gloves_engage" ), var_0, "J_Wrist_LE" );
}

player_hand_plant_lf_wallclimb( var_0 )
{
    killfxontag( common_scripts\utility::getfx( "exo_l_gloves_disengage" ), var_0, "J_Wrist_LE" );
    playfxontag( common_scripts\utility::getfx( "exo_l_gloves_engage_slow" ), var_0, "J_Wrist_LE" );
    playfxontag( common_scripts\utility::getfx( "dust_mag_l_glove_impact" ), var_0, "J_Mid_LE_0" );
}

player_mag_glove_lglove_disengage( var_0 )
{
    killfxontag( common_scripts\utility::getfx( "exo_l_gloves_engage_slow" ), var_0, "J_Wrist_LE" );
    killfxontag( common_scripts\utility::getfx( "exo_l_gloves_engage" ), var_0, "J_Wrist_LE" );
    playfxontag( common_scripts\utility::getfx( "exo_l_gloves_disengage" ), var_0, "J_Wrist_LE" );
...
player_hand_plant_rt_wallclimb( var_0 )
{
    killfxontag( common_scripts\utility::getfx( "exo_r_gloves_disengage" ), var_0, "J_Wrist_RI" );
    playfxontag( common_scripts\utility::getfx( "exo_r_gloves_engage_slow" ), var_0, "J_Wrist_RI" );
    playfxontag( common_scripts\utility::getfx( "dust_mag_r_glove_impact" ), var_0, "J_Mid_RI_0" );
}

player_mag_glove_rglove_disengage( var_0 )
{
    killfxontag( common_scripts\utility::getfx( "exo_r_gloves_engage_slow" ), var_0, "J_Wrist_RI" );
    killfxontag( common_scripts\utility::getfx( "exo_r_gloves_engage" ), var_0, "J_Wrist_RI" );
    playfxontag( common_scripts\utility::getfx( "exo_r_gloves_disengage" ), var_0, "J_Wrist_RI" );
...
burke_hand_plant_lf_wallclimb( var_0 )
{

}

burke_hand_plant_rt_wallclimb( var_0 )
{
...
roof_breach_device_plant_dust( var_0 )
{

}

roof_breach_device_area_mark( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "roof_breach_device_laser" ), var_0, "tag_fx" );
    wait 0.4;
    playfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_1" );
    playfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_2" );
    playfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_3" );
    playfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_4" );
    wait 1;
    stopfxontag( common_scripts\utility::getfx( "roof_breach_device_laser" ), var_0, "tag_fx" );
    level waittill( "kill_fx_burnmarks" );
    waitframe();
    killfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_1" );
    killfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_2" );
    killfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_3" );
    killfxontag( common_scripts\utility::getfx( "roof_breach_device_laser_cut_fast" ), var_0, "tag_laser_4" );
}

roof_breach_device_plant_mini_charges( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "roof_breach_device_radial_blast_charges" ), var_0, "tag_fx" );
    level notify( "kill_fx_burnmarks" );
    earthquake( 0.5, 0.5, level.player.origin, 100 );
}

roof_breach_device_radial_sml_explosions( var_0 )
{

}

roof_breach_chunks_bursts( var_0 )
{
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_02" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_03" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_05" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_06" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_07" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_08" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_13" );
    wait 0.1;
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_12" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_15" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_16" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_18" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_21" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_24" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_25" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_09" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_10" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_17" );
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_20" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_22" );
    wait 3.6;
    thread landing_dust_team();
    wait 3;
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_02" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_03" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_05" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_06" );
    waitframe();
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_07" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_08" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_lrg" ), var_0, "jo_lag_govt_roof_chunk_13" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_12" );
    waitframe();
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_15" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_16" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_18" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_21" );
    waitframe();
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_24" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_med" ), var_0, "jo_lag_govt_roof_chunk_25" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_09" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_10" );
    waitframe();
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_17" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_20" );
    stopfxontag( common_scripts\utility::getfx( "ground_concrete_breach_burst_sml" ), var_0, "jo_lag_govt_roof_chunk_22" );
}
...
roof_breach_device_explosion( var_0 )
{
...
handcuff_break_fx( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "lag_pm_handcuff_break" ), var_0, "tag_origin" );
}
...
gate_controlbox_broken_fx( var_0 )
{
    wait 0.1;
    playfxontag( common_scripts\utility::getfx( "lag_gate_controlbox_broken" ), var_0, "panelBox" );
    wait 1.2;
    common_scripts\_exploder::exploder( "gate_dust_falling" );
}

pull_fence_dust( var_0 )
{
    wait 0.1;
...
vista_pigeons_alley1_market()
{
    ...
    var_0 = [ ( -46713.5, 3542.82, 945.343 ), ( -45592.5, 3600.9, 1155.3 ), ( -47504, 3855.55, 895.125 ), ( -47839.8, 1572.01, 849.537 ), ( -48173, 1032.6, 904.365 ), ( -46939.5, 324.496, 817.125 ), ( -46313.5, -194.44, 1055.14 ), ( -47910.4, 265.494, 899.135 ), ( -46925.6, 1474.19, 1228.12 ), ( -46696, 2669.63, 959.955 ), ( -46389.5, 3813.8, 869.748 ), ( -44890.1, 3729.2, 712.27 ), ( -45386.6, 3484.48, 657.968 ), ( -44975.2, 3505.28, 902.054 ), ( -46211.4, 3678.51, 748.553 ), ( -46980.2, 3722.23, 853.378 ) ];
    var_1 = [ ( 270, 0, -165 ), ( 270, 0, 174 ), ( 270, 0, 153 ), ( 270, 225, 25.9989 ), ( 270, 180, 66.999 ), ( 270, 0, 127.998 ), ( 270, 0, 154.998 ), ( 270, 180, 92.9972 ), ( 270, 14.0362, 88.9604 ), ( 270, 14.0362, 88.9604 ), ( 270, 0, -165 ), ( 270, 0, -169 ), ( 270, 0, -179 ), ( 270, 0, -179 ), ( 270, 0, 160 ), ( 270, 0, 175 ) ];
    thread maps\_shg_fx::start_fx_by_view( "pigeon_flock_vista_runner", var_0, 4, 4, "msg_fx_zone10a_froggercrossing", 0, var_1 );
}

truck_dust_trail( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "veh_trail_dust" ), var_0, "tag_origin" );
    wait 12;
    stopfxontag( common_scripts\utility::getfx( "veh_trail_dust" ), var_0, "tag_origin" );
}

truck_treadfx_wheels( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_front_left" );
    playfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_front_right" );
    level waittill( "stop_nonvisible_treads" );
    stopfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_front_left" );
    stopfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_front_right" );
}

truck_treadfx_skid( var_0 )
{
    var_1 = common_scripts\utility::spawn_tag_origin();
...
truck_treadfx_turn( var_0 )
{
    ...
    playfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_front_right" );
    wait 3;
    playfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_back_right" );
    stopfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_front_left" );
    wait 4;
    stopfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_front_right" );
    stopfxontag( common_scripts\utility::getfx( "tread_dirt_thick" ), var_0, "tag_wheel_back_right" );
}

gideon_slide_dust( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "dust_foot_slide" ), var_0, "tag_origin" );
    wait 0.75;
    stopfxontag( common_scripts\utility::getfx( "dust_foot_slide" ), var_0, "tag_origin" );
}
...
kva_pickup_wheel_skid_ram( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "single_wheel_brake_skid_asphalt" ), var_0, "TAG_WHEEL_BACK_RIGHT" );
    playfxontag( common_scripts\utility::getfx( "single_wheel_brake_skid_asphalt" ), var_0, "TAG_WHEEL_FRONT_right" );
    wait 1.75;
    stopfxontag( common_scripts\utility::getfx( "single_wheel_brake_skid_asphalt" ), var_0, "TAG_WHEEL_BACK_RIGHT" );
    stopfxontag( common_scripts\utility::getfx( "single_wheel_brake_skid_asphalt" ), var_0, "TAG_WHEEL_FRONT_RIGHT" );
}

kva_pickup_hit_bus( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "lag_mtkdown_kva_truck_side_swipe" ), var_0, "TAG_door_right_front" );
    thread bus_kva_impact_sparks();
    wait 5;
    stopfxontag( common_scripts\utility::getfx( "lag_mtkdown_kva_truck_side_swipe" ), var_0, "TAG_door_right_front" );
}
...
player_land_on_hood( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "lag_mtkdown_kva_truck_windshield_smash_smoke" ), var_0, "TAG_HOOD" );
    wait 2.5;
    stopfxontag( common_scripts\utility::getfx( "lag_mtkdown_kva_truck_windshield_smash_smoke" ), var_0, "TAG_HOOD" );
}

kva_pickup_hit_windshield( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "lag_mtkdown_kva_truck_windshield_smash" ), var_0, "windowArmor_FL" );
    wait 2.5;
    playfxontag( common_scripts\utility::getfx( "lag_mtkdown_kva_truck_windshield_smash_smoke" ), var_0, "tag_hood" );
}

kva_death_impact_post( var_0 )
{
...
kva_pickup_hit_divider_01( var_0 )
{
...
kva_pickup_hit_divider_03( var_0 )
{
    wait 0.8;
    playfxontag( common_scripts\utility::getfx( "lag_mtkdown_kva_truck_flip_collision" ), var_0, "tag_origin" );
...
kva_pickup_flip_and_skid( var_0 )
{
    wait 0.9;
...
fake_tread_fx_hostage_truck( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "dust_tread_fx" ), var_0, "tag_wheel_front_right" );
    playfxontag( common_scripts\utility::getfx( "dust_tread_fx" ), var_0, "tag_wheel_back_right" );
    level waittill( "kill_hostage_truck_tread_fx" );
    stopfxontag( common_scripts\utility::getfx( "dust_tread_fx" ), var_0, "tag_wheel_front_right" );
    stopfxontag( common_scripts\utility::getfx( "dust_tread_fx" ), var_0, "tag_wheel_back_right" );
}

truck_rearview_mirror_snap( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "lag_tkdown_truck_rvmirror_snap" ), var_0, "tag_mirror_right" );
}

vm_hand_sparks( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "sparks_skid_asphalt_sml" ), var_0, "J_Wrist_LE" );
    wait 0.65;
    playfxontag( common_scripts\utility::getfx( "sparks_skid_asphalt_sml" ), var_0, "J_Wrist_LE" );
}

truck_headon_collision( var_0 )
{
    wait 0.25;
    playfxontag( common_scripts\utility::getfx( "lag_truck_headon_impact" ), var_0, "tag_origin" );
    wait 2;
...
truck_rail_impact( var_0 )
{
    wait 0.5;
    playfxontag( common_scripts\utility::getfx( "lag_tkdown_truck_barrier_break" ), var_0, "tag_origin" );
    ...
    stopfxontag( common_scripts\utility::getfx( "lag_tkdown_truck_barrier_break" ), var_0, "tag_origin" );
...
truck_water_impact( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "underwater_splash_foam" ), var_0, "tag_origin" );
    ...
    killfxontag( common_scripts\utility::getfx( "underwater_splash_foam" ), var_0, "tag_origin" );
    level waittill( "kill_above_water_splashes" );
...
water_bubbles_transition_player_view()
{
    ...
    wait 2.5;
    stopfxontag( common_scripts\utility::getfx( "underwater_bubble_vm_transition_lp" ), var_0, "tag_origin" );
    waitframe();
    var_0 delete();
}
...
ambient_underwater_effects_rescue( var_0 )
{
    wait 5;
...
truck_latch_open_trail( var_0 )
{
    ...
    wait 11.25;
    stopfxontag( common_scripts\utility::getfx( "lag_tkdown_truck_latch_door_open" ), var_1, "tag_origin" );
    waitframe();
    var_1 delete();
}

truck_cargo_door_open( var_0 )
{

}

hostage_drowned_bubble_trails( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_spineupper" );
    wait 0.5;
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_head" );
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_med" ), var_0, "J_SpineLower" );
    wait 2;
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_head" );
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_spineupper" );
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_med" ), var_0, "J_SpineLower" );
}

gideon_bubble_trails( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_spineupper" );
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "J_Knee_ri" );
    wait 2;
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "J_Knee_ri" );
    wait 2;
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_sml_lp" ), var_0, "j_wrist_ri" );
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_med" ), var_0, "j_knee_ri" );
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "J_Knee_le" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_ankle_le" );
    wait 2.5;
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_sml_lp" ), var_0, "j_wrist_le" );
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_med" ), var_0, "j_knee_ri" );
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_ankle_le" );
    wait 1;
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_sml_lp" ), var_0, "j_wrist_ri" );
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "J_Knee_le" );
    level waittill( "kill_underwater_effects" );
    wait 0.1;
    killfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_spineupper" );
    killfxontag( common_scripts\utility::getfx( "bubble_trail_runner_sml_lp" ), var_0, "j_wrist_le" );
}

hostage_rescued_bubble_trails( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_spineupper" );
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_ankle_le" );
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_wrist_ri" );
    wait 2;
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_wrist_ri" );
    wait 1;
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_ankle_le" );
    level waittill( "kill_underwater_effects" );
    wait 0.35;
...
gideon_swim_stroke_up( var_0 )
{
    level endon( "kill_underwater_effects" );
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_wrist_le" );
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_spineupper" );
    wait 1;
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_ankle_le" );
    wait 2;
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_wrist_le" );
    wait 1;
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_spineupper" );
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_ankle_le" );
}
...
player_gasping_breath()
{
    ...
    playfxontag( common_scripts\utility::getfx( "underwater_bubble_vm_gasping_breath" ), var_0, "tag_origin" );
    wait 1.5;
    killfxontag( common_scripts\utility::getfx( "underwater_bubble_vm_gasping_breath" ), var_0, "tag_origin" );
    var_0 delete();
}
