...
detonate_foam_grenade( var_0 )
{
    ...
    var_1.origin = var_1.origin + ( 0, 0, 5 );
...
create_foam_matrix( var_0 )
{
    ...
    for ( var_7 = 0; var_7 < 16; var_7++ )
    {
        ...
        for ( var_12 = var_1 / 8 - var_1 * 0.01 * var_7; var_8 < var_12; var_10++ )
        {
            ...
            for ( var_16 = 0; var_16 < 360; var_16 = var_16 + var_15 )
            {
                var_4.angles = var_4.angles + ( 0, var_16, 0 );
                ...
                if ( var_18["fraction"] >= 1 && isvalidfoamspace( var_17 ) )
                {
                    ...
                    if ( var_10 > 1 )
                        var_3.origin = var_3.origin + ( randomfloatrange( -6, 6 ), randomfloatrange( -6, 6 ), randomfloatrange( -6, 6 ) );
        ...
        if ( bullettracepassed( var_4.origin, var_4.origin + ( 0, 0, var_5 ), 0, undefined, 0 ) )
            var_4.origin = var_4.origin + ( 0, 0, var_5 );
    }
