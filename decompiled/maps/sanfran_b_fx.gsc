...
vfx_heli_drop_off_intro_on()
{
    ...
    maps\_utility::delaythread( 7.0, maps\_utility::pauseexploder, 4004 );
    maps\_utility::delaythread( 10.0, maps\_utility::pauseexploder, 4002 );
    maps\_utility::delaythread( 10.0, common_scripts\_exploder::exploder, 4001 );
    ...
    maps\_utility::delaythread( 15.0, maps\_utility::pauseexploder, 4003 );
    maps\_utility::delaythread( 16.0, maps\_utility::pauseexploder, 4005 );
    thread maps\sanfran_b_lighting::dof_car_explosion();
    maps\_utility::delaythread( 90.0, maps\_utility::pauseexploder, 4001 );
}
...
{
    var_0 = getentarray( "godray_destroyed", "targetname" );
    var_1 = getentarray( "godray_destroyed_dim", "targetname" );
    var_2 = getentarray( "window_explosion_wait", "targetname" );

    if ( isdefined( var_0[0] ) )
        common_scripts\utility::array_thread( var_0, ::shadow_godray_window_large_think );

    if ( isdefined( var_1[0] ) )
        common_scripts\utility::array_thread( var_1, ::shadow_godray_window_large_dim_think );

    if ( isdefined( var_2[0] ) )
        common_scripts\utility::array_thread( var_2, ::window_explosion_wait_think );
}
