...
main_s3interrogate()
{
    ...
    {
        var_7 common_scripts\utility::delaycall( 0.5, ::_meth_83EF, var_5 );
        var_7 common_scripts\utility::delaycall( 0.5, ::_meth_83AB, var_5.origin );
    }
    ...
    foreach ( var_16 in getentarray( "model_s3interrogation_doorin", "targetname" ) )
        var_16 _meth_804D( var_14 );

    wait 10.0;
    var_14 _meth_82AE( var_14.origin - ( 0, 90, 0 ), 2, 2, 0 );
    level.player common_scripts\utility::delaycall( 114.3, ::_meth_80AD, "heavy_2s" );
    level.player common_scripts\utility::delaycall( 118.1, ::_meth_80AD, "heavy_2s" );
    wait(var_13 - 20);
    ...
    level.player common_scripts\utility::delaycall( 23.5, ::_meth_8031, 65, 4 );
    maps\_utility::delaythread( 24.75, ::breakout_opfor_cleanup, var_0, var_1, var_4, var_3 );
    level.player common_scripts\utility::delaycall( 24, ::_meth_807D, var_12[1], "tag_player", 0.5, 20, 30, 15, 15, 1 );
    level.player common_scripts\utility::delaycall( 24, ::_meth_80FE, 0.3, 0.15 );
...
s3_interrogate_doctor_scene()
{
    ...
    var_2 _meth_80B1( "cap_morgue_body_c" );
...
breakout_opfor_cleanup( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_5 _meth_83C7( var_5 maps\_utility::getanim( "s3_breakout" ), 0 );
...
main_s3escape()
{
    ...
    var_2 _meth_82AE( var_2.origin + ( 0, 0, 112 ), 1, 0.2, 0.05 );
    ...
    var_4 _meth_82AE( var_4.origin + ( 0, 0, 150 ), 1.5, 0.2, 0.05 );
...
s3escape_console_setup()
{
    ...
    _func_057( "captured_elevator_controls", 0, 1.0, 1 );
    ...
    var_0 = _func_231( "s3_escape_console_monitor", "targetname" );
    ...
    {
        level.s3_escape_console_monitor _meth_83F6( 0, 0 );
        wait 0.2;

        if ( !common_scripts\utility::flag( "s3_escape_console_monitor_unfreeze" ) )
        {
            level.s3_escape_console_monitor _meth_83F6( 0, 1 );
            wait 0.2;
        }
    }
}
...
s3escape_console_cinematic_watcher()
{
    ...
    while ( _func_22B() < 10270 )
        waitframe();

    wait 1;
    level.s3_escape_console_monitor _meth_83F6( 0, 3 );
}
...
s3escape_intro_scene( var_0 )
{
    ...
    var_2 _meth_82AE( var_2.origin + ( 0, 90, 0 ), 2, 2, 0 );
    ...
    if ( level.currentgen )
    {
        ...
        var_6 = getent( "model_s3escape_doorout_coll", "targetname" );
        var_6 _meth_8057();
        var_2 _meth_82AE( var_2.origin - ( 0, 90, 0 ), 0.25, 0.25, 0 );
        wait 1.0;
...
s3escape_doctor_scene()
{
    ...
    var_2 _meth_80B1( "cap_hanging_bodybag" );
    var_2.animname = "escape_bodybag";
    var_2 maps\_anim::setanimtree();
    var_3 = spawn( "script_model", var_2.origin );
    var_3 _meth_80B1( "trolley_block" );
    var_3 _meth_804D( var_2, "tag_origin", ( 0, 0, 6 ), ( 0, 0, 0 ) );
    var_4 = spawn( "script_model", var_0.origin );
    var_4 _meth_80B1( "det_patient_chart_01" );
    ...
    var_6 common_scripts\utility::delaycall( 7.5, ::_meth_82AE, var_6.origin, 1.5, 1.5, 0 );
    var_6 _meth_82AE( var_6.origin + ( 0, 90, 0 ), 1.5, 1.5, 0 );
...
s3_enter_security_room( var_0, var_1 )
{
    ...
    var_10 _meth_80B1( "cap_lab_chair" );
    ...
    var_9 _meth_83C7( %cap_s3_escape_takedown_guard_01, 0 );
    ...
    var_12 _meth_8048( "tag_rail_master_on" );
...
s3_escape_outer_door()
{
    ...
    var_1 _meth_80B1( "cpt_hinge_door_rght_01" );
    var_2 = getent( "s3_escape_security_door_col", "targetname" );
    var_2 _meth_804D( var_1, "j_bone_door_right", ( 28, 1.5, 48 ), ( 0, 0, 0 ) );
...
s3_escape_sliding_door_player( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) )
        var_0 _meth_82AE( var_0.origin + ( 0, 53, 0 ), 1, 0.25, 0.25 );
    else
        var_0 _meth_82AE( var_0.origin - ( 0, 53, 0 ), 1, 0.25, 0.25 );
...
s3_escape_player_exo_and_gun_anim( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    level.player _meth_8080( var_2, "tag_player", 0.5 );
    wait 0.5;
    var_2 show();
    level.player _meth_807D( var_2, "tag_player", 0.75, 45, 45, 30, 30, 1 );
    level.player common_scripts\utility::delaycall( 3.5, ::_meth_80AD, "light_2s" );
    level.player common_scripts\utility::delaycall( 4.25, ::_meth_8031, 42, 1 );
    level.player common_scripts\utility::delaycall( 6, ::_meth_8031, 65, 3 );
    wait(var_4 - 0.5);
    var_2 delete();
    ...
    level.player _meth_830E( "iw5_titan45onearmgundown_sp" );
    level.player _meth_82F7( "iw5_titan45onearmgundown_sp", 0 );
    level.player _meth_8315( "iw5_titan45onearmgundown_sp" );
    level.player _meth_8130( 0 );
...
s3_splitup_event( var_0 )
{
    ...
    var_10 _meth_80B1( "vm_titan45_nocamo" );
    var_10 _meth_804D( var_9, "tag_weapon_right", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    ...
    level.s3_escape_console_monitor _meth_83F6( 0, 2 );
    level.player _meth_8080( var_9, "tag_player", 0.5 );
    wait 0.5;
    level.player freezecontrols( 0 );
    var_9 show();
    level.player _meth_807D( var_9, "tag_player", 1, 0, 0, 0, 0, 1 );
    ...
    level.allies[0] _meth_81A5( var_14 );
    wait 3.0;
    ...
    if ( !common_scripts\utility::flag( "s3_player_pickedup_console_gun" ) )
    {
        ...
        level.player _meth_8316( "iw5_kvahazmatknifeonearm_sp" );
        var_10 delete();
    ...
    var_15 _meth_82AE( var_15.origin - ( 0, 0, 112 ), 1, 0.2, 0.05 );
...
s3_escape_elevator_movement()
{
    ...
    var_2 _meth_82AE( var_2.origin + ( 52, 0, 0 ), 0.75, 0.2, 0.05 );
    var_3 = getent( "s3_escape_door_right", "targetname" );
    var_3 _meth_82AE( var_3.origin + ( -52, 0, 0 ), 0.75, 0.2, 0.05 );
    ...
    foreach ( var_5 in var_0 )
    {
        if ( var_5.classname == "script_model" )
            var_5 _meth_804D( var_1 );
    }

    var_1 _meth_82AE( var_1.origin + ( 0, 0, -150 ), 1.5, 0.2, 0.2 );
...
s3_body_movement()
{
    ...
    foreach ( var_2 in var_0 )
        var_2 _meth_82AE( var_2.origin - ( 0, 160, 0 ), 4, 0.05, 0.05 );
}
...
s3escape_fade_to_black( var_0 )
{
    ...
    var_1 _meth_80CC( "black", 1280, 720 );
...
injured_player_wobble()
{
    ...
    while ( !common_scripts\utility::flag( "flag_scene_doctor_done" ) )
    {
        ...
        var_5 = var_3 - var_4;
        var_0 _meth_82B5( ( var_2[0] + randomfloatrange( var_1 * -1, var_1 ), var_2[1] + randomfloatrange( var_1 * -1, var_1 ), var_2[2] + randomfloatrange( var_1 * -1, var_1 ) ), var_3, var_4, var_5 );
        wait(var_3);
        var_3 = randomfloatrange( 3, 5 );
        var_4 = randomfloatrange( 0, var_3 );
        var_5 = var_3 - var_4;
        var_0 _meth_82B5( var_2, var_3, var_4, var_5 );
        wait(var_3);
    }
...
injured_player_blur()
{
    ...
    while ( !common_scripts\utility::flag( "flag_scene_doctor_done" ) )
    {
        ...
        _func_072( randomfloatrange( 1, 3 ), var_0 );
        wait(var_0);
        _func_072( 0, var_0 );
        wait(var_0);
        wait(randomfloatrange( 3, 5 ));
