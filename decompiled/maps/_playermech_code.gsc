...
playermech_damage_manager()
{
    ...
    for (;;)
    {
        ...
        self.mechdata.health = self.mechdata.health - var_1 / level.damage_multiplier_mod * 0.25;
...
rocket_swarm_path_think( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_5 = 50.0;
        var_4 = var_4 + ( randomfloatrange( var_5 * -1.0, var_5 ), randomfloatrange( var_5 * -1.0, var_5 ), 0 );
    }
    ...
    {
        var_4 = var_4 + rocket_swarm_get_height_offset( var_0 );
...
rocket_swarm_start_position( var_0, var_1 )
{
    ...
    if ( var_1 >= var_6 )
    {
        var_8 = var_8 + ( 0, 0, var_3 );
        var_1 = var_1 - var_6;
    }
    else
        var_8 = var_8 - ( 0, 0, var_3 );

    var_8 = var_8 + ( 0, var_7 * var_1 - var_5, 0 );
