...
setup_mob_turret()
{
    ...
    if ( level.nextgen )
    {
        ...
        level.player setclutforplayer( "", 1.0 );
    ...
    var_4 setmodel( "vehicle_mob_deck_large_calibur_turret_vm" );
    var_5 = ( -0.99, 0, 0 );
    ...
    var_8 setmodel( "vehicle_mob_deck_large_calibur_turret_vm" );
    var_5 = ( -0.55, 0.45, 0 );
...
link_player_to_mob_turret( var_0, var_1 )
{
    ...
    var_0 setflaggedanimknob( "turret_transform", %sf_b_mob_turret_transform, 1, 0, 1 );
    var_9 = undefined;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        if ( var_1 < 0 )
        {
            ...
            var_0 setanimknob( var_0.mob_pitch_anim, 1, 0, 0 );
            var_0 setanimtime( var_0.mob_pitch_anim, var_9 );
        }
        else
        {
    ...
    if ( var_2 )
    {
        self unlink();
        var_12 = 2.65;
        self playerlinktoblend( var_8, "tag_origin", var_12, 0.25, 0.25 );
        common_scripts\utility::delaycall( var_12, ::playerlinktodelta, var_8, "tag_origin", 1, 0, 0, 0, 0, 1 );
    }

    var_0 waittillmatch( "turret_transform", "end" );
    var_0.mob_yaw_anim = %sf_b_mob_turret_center_to_r;
    var_0.mob_yaw_sign = -1;
    var_0 setanimknoball( var_0.mob_yaw_anim, %root, 1, 0, 0 );
...
control_mob_turret( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self.mob_yaw_anim ) )
        {
            var_4 = self getanimtime( self.mob_yaw_anim );
        ...
        else if ( var_4 == 0 )
        {
            ...
            self setanimknob( self.mob_yaw_anim, 1, 0, abs( var_3 ) );
        ...
        else if ( var_4 > 0 )
        {
            self.mob_yaw_anim = %sf_b_mob_turret_center_to_l;
            self.mob_yaw_sign = 1;
            self setanimknob( self.mob_yaw_anim, 1, 0, var_3 * -1 );
            soundscripts\_snd::snd_message( "mob_turret_move", "lat_move" );
            self setanimtime( self.mob_yaw_anim, var_4 );
        }
        else
        {
            self.mob_yaw_anim = %sf_b_mob_turret_center_to_r;
            self.mob_yaw_sign = -1;
            self setanimknob( self.mob_yaw_anim, 1, 0, var_3 );
            soundscripts\_snd::snd_message( "mob_turret_move", "lat_move" );
            self setanimtime( self.mob_yaw_anim, var_4 * self.mob_yaw_sign );
        }
        ...
        {
            var_5 = self getanimtime( self.mob_pitch_anim );
        ...
        else if ( var_5 > 0 )
        {
            self.mob_pitch_anim = %sf_b_mob_turret_center_to_low;
            self.mob_pitch_sign = 1;
            self setanimknob( self.mob_pitch_anim, 1, 0, var_2 * -1 );
            soundscripts\_snd::snd_message( "mob_turret_move", "vert_move" );
            self setanimtime( self.mob_pitch_anim, var_5 );
        }
        else
        {
            self.mob_pitch_anim = %sf_b_mob_turret_center_to_up;
            self.mob_pitch_sign = -1;
            self setanimknob( self.mob_pitch_anim, 1, 0, var_2 );
            soundscripts\_snd::snd_message( "mob_turret_move", "vert_move" );
            self setanimtime( self.mob_pitch_anim, var_5 * self.mob_pitch_sign );
        }
...
attachdistortionfx( var_0 )
{
    ...
    var_1 linkto( var_0, "tag_player", ( 5, 0, 0 ), ( 0, 0, 0 ) );
...
railgun_hud_update()
{
    ...
    for (;;)
    {
        ...
        luinotifyevent( &"railgun_hud_update", 3, var_0, var_1, var_2 );
        waitframe();
    }
}
