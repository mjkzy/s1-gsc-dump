...
setup_mob_turret()
{
    ...
    var_4.angles = ( -5, 0, 5 );
    var_4.angles = var_4.angles - ( 0, 325, 0 );
    ...
    var_8.angles = ( 5, 0, -5 );
    var_8.angles = var_8.angles + ( 0, 152, 0 );
...
control_mob_turret( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self.mob_pitch_anim ) )
        {
            ...
            var_5 = var_5 * self.mob_pitch_sign;
        }
...
control_mob_fire()
{
    ...
    for (;;)
    {
        if ( level.player attackbuttonpressed() )
        {
            ...
            for ( self.ms_until_ready_to_fire = var_0; self.ms_until_ready_to_fire > 0; self.ms_until_ready_to_fire = self.ms_until_ready_to_fire - 50 )
                wait 0.05;
        }
...
railgun_track_damage( var_0, var_1 )
{
    ...
    while ( self.health > 0 )
    {
        ...
        {
            self.health = self.health + int( var_6 * 0.9 );
