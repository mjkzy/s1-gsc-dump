...
intro_droppod_blimp_detach01( var_0 )
{
...
intro_droppod_blimp_detach02( var_0 )
{
    wait 0.35;
    var_1 = common_scripts\utility::spawn_tag_origin();
...
intro_blimp_missile( var_0 )
{
    wait 1;
    var_0 soundscripts\_snd::snd_message( "droppod_intro_blimp_missile" );
    playfxontag( common_scripts\utility::getfx( "seo_intro_misl_trail" ), var_0, "tag_origin" );
    common_scripts\_exploder::exploder( "100" );
}

intro_blimp_missile_trail_delete( var_0 )
{
    wait 5;
    stopfxontag( common_scripts\utility::getfx( "seo_intro_misl_trail" ), var_0, "tag_origin" );
}
...
intro_blimp_explode( var_0 )
{
    ...
    thread intro_blimp_explode2( var_0 );
    wait 1;
    var_2 delete();
    var_3 delete();
    wait 4;
...
intro_blimp_explode2( var_0 )
{
    ...
    thread intro_blimp_explode3( var_0 );
    wait 0.8;
    playfxontag( common_scripts\utility::getfx( "seo_intro_blimp_explo2" ), var_1, "tag_origin" );
    playfxontag( common_scripts\utility::getfx( "seo_intro_blimp_explo2" ), var_0, "tag_flash_40mm" );
    wait 2;
    var_1 delete();
}
...
intro_blimp_explode3( var_0 )
{
    ...
    thread intro_blimp_explode4( var_0 );
    wait 0.3;
    playfxontag( common_scripts\utility::getfx( "seo_intro_blimp_explo2" ), var_1, "tag_origin" );
    wait 0.3;
    playfxontag( common_scripts\utility::getfx( "seo_intro_blimp_explo2" ), var_0, "tag_flash_105mm" );
    wait 2;
    var_1 delete();
}
...
intro_blimp_explode4( var_0 )
{
    ...
    playfxontag( common_scripts\utility::getfx( "seo_intro_blimp_explo2" ), var_0, "tag_flash_flares" );
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "seo_intro_blimp_explo2" ), var_0, "tag_flash_25mm" );
    wait 5;
    var_1 delete();
}
...
intro_droppod_thrusters( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        waitframe();
        playfxontag( common_scripts\utility::getfx( "seo_intro_drop_pod_thrusters" ), var_2, "tag_fx" );
        var_2 thread intro_droppod_thrusters_stop();
    }
}
...
intro_missile_trail( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "seo_intro_misl_trail" ), var_0, "tag_origin" );
}

intro_missile_trail_delete( var_0 )
{
    stopfxontag( common_scripts\utility::getfx( "seo_intro_misl_trail" ), var_0, "tag_origin" );
}

intro_sinkhole_explo( var_0 )
{
    common_scripts\_exploder::exploder( "sinkhole_explo" );
    level notify( "msg_intro_sinkhole_explo" );
}

intro_missile_hit_pod( var_0 )
{
    level notify( "intro_missile_hit_pod" );
    level notify( "missle_hit" );
    playfxontag( common_scripts\utility::getfx( "seo_intro_misl_hit_pod" ), var_0, "door_F" );
    playfxontag( common_scripts\utility::getfx( "seo_intro_smoke_droppod_door_trail" ), var_0, "door_F" );
    wait 0.4;
    wait 2.2;
    stopfxontag( common_scripts\utility::getfx( "seo_intro_misl_hit_pod" ), var_0, "door_F" );
    killfxontag( common_scripts\utility::getfx( "seo_intro_smoke_droppod_door_trail" ), var_0, "door_F" );
}

intro_pod_door_flyout( var_0 )
{
    wait 0.5;
    var_1 = common_scripts\utility::spawn_tag_origin();
    ...
    stopfxontag( common_scripts\utility::getfx( "seo_intro_smk_droppod_at_door" ), var_4, "tag_origin" );
    stopfxontag( common_scripts\utility::getfx( "seo_intro_smk_droppod_at_door" ), var_5, "tag_origin" );
    wait 2;
    stopfxontag( common_scripts\utility::getfx( "seo_intro_smoke_droppod_door_middle" ), var_2, "tag_origin" );
    wait 5;
    stopfxontag( common_scripts\utility::getfx( "seo_intro_smoke_droppod_door_linger" ), var_0, "emergencyShield_dam_F" );
    wait 3;
    var_2 delete();
    var_1 delete();
    var_3 delete();
...
intro_pod_emergency_door_close( var_0 )
{
    level notify( "msg_emergency_door_close" );
}

intro_droppod_velocity_streaks( var_0 )
{
    ...
    killfxontag( common_scripts\utility::getfx( "seo_intro_pod_wind_streaks" ), var_1, "tag_origin" );
...
intro_pod_hit_building1( var_0 )
{
    ...
    stopfxontag( common_scripts\utility::getfx( "seo_intro_pod_hit_building" ), var_2, "tag_origin" );
    wait 3;
    thread final_pod_crash_fast( var_0 );
    level waittill( "pod_land_apartment" );
    killfxontag( common_scripts\utility::getfx( "seo_intro_pod_exit_building" ), var_2, "tag_origin" );
    waitframe();
    var_2 delete();
    wait 5.5;
    killfxontag( common_scripts\utility::getfx( "seo_intro_missile_hit_pod_sparks" ), var_1, "tag_origin" );
    waitframe();
    var_1 delete();
}
...
final_pod_crash_fast( var_0 )
{
    ...
    level waittill( "pod_land_apartment" );
    wait 1;
    killfxontag( common_scripts\utility::getfx( "seo_intro_pod_hit_building" ), var_1, "tag_origin" );
    var_1 delete();
}

intro_pod_hit_building1_flr1( var_0 )
{

}

intro_pod_hit_building1_flr2( var_0 )
{

}

intro_pod_hit_building1_flr3( var_0 )
{
    level notify( "hit_3" );
}

intro_pod_exit_building1( var_0 )
{
...
intro_pod_hit_building_2( var_0 )
{
    level notify( "intro_pod_crash_end" );
}

intro_pod_hit_apartment( var_0 )
{
    level notify( "pod_land_apartment" );
    playfxontag( common_scripts\utility::getfx( "seo_intro_indoor_dpod_smk_low" ), var_0, "tag_seat03" );
    level waittill( "player_drop_pod_door_kick" );
    stopfxontag( common_scripts\utility::getfx( "seo_intro_indoor_dpod_smk_low" ), var_0, "tag_seat03" );
}

player_drop_pod_se_door_kick( var_0 )
{
    ...
    playfxontag( common_scripts\utility::getfx( "seo_intro_smoke_droppod_door_trail" ), var_0, "emergencyShield_F" );
    ...
    stopfxontag( common_scripts\utility::getfx( "seo_intro_smoke_droppod_door_trail" ), var_0, "emergencyShield_F" );
    stopfxontag( common_scripts\utility::getfx( "seo_intro_smoke_droppod_door_kick" ), var_1, "tag_origin" );
    var_1 delete();
}

cormack_pod_exit_impact( var_0 )
{
    wait 0.95;
...
vista_ambientfx_aa_explosion()
{
    ...
    thread maps\_shg_fx::start_fx_by_view( "aa_explosion_runner_single", var_0, var_2, var_3, "msg_kill_vista_effects", 1, var_1, "seo_vista_amb_explos" );
}

vista_ambientfx_midair_explosion()
{
    level waittill( "vfx_player_control_after_pod_landed" );
    var_0 = [ ( 38645.5, 18055.3, 4353.43 ), ( 50704.9, 14364.3, 3561.84 ), ( 43778.1, 15611.2, 3936.31 ), ( 35991.2, 14052.8, 3841.32 ), ( 44244.7, 7213.38, 4468.32 ), ( 43302.9, 10371.4, 3629.11 ), ( 49811, 11470.7, 5095.18 ), ( 50682, 17398.6, 5364.78 ), ( 45054.1, 12724.6, 7652.58 ), ( 36045.1, 17432.6, 5536.12 ), ( 41472.1, 13800.8, 7226.16 ), ( 39003.7, 7673.85, 6069.51 ) ];
    var_1 = [ ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ) ];
    var_2 = 3;
    var_3 = 3;
    ...
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_midair_runner_single", var_0, var_2, var_3, "msg_kill_vista_effects", 1, var_1, "midair_exp_audio" );
}
...
{
    wait 1;
    var_0[0] = "script_vehicle_mil_cargo_truck";
    var_1[0] = "script_vehicle_ft101_tank";
    var_2 = "vfx/treadfx/tread_dust_ft101_tank";
    var_3 = "vfx/treadfx/tread_dust_trucks";

    foreach ( var_5 in var_1 )
    {
        maps\_vehicle::set_vehicle_effect( var_5, "brick", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "bark", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "carpet", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "cloth", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "concrete", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "dirt", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "flesh", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "foliage", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "glass", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "grass", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "gravel", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "ice", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "metal", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "mud", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "paper", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "plaster", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "rock", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "sand", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "snow", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "water", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "wood", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "asphalt", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "ceramic", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "plastic", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "rubber", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "cushion", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "fruit", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "paintedmetal", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "riotshield", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "slush", var_2 );
        maps\_vehicle::set_vehicle_effect( var_5, "default", var_2 );
    }

    foreach ( var_5 in var_0 )
    {
        maps\_vehicle::set_vehicle_effect( var_5, "brick", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "bark", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "carpet", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "cloth", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "concrete", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "dirt", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "flesh", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "foliage", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "glass", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "grass", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "gravel", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "ice", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "metal", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "mud", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "paper", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "plaster", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "rock", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "sand", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "snow", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "water", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "wood", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "asphalt", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "ceramic", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "plastic", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "rubber", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "cushion", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "fruit", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "paintedmetal", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "riotshield", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "slush", var_3 );
        maps\_vehicle::set_vehicle_effect( var_5, "default", var_3 );
    }
}
...
drop_pod_fx_start( var_0 )
{
    maps\_utility::delaythread( 0, ::drop_pod_thrusters, var_0 );
    maps\_utility::delaythread( 2.4, ::drop_pod_ground_impact, var_0 );
    maps\_utility::delaythread( 2.97, ::drop_pod_door_spark, var_0 );
}

drop_pod_thrusters( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "drop_pod_hovering_thruster" ), var_0, "tag_fx" );
    ...
    wait 1.5;
    stopfxontag( common_scripts\utility::getfx( "drop_pod_hovering_thruster" ), var_0, "tag_fx" );
    playfxontag( common_scripts\utility::getfx( "drop_pod_hovering_thruster_short" ), var_0, "tag_fx" );
    wait 0.5;
    stopfxontag( common_scripts\utility::getfx( "drop_pod_hovering_thruster_short" ), var_0, "tag_fx" );
    playfxontag( common_scripts\utility::getfx( "drop_pod_hovering_thruster_idle" ), var_0, "tag_fx" );
    wait 0.4;
    stopfxontag( common_scripts\utility::getfx( "drop_pod_hovering_side_spray" ), var_1, "tag_origin" );
    stopfxontag( common_scripts\utility::getfx( "drop_pod_hovering_side_spray" ), var_2, "tag_origin" );
    stopfxontag( common_scripts\utility::getfx( "drop_pod_hovering_side_spray" ), var_3, "tag_origin" );
    stopfxontag( common_scripts\utility::getfx( "drop_pod_hovering_thruster_idle" ), var_0, "tag_fx" );
    wait 1;
    var_1 delete();
    var_2 delete();
    var_3 delete();
...
drop_pod_ground_impact( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "drop_pod_landing_impact_ground" ), var_0, "tag_fx" );
    earthquake( 0.2, 2.4, var_0.origin, 1600 );
}

drop_pod_door_spark( var_0 )
{
    ...
    wait 0.3;
    stopfxontag( common_scripts\utility::getfx( "seo_spark_droppod_door" ), var_1, "tag_origin" );
    wait 8;
    stopfxontag( common_scripts\utility::getfx( "seo_dust_droppod_door" ), var_1, "tag_origin" );
    wait 9;
    var_1 delete();
}
...
operating_base_ambientfx_aa_explosion()
{
    ...
    var_1 = [ ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ), ( 325, 270, 90.0001 ) ];
    var_2 = 2;
    var_3 = 3;
...
operating_base_ambientfx_midair_explosion()
{
    ...
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_midair_runner_single", var_0, var_2, var_2, "drone_swarm_spawning", 1, var_1, "midair_exp_audio" );
}

operating_base_ambientfx_ground_fireball_explosion()
{
    common_scripts\utility::flag_wait( "msg_fx_zone1g_building_ground_floor" );
    var_0 = [ ( 33804.2, 4314.53, 1320.13 ), ( 33315.4, 3566.97, 1318 ), ( 35060.3, 7155.24, 1313.7 ), ( 33335.2, 10154.7, 1318 ), ( 31464.5, 6406.76, 1622.03 ), ( 31122, 7724.05, 1425.83 ), ( 28311.1, 6502.85, 1332.66 ), ( 29088.4, 7718.85, 1320.7 ), ( 27895.2, 6849.89, 1363.14 ), ( 27098.8, 7447.25, 1316.52 ), ( 25533.8, 6682.31, 1322.75 ), ( 33974.3, 5589.48, 1320.13 ), ( 35646.8, 7660.74, 1320.12 ), ( 36321.3, 7648.72, 1320.13 ), ( 36228.9, 7200.14, 1316.25 ), ( 32958.1, 8910.46, 1320.13 ), ( 33726.3, 4534.13, 1312.13 ), ( 33306.1, 4379.92, 1317.81 ), ( 33336.2, 4967.27, 1318 ) ];
    var_1 = [ ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 272.896, 355.302, 2.88336 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ) ];
    var_2 = 3;
    var_3 = 5;
...
operating_base_ambientfx_window_glass_explosion()
{
    ...
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_windowglass", var_0, var_2, var_3, "drone_swarm_spawning", 0, var_1, "midair_exp_glass" );
}

titan_camera_shake( var_0 )
{
    earthquake( 0.2, 1.8, var_0.origin, 1600 );
    wait 1;
    earthquake( 0.2, 1.8, var_0.origin, 1600 );
}
...
titan_impact_fx_fl( var_0 )
{
    ...
    wait 0.08;
    playfxontag( common_scripts\utility::getfx( "titan_tread_impact" ), var_0, "frontWheelTread07_FL" );
    common_scripts\_exploder::exploder( 2100 );
    earthquake( 0.3, 1.8, var_0.origin, 1600 );
    wait 2.5;
    common_scripts\_exploder::exploder( 2010 );
    playfxontag( common_scripts\utility::getfx( "rocks_falling_m" ), var_0, "frontWheelTread07_FL" );
    wait 1;
    ...
    wait 4;
    playfxontag( common_scripts\utility::getfx( "titan_tread_impact" ), var_0, "frontWheelTread07_FL" );
    earthquake( 0.2, 1.8, var_0.origin, 800 );
    wait 3;
    playfxontag( common_scripts\utility::getfx( "titan_tread_impact" ), var_0, "frontWheelTread07_FL" );
    earthquake( 0.2, 1.8, var_0.origin, 800 );
    wait 1;
...
titan_impact_fx_fr( var_0 )
{
    var_0 endon( "death" );
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "titan_tread_impact" ), var_0, "frontWheelTread07_FR" );
    earthquake( 0.3, 1.8, var_0.origin, 2000 );
    wait 2;
...
titan_impact_fx_rr( var_0 )
{
    ...
    wait 0.1;
    playfxontag( common_scripts\utility::getfx( "titan_tread_impact" ), var_0, "frontWheelTread06_KR" );
    common_scripts\_exploder::exploder( 2055 );
    earthquake( 0.2, 1.8, var_0.origin, 1600 );
    wait 1.5;
    common_scripts\_exploder::exploder( 2025 );
...
{
    var_0 endon( "death" );
    playfxontag( common_scripts\utility::getfx( "titan_tread_impact" ), var_0, "frontWheelTread06_KL" );
    earthquake( 0.2, 1.8, var_0.origin, 1600 );
    wait 0.8;
    common_scripts\_exploder::exploder( 2054 );
    wait 1.5;
...
drone_spot_light( var_0 )
{
    if ( isalive( self ) )
        playfxontag( common_scripts\utility::getfx( "drone_search_lt" ), var_0, "tag_origin" );
}

car_door_snap_will( var_0 )
{
    common_scripts\_exploder::exploder( 2220 );
}

car_door_snap_player( var_0 )
{

}

exo_truck_push( var_0 )
{

}

cormack_perarts_jump_explosions( var_0 )
{
    wait 1.1;
...
will_perarts_jump_explosions( var_0 )
{
    wait 1.9;
...
weaponplf_flyby_dustfx_sinkhole( var_0 )
{
    wait 3;
    var_1 = common_scripts\utility::spawn_tag_origin();
...
sinkhole_ambientfx_aa_explosions()
{
    ...
    var_0 = [ ( 22502.7, 14535.2, 4702.46 ), ( 23569.3, 13543.8, 4432.45 ), ( 23931.9, 16851.7, 9235.49 ), ( 23609.5, 11498.4, 5512.78 ), ( 21458.8, 15618, 4870.65 ), ( 23189.1, 18027.9, 5984.3 ), ( 22752.5, 11295.8, 2996.73 ), ( 22876.8, 19240.9, 4358.8 ), ( 20954.3, 16291.2, 3522.39 ), ( 22649, 13195, 3076.32 ), ( 22143.9, 20790.7, 7324.31 ), ( 23167.1, 15297.2, 5433.97 ), ( 25200.6, 10847.7, 3849.67 ), ( 22754, 12019, 3286.13 ), ( 23876.1, 19712.5, 6844.53 ), ( 23963.6, 15975.5, 3751.77 ), ( 23271.3, 10070.4, 4623.79 ), ( 23810.8, 13616.4, 7628.76 ), ( 23873.7, 17237, 3108.3 ), ( 22784.4, 16459, 4049.49 ), ( 22914.7, 14416.8, 3772.56 ), ( 23464.1, 15291.1, 3508.37 ), ( 23608.1, 19241.3, 3205.12 ) ];
    var_1 = [ ( 270, 0, 0 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 270, 0, 0 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 270, 0, 0 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 270, 0, 0 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 276, 90.0005, -90.0005 ) ];
    var_2 = 1;
    var_3 = 4;
    ...
    thread maps\_shg_fx::start_fx_by_view( "aa_explosion_runner_single", var_0, var_2, var_3, "msg_fx_zone5_subway_traverse", 0, var_1, "seo_ambient_ground_explosions" );
}

sinkhole_ambientfx_midair_explosions()
{
    common_scripts\utility::flag_wait( "msg_fx_zone3b_transition_lobby" );
    var_0 = [ ( 19561.7, 14358.8, 7855.85 ), ( 23381.2, 16616.7, 7193.57 ), ( 23065.7, 12406.3, 5605.04 ), ( 25865.7, 16393.7, 6140.61 ), ( 19781.9, 16340.8, 4896.5 ), ( 23344.2, 11032.9, 3512.27 ), ( 24393.1, 20192.7, 6396.58 ), ( 22130, 14220.2, 8568.02 ), ( 22927.8, 20117.1, 4441.94 ), ( 22355.5, 18627.7, 5889.03 ), ( 19868.2, 17651.6, 7869.9 ), ( 24004.8, 13214.9, 7180.08 ) ];
    var_1 = [ ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 6.99978 ) ];
    var_2 = 4;
    var_3 = 6;
...
sinkhole_ambientfx_windowglass_explosions()
{
    ...
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_windowglass", var_0, var_2, var_3, "msg_fx_zone5_subway_traverse", 0, var_1, "midair_exp_glass_audio" );
}
...
subway_bombshakes()
{
    ...
    for (;;)
    {
        ...
        if ( common_scripts\utility::flag( "msg_fx_zone5_subway_traverse" ) )
        {
            var_1 = 1008;
            var_0.origin = self.player getorigin();
            var_2 = bullettrace( self.player.origin + ( 0, 0, 12 ), self.player.origin + ( 0, 0, 1200 ), 0, undefined );
...
cigarette_light( var_0 )
{
    wait 0.9;
    playfxontag( common_scripts\utility::getfx( "cigarette_smk_light" ), var_0, "tag_inhand" );
}
...
shoping_district_ambientfx_aa_explosion()
{
    ...
    var_0 = [ ( 20673, 20552.3, 5258.69 ), ( 16666.5, 19927.5, 5624.46 ), ( 21245.6, 17719.7, 6303.46 ), ( 16756.2, 20503.4, 4837.3 ), ( 18491.4, 16908, 6126.36 ), ( 18569.9, 22409.7, 5052.01 ), ( 14798.6, 20316.1, 5253.98 ), ( 14657.8, 18393.6, 4916.39 ), ( 12132.3, 19611.8, 5915.53 ), ( 20007.2, 18634.3, 5165.69 ), ( 14305.3, 25295.4, 4464.22 ), ( 29463.4, 22093.2, 8050.42 ), ( 18561.1, 19191.7, 6940.02 ), ( 15632.8, 22799.3, 5405.85 ), ( 17033.3, 22724.6, 5456.83 ), ( 20090.5, 17090.6, 6104.45 ), ( 19207.1, 19760.4, 4969.31 ), ( 18897.9, 17861.2, 5336.73 ), ( 17643.6, 17975.9, 6187.16 ), ( 17001.1, 16779.1, 6292.83 ), ( 15251.6, 17846, 7191.07 ), ( 16847.6, 18875.3, 5501.05 ), ( 17855.1, 20501.1, 6919.57 ), ( 13104.7, 17787.2, 5501.51 ) ];
    var_1 = [ ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ), ( 276, 90.0005, -90.0005 ) ];
    thread maps\_shg_fx::start_fx_by_view( "aa_explosion_runner_single", var_0, 1, 3, "msg_fx_zone7_2nd_floor_building_overview", 0, var_1, "midair_exp_audio" );
}

shoping_district_ambientfx_midair_explosion()
{
    common_scripts\utility::flag_wait( "msg_fx_zone6_escalator_exit_shopping" );
    var_0 = [ ( 19698.9, 19061.8, 4994.42 ), ( 16272.7, 17077.3, 5378.53 ), ( 19962.5, 17044.7, 3240.4 ), ( 21958.1, 17690.8, 5018.19 ), ( 18329.5, 15896.8, 5149.17 ), ( 14360.9, 18246.4, 3706.19 ), ( 17554.9, 19976.5, 6951.65 ), ( 21203.4, 20643.3, 5438.43 ), ( 15766.9, 17676, 4229.81 ), ( 15413.4, 21719.1, 4376.28 ), ( 12066.6, 20949.7, 6861.5 ), ( 16252.1, 15202, 4464.51 ), ( 19142.6, 20042.1, 4181.94 ), ( 15920.4, 19633.7, 4839.31 ), ( 18169.2, 18171.3, 3759.21 ), ( 16947.5, 19661.9, 3291.84 ), ( 19693.6, 21307.6, 3165.27 ), ( 16979, 21159.9, 3305.99 ), ( 18195.2, 19631.7, 2727.43 ) ];
    var_1 = [ ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ) ];
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_midair_runner_single", var_0, 2, 6, "msg_fx_zone7_2nd_floor_building_overview", 0, var_1, "midair_exp_audio" );
}

shoping_district_ambientfx_windowglass_explosion()
{
    common_scripts\utility::flag_wait( "msg_fx_zone6_escalator_exit_shopping" );
    var_0 = [ ( 21256.3, 18920, 3139.02 ), ( 21211.7, 19250.9, 4038.3 ), ( 21816.9, 24241.2, 8481.06 ), ( 20870.5, 24707, 7494.13 ), ( 21665.4, 24274.2, 7237.97 ), ( 21674.1, 24316.8, 5412.25 ), ( 21021.4, 24598.8, 4718.75 ), ( 18360.9, 23149.9, 4130 ), ( 19322.4, 23652.2, 3644.22 ), ( 21225.3, 18717.2, 3988.18 ), ( 15650.6, 17890.7, 2754.44 ) ];
    var_1 = [ ( 280.925, 191.431, 108.251 ), ( 328.557, 150.211, 115.126 ), ( 293.35, 214.205, 141.894 ), ( 324.639, 218.62, 127.313 ), ( 321.525, 215.797, 127.517 ), ( 316.622, 277.568, 85.2917 ), ( 316.622, 277.568, 85.2917 ), ( 316.622, 277.568, 72.2915 ), ( 309.544, 330.429, 80.3149 ), ( 299.522, 184.568, 85.3982 ), ( 331.685, 153.042, 47.3377 ) ];
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_windowglass", var_0, 4, 6, "msg_fx_zone7_2nd_floor_building_overview", 0, var_1, "midair_exp_glass_audio" );
}
...
weapon_platform_fire_1( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "weaponplf_cannon_muzzle" ), var_0, "launcherBarrel_T" );
}

weapon_platform_fire_2( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "weaponplf_cannon_muzzle" ), var_0, "launcherBarrel_R" );
}

weapon_platform_fire_3( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "weaponplf_cannon_muzzle" ), var_0, "launcherBarrel_L" );
}
...
seo_outro_wp_wp_powerup( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "weaponplf_tread_smk_powerup" ), var_0, "TAG_ORIGIN" );
    level waittill( "wp_takeoff_start" );
    stopfxontag( common_scripts\utility::getfx( "weaponplf_tread_smk_powerup" ), var_0, "TAG_ORIGIN" );
}

seo_outro_wp_take_off_start( var_0 )
{
    level notify( "wp_takeoff_start" );
    playfxontag( common_scripts\utility::getfx( "weaponplf_tread_smk" ), var_0, "TAG_ORIGIN" );
    level waittill( "wp_init_explo_start" );
    stopfxontag( common_scripts\utility::getfx( "weaponplf_tread_smk" ), var_0, "TAG_ORIGIN" );
}

seo_outro_wp_explo_sequence_start( var_0 )
{
    maps\_utility::delaythread( 0, ::seo_outro_wp_init_explo, var_0 );
    maps\_utility::delaythread( 0, ::seo_outro_pause_env_fx );
    maps\_utility::delaythread( 2.1, ::seo_outro_wp_belly_explo_1, var_0 );
    maps\_utility::delaythread( 2.95, ::seo_outro_wp_wing_fall_off, var_0 );
    maps\_utility::delaythread( 3.15, ::seo_outro_wp_belly_explo_2, var_0 );
    maps\_utility::delaythread( 3.9, ::seo_outro_wp_belly_explo_2_end, var_0 );
    maps\_utility::delaythread( 4.85, ::seo_outro_wp_tail_explo_shockwave, var_0 );
    maps\_utility::delaythread( 4.95, ::seo_outro_wp_tail_explo_shockwave_ground );
    maps\_utility::delaythread( 5.2, ::seo_outro_wp_tail_explo, var_0 );
...
seo_outro_wp_init_explo( var_0 )
{
    ...
    wait 3;
    stopfxontag( common_scripts\utility::getfx( "seo_outro_wp_explo_initial" ), var_1, "tag_origin" );
    var_1 delete();
}
...
seo_outro_wp_tail_explo_shockwave( var_0 )
{
...
seo_outro_rolling_smk()
{
    ...
    maps\_utility::delaythread( 7.0, common_scripts\_exploder::exploder, "outro_grnd_smk_settle" );
}
...
outro_vm_arm_blood_init( var_0 )
{
    ...
    var_5 += ( 0, 1.5, 0 );
    playfx( common_scripts\utility::getfx( "fusion_end_armblood_bloodsquirts" ), var_5, ( 0, 0, 1 ), ( 0, 1, 0 ) );
}

outro_vm_body_drag_dust( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "fusion_drag_dust" ), var_0, "J_Ankle_LE" );
    playfxontag( common_scripts\utility::getfx( "fusion_drag_dust" ), var_0, "J_Ankle_RI" );
}
