...
handle_turret_shootloop()
{
    ...
    for (;;)
    {
        ...
        self.mgturret[0] _meth_8106( var_4 );
...
moving_note_targets( var_0, var_1 )
{
    ...
    for (;;)
    {
        self _meth_82AE( var_1.origin, var_2, 0.5, 0.5 );
        wait(var_2);
        self _meth_82AE( var_0.origin, var_3, 0.5, 0.5 );
        wait(var_3);
    }
}
...
turret_shoot_vtols()
{
    ...
    foreach ( var_3 in var_0 )
    {
        ...
        while ( isdefined( var_3 ) && var_3 maps\_vehicle::isvehicle() )
        {
            ...
            self.mgturret[0] _meth_8106( var_3, var_4 );
            wait 0.2;
            self.mgturret[0] _meth_80EA();
...
vtol_battle_redux()
{
    ...
    _func_0D3( "bg_fallDamageMaxHeight", 6000 );
...
vtol_death_if_pilot_shot( var_0 )
{
    ...
    _func_0D3( "bg_fallDamageMinHeight", 400 );
    _func_0D3( "bg_fallDamageMaxHeight", 1024 );
}
...
heli_fight()
{
    ...
    for (;;)
    {
        ...
        for ( var_3 = 0; var_3 < 2; var_3++ )
        {
            ...
            var_4 _meth_8106( var_2, ( 0, 0, 36 ) );
            var_4 _meth_80E2();
            var_4 common_scripts\utility::delaycall( var_0, ::_meth_80E3 );
        }
