...
tracking_grenade_think( var_0 )
{
    ...
    for ( var_38 = 0; var_38 < var_11; var_38 = var_38 + 0.05 )
    {
        ...
        var_30 = var_30 + getsmoothrandomvector( 52.8, 1 );
        var_47 = vectorclamp( ( var_30 - var_29 ) * var_19 - var_15, var_16 );
        var_47 = vectorlerp( var_47, var_32, var_18 );
        var_33 = var_33 + var_47;
        var_33 = var_33 + common_scripts\utility::randomvector( var_22 * length( var_33 ) );
        ...
        if ( var_48 > 0 )
        {
            ...
            if ( var_48 > var_17 )
            {
                ...
                var_33 = ( 0, 0, 0 );
                var_29 = var_29 + vectorclamp( var_47, var_16, var_17 );
            }

            var_29 = var_29 + var_15;
        }
    ...
    if ( isdefined( var_0 ) )
    {
        if ( isarray( var_0 ) )
        {
            ...
            foreach ( var_4, var_3 in var_0 )
                var_1 = var_1 + ( var_4 + " -> " + safe_str( var_3 ) + "\n" );
        ...
        if ( isdefined( var_0.targetname ) )
            var_1 = var_1 + ( " targetname: \"" + var_0.targetname + "\"" );

        if ( isdefined( var_0.script_noteworthy ) )
            var_1 = var_1 + ( " script_noteworthy: \"" + var_0.script_noteworthy + "\"" );

        if ( isdefined( var_0.classname ) )
            var_1 = var_1 + ( " classname: \"" + var_0.classname + "\"" );
