...
pod_flyin()
{
    ...
    var_7 _meth_80B1( "viewbody_sentinel_pilot_mitchell_grapple" );
    level.player _meth_807F( var_7, "tag_player" );
...
warbird_carrying_walker( var_0, var_1 )
{
    ...
    var_2 _meth_804D( self, "tag_guy0", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_2 _meth_80B1( maps\_utility::getmodel( var_0 ) );
    var_3 = spawn( "script_model", ( 0, 0, 0 ) );
    var_3 _meth_804D( var_2, "TAG_ATTACH", ( 0, 0, -114 ), ( 0, 90, 0 ) );
    var_3 _meth_80B1( maps\_utility::getmodel( var_1 ) );
...
monitor_snipers_stragglers()
{
    ...
    foreach ( var_1 in level.snipers_defenders )
    {
        ...
        {
            var_1 _meth_81A7( level.player, 2 );
...
player_defend_snipers()
{
    ...
    level.allies[1] _meth_81A9( var_0 );
    level.allies[2] _meth_81A9( var_0 );
...
watch_ally_alert()
{
    ...
    if ( level.ally_alert_vol != "none" )
    {
        ...
        common_scripts\utility::array_call( level.allies, ::_meth_81A9, var_3 );
        level.ally_alert_vol = "none";
    }
}
