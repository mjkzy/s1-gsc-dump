...
heli_wait_node( var_0, var_1, var_2 )
{
    ...
    var_9 = isdefined( var_0.script_stopnode ) && var_0.script_stopnode;
    var_10 = isdefined( var_0.script_unload );
    var_11 = isdefined( var_0.script_flag_wait ) && !common_scripts\utility::flag( var_0.script_flag_wait );
    var_12 = !isdefined( var_0.target );
    var_13 = isdefined( var_0.script_delay );

    if ( isdefined( var_0.angles ) )
        var_14 = var_0.angles[1];
    else
        var_14 = 0;
    ...
    if ( isdefined( var_2 ) )
        var_15 = maps\_utility::add_z( var_15, var_2 );
...
vehicle_kill_common( var_0, var_1 )
{
    ...
    var_6 = vehicle_should_do_rocket_death( var_4, var_0, var_1 );
    thread kill_death_anim_thread( var_3 );
    thread _kill_fx( var_4, var_6 );
...
vehicle_kill()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) && isdefined( maps\_vehicle_aianim::guy_vehicle_death ) )
...
aircraft_wash_thread( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_18 = var_16 gettagorigin( var_1 );
            var_19 = var_16 gettagangles( var_1 );
            var_19 = combineangles( var_19, ( -90, 0, 0 ) );
        }
        else
        {
        ...
        var_20 = anglestoup( var_19 ) * -1;
        var_12++;

        if ( var_12 > var_11 )
        {
            var_12 = var_11;
            var_14 = bullettrace( var_18, var_18 + var_20 * var_6, 0, var_16 );
        }

        if ( var_14["fraction"] == 1 || var_14["fraction"] < var_7 )
            continue;

        var_21 = distance( var_18, var_14["position"] );
        var_22 = get_wash_fx( self, var_14, var_20, var_21, var_1 );
        ...
        if ( !isdefined( var_14["position"] ) )
            continue;

        var_10 = ( var_21 - var_5 ) / ( var_6 - var_5 ) * ( var_8 - var_9 ) + var_9;
        var_10 = max( var_10, var_9 );
        var_23 = var_14["position"];
        var_24 = var_14["normal"];
        var_21 = vectordot( var_23 - var_18, var_24 );
        var_25 = var_18 + ( 0, 0, var_21 );
        var_26 = var_23 - var_25;

        if ( var_24[2] < -0.99 )
            continue;

        var_27 = vectortoangles( var_24 );

        if ( angleclamp180( var_27[0] ) > -90 + var_17 )
            var_24 = anglestoforward( ( -90 + var_17, var_27[1], 0 ) );

        if ( length( var_26 ) < 1 )
            var_26 = anglestoforward( var_19 + ( 0, 180, 0 ) );

        if ( abs( vectordot( vectornormalize( var_26 ), var_24 ) ) > 0.999 )
            continue;

        playfx( var_22, var_23, var_24, var_26 );
    }
}
...
get_wash_fx( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_1["surfacetype"];
    var_6 = undefined;
    var_7 = vectordot( ( 0, 0, -1 ), var_2 );
    ...
    if ( isdefined( level._vehicle_effect_custom_param ) && isdefined( level._vehicle_effect_custom_param[var_0.classname] ) && isdefined( level._vehicle_effect_custom_param[var_0.classname].get_surface_override_function ) )
        var_5 = var_0 [[ level._vehicle_effect_custom_param[var_0.classname].get_surface_override_function ]]( var_5, var_4 );

    return get_wash_effect( var_0.classname, var_5, var_6 );
}
...
regen_front_armor( var_0, var_1 )
{
    ...
    if ( vectordot( var_2, var_3 ) > 0.86 )
        self.health += int( var_1 * level.vehicle_frontarmor[self.vehicletype] );
}
