...
courtyard_ambient_bullet_impacts()
{
    ...
    for (;;)
    {
        ...
        var_4 = var_4 * randomintrange( 256, 512 );
        var_5 = var_5 * randomintrange( -256, 256 );
        var_7 = randomint( 360 );
        ...
        while ( var_9 < var_15 )
        {
            ...
            if ( var_16 < 0.8 )
            {
                ...
                var_6.origin = var_6.origin + ( var_17, var_18, var_19 );
...
turbine_room_elevator()
{
    ...
    else
    {
        ...
        var_5.origin = var_5.origin + var_37;
        var_2.origin = var_2.origin + var_37;
        var_9.origin = var_9.origin + var_37;
