...
process_buttonmash( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_0.buttonmash_value = var_0.buttonmash_value + var_0.buttonmash_add_per_press;
...
animation_process( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        var_0.buttonmash_value = var_0.buttonmash_value - var_0.buttonmash_decay_per_frame;
