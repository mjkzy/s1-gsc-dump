...
setup_traffic_spawner( var_0 )
{
    ...
    if ( !isdefined( level.traffic_spawners[var_0] ) )
    {
        ...
        for ( var_3 = 0; var_3 < var_1.size; var_3++ )
        {
            ...
            var_2 = var_2 + level.traffic_spawners[var_0][var_3]["weight"];
        }
...
get_pos_at_given_distance_on_lane( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_3 )
    {
        ...
        var_5 = var_5 + randomfloatrange( var_5, var_5 + var_12 );
    }
...
spawn_new_traffic_entity_at_node_override( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_6 = 0; var_6 < level.traffic_spawners[var_3].size; var_6++ )
    {
        ...
        var_5 = var_5 - level.traffic_spawners[var_3][var_6]["normalizedweight"];
    }
...
scale_vehicle_speed( var_0 )
{
    ...
    self.traffic_speed = self.traffic_speed * var_0;
...
get_path_segment_array( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        var_4 = var_4 + distance2d( var_7.origin, var_3.origin );
...
monitor_script_model_damage()
{
    ...
    for ( self.currenthealth = self.health; self.currenthealth > 0; self.currenthealth = self.currenthealth - var_2 )
