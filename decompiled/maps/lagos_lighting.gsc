...
setup_lighting_intro_start()
{
    ...
    level.player setclutforplayer( "clut_lagos_intro_exterior", 1.0 );
    ...
    if ( level.nextgen )
    {
        ...
        var_3 setlightshadowstate( "force_on" );
    }

    level.burke overridelightingorigin( var_0.origin );
    wait 12.0;
...
setup_dof_drone()
{
    ...
    level.player setphysicaldepthoffield( 3.0, 100 );
}
...
setup_hostage_key_fov_tune()
{
    ...
    common_scripts\utility::flag_wait( "fly_drone_start" );
    wait 36.0;
    var_0 setlightfovrange( 20, 10 );
    wait 16.3;
    var_1 setlightfovrange( 50, 40 );
    wait 6.0;
    var_1 setlightfovrange( 90, 40 );
...
setup_dof_intro()
{
    ...
    if ( level.nextgen )
    {
        setsaveddvar( "r_dof_physical_bokehenable", "1" );
        level.player enablephysicaldepthoffieldscripting();
        level.player setphysicaldepthoffield( 2.0, 72.0 );
        wait 2.0;
        level.player setphysicaldepthoffield( 2.5, 30.0 );
        wait 3.5;
        level.player setphysicaldepthoffield( 2.0, 88.0 );
        wait 6.0;
        level.player setphysicaldepthoffield( 2.0, 133.0 );
        wait 4.35;
        level.player setphysicaldepthoffield( 2.5, 23.0 );
        wait 1.7;
    ...
    else
    {
        ...
        wait 3.5;
        level.player setphysicaldepthoffield( 2.16, 67.0 );
        wait 6.0;
...
setup_lagos_intro_interiors_volume()
{
    for (;;)
    {
        ...
        level.player setclutforplayer( "clut_lagos_intro_exterior", 3.0 );
...
setup_dof_government_overlook()
{
    ...
    level.player setphysicaldepthoffield( 1.2, 47.0 );
    wait 3.75;
...
setup_lighting_override_exo_wallclimb()
{
    ...
    var_2 overridereflectionprobe( var_1.origin );
    common_scripts\utility::flag_wait( "climb_ending_lighting" );
    var_2 defaultlightingorigin();
    var_2 defaultreflectionprobe();
}
...
setup_dof_government_climb()
{
    ...
    {
        level.player enablephysicaldepthoffieldscripting();
        level.player setphysicaldepthoffield( 2.0, 95.0 );
        wait 7.65;
        level.player setphysicaldepthoffield( 4.5, 11.0 );
        setsaveddvar( "r_dof_physical_bokehenable", 1 );
        wait 6.0;
        level.player setphysicaldepthoffield( 8.0, 16.0 );
        common_scripts\utility::flag_wait( "climb_ending_lighting" );
        wait 1.5;
        setsaveddvar( "r_mbEnable", "2" );
        setsaveddvar( "r_mbCameraRotationInfluence", "1" );
        wait 0.3;
        level.player setphysicaldepthoffield( 2.0, 13.0, 20, 20 );
        wait 1.0;
        level.player setphysicaldepthoffield( 2.0, 27.0, 20, 20 );
        wait 1.25;
        level.player setphysicaldepthoffield( 2.0, 18.0, 20, 20 );
        wait 1.0;
        level.player setphysicaldepthoffield( 2.0, 109.0, 20, 20 );
        wait 2.0;
        setsaveddvar( "r_dof_physical_bokehenable", 0 );
        level.player disablephysicaldepthoffieldscripting();
    }
    else
    {
        ...
        wait 1.0;
        level.player setphysicaldepthoffield( 2.0, 32.0, 20, 20 );
        wait 1.25;
        level.player setphysicaldepthoffield( 2.0, 18.0, 20, 20 );
        wait 1.0;
        level.player setphysicaldepthoffield( 2.0, 109.0, 20, 20 );
...
setup_dof_government_breach()
{
    ...
    level.player enablephysicaldepthoffieldscripting();
    level.player setphysicaldepthoffield( 1.2, 106.0 );
    wait 4.0;
    level.player setphysicaldepthoffield( 1.2, 67.0 );
    wait 10.0;
...
setup_lighting_harmonic_breach_dof()
{
    ...
    level.player enablephysicaldepthoffieldscripting();
    level.player setphysicaldepthoffield( 2.0, 16.1 );
    wait 3.15;
    level.player setphysicaldepthoffield( 2.0, 142.5, 20, 20 );
    wait 4.5;
    level.player setphysicaldepthoffield( 2.0, 16.1, 20, 20 );
    wait 0.75;
    level.player setphysicaldepthoffield( 2.0, 23.7, 20, 20 );
    wait 0.75;
    level.player setphysicaldepthoffield( 2.0, 13.2, 20, 20 );
    wait 0.75;
    level.player setphysicaldepthoffield( 2.0, 20.9, 20, 20 );
    wait 1.25;
    level.player setphysicaldepthoffield( 22.0, 100.0, 20, 20 );
    common_scripts\utility::flag_wait( "harmonic_complete_lighting" );
...
setup_dof_hostage_release()
{
    ...
    if ( level.nextgen )
    {
        level.player enablephysicaldepthoffieldscripting();
        wait 0.5;
        level.player setphysicaldepthoffield( 2.0, 13.75 );
        wait 2.0;
        level.player setphysicaldepthoffield( 2.6, 36.0 );
        wait 7.25;
        level.player setphysicaldepthoffield( 2.6, 102.5 );
        wait 10.0;
        level.player setphysicaldepthoffield( 2.6, 46.0 );
        wait 7.0;
        level.player disablephysicaldepthoffieldscripting();
        setsaveddvar( "r_mbEnable", "0" );
        setsaveddvar( "r_mbCameraRotationInfluence", "0" );
...
{
    wait 0.5;
    setsaveddvar( "r_mbvelocityscalar", 1.0 );
}
...
setup_lighting_van_takedown()
{
    ...
    level.player lightsetforplayer( "lagos_chase" );
    level.player setclutforplayer( "clut_lagos_chase_vista", 1.0 );
...
setup_dof_shoreline()
{
    ...
    if ( level.nextgen )
    {
        level.player enablephysicaldepthoffieldscripting();
        setsaveddvar( "r_dof_physical_bokehenable", 1 );
        level.player setphysicaldepthoffield( 2.5, 23.0, 20, 20 );
        wait 5.35;
        level.player setphysicaldepthoffield( 2.5, 40.0, 20, 20 );
        wait 2.0;
        level.player setphysicaldepthoffield( 2.5, 78.0, 20, 20 );
        wait 1.0;
        level.player setphysicaldepthoffield( 2.5, 40.0, 20, 20 );
        wait 2.0;
        level.player setphysicaldepthoffield( 2.5, 60.0, 20, 20 );
        wait 1.0;
        level.player setphysicaldepthoffield( 2.5, 78.0, 20, 20 );
        wait 2.0;
        level.player setphysicaldepthoffield( 2.5, 40.0, 20, 20 );
        wait 4.25;
        level.player setphysicaldepthoffield( 2.5, 90.0, 20, 20 );
        wait 3.5;
        level.player setphysicaldepthoffield( 2.5, 40.0, 20, 20 );
        wait 5.35;
        level.player setphysicaldepthoffield( 2.5, 23.0, 20, 20 );
        wait 0.15;
        level.player setphysicaldepthoffield( 2.5, 13.0, 20, 20 );
        wait 0.6;
        level.player setphysicaldepthoffield( 2.5, 60.0, 20, 20 );
    }
    else
    {
        ...
        wait 5.35;
        level.player setphysicaldepthoffield( 3.55, 33.0 );
        wait 5.0;
        level.player setphysicaldepthoffield( 3.37, 40.48 );
        wait 7.25;
        level.player setphysicaldepthoffield( 3.37, 40.48 );
        wait 4.5;
        level.player setphysicaldepthoffield( 3.55, 33.0, 20, 20 );
        wait 1.65;
        level.player setphysicaldepthoffield( 3.33, 22.7, 20, 20 );
        wait 2.5;
        level.player setphysicaldepthoffield( 3.65, 23.0, 20, 20 );
        wait 1.0;
        level.player setphysicaldepthoffield( 2.0, 60.0, 20, 20 );
        level.player setphysicaldepthoffield( 19, 5 );
    }
}
