...
set_level_lighting_values()
{
    if ( _func_235() )
    {
        ...
        if ( maps\_utility::is_gen4() )
            level.player _meth_83C0( "lagos_intro_drone" );
...
setup_dof_presets()
{
    if ( level.nextgen )
    {
        ...
        maps\_lighting::create_dof_preset( "lagos_roundabout_tanker", 10, 250, 6, 1000, 3000, 2.0, 0.5 );
...
{
    maps\_lighting::create_flickerlight_preset( "lagos_underwater", ( 0.972549, 0.62451, 1 ), ( 0.2, 0.146275, 1 ), 0.005, 0.2, 5 );
}
...
setup_lighting_intro_drone()
{
    ...
    wait 0.5;
    level.player _meth_83C0( "lagos_intro_drone_exterior" );
    level.player _meth_8490( "clut_lagos_drone", 0.25 );
...
setup_lighting_intro_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_intro_sequence" );
    level.player _meth_8490( "clut_lagos_intro_exterior", 1.0 );
    ...
    var_0 = getent( "initial_talking_lighting_centroid", "targetname" );
    var_1 = getent( "under_train_lighting_centroid", "targetname" );

    if ( level.nextgen )
    {
        var_2 = getent( "intro_primary_final_rim", "targetname" );
        var_3 = getent( "intro_primary_rim", "targetname" );
        var_2 _meth_8498( "force_on" );
        var_3 _meth_8498( "force_on" );
    }

    level.burke _meth_847B( var_0.origin );
    wait 12.0;

    if ( level.nextgen )
    {
        thread maps\_lighting::lerp_spot_intensity( "intro_primary_uplight", 2.0, 0 );
        thread maps\_lighting::lerp_spot_intensity( "intro_primary_final_rim", 5.0, 40000 );
    }

    wait 6.0;
    level.player _meth_83C0( "lagos_intro" );

    if ( level.nextgen )
    {
        _func_0D3( "r_mbEnable", "0" );
        thread maps\_lighting::lerp_spot_intensity( "intro_primary_final_rim", 2, 0 );
        thread maps\_lighting::lerp_spot_intensity( "intro_primary_rim", 5.0, 0 );
        var_2 = getent( "intro_primary_final_rim", "targetname" );
        var_3 = getent( "intro_primary_rim", "targetname" );
...
setup_lighting_government_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_government_building_ext" );
    level.player _meth_8490( "clut_lagos_intro_exterior", 1.0 );
...
setup_lighting_pre_h_breach_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_government" );
    level.player _meth_8490( "clut_lagos_government_interior", 0.1 );
    ...
    if ( level.nextgen )
    {
        ...
        var_0 = getent( "government_window_back_02", "targetname" );
        var_0 _meth_8020( 45, 10 );
    }
...
setup_lighting_roundabout_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_government_building_transition" );
    level.player _meth_8490( "clut_lagos_intro_exterior", 0.1 );
    maps\_utility::vision_set_fog_changes( "lagos_government_building_ext", 0.1 );
...
setup_lighting_alley1_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_alley" );
    level.player _meth_8490( "clut_lagos_intro_exterior", 0.1 );
...
setup_lighting_alley2_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_alley_rec_transition" );
    level.player _meth_8490( "clut_lagos_intro_exterior", 0.1 );
...
setup_lighting_flank_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_alley_interiors" );
    level.player _meth_8490( "clut_lagos_intro_exterior", 0.1 );
...
setup_lighting_frogger_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_frogger" );
    level.player _meth_8490( "clut_lagos_frogger", 0.1 );
...
setup_lighting_middle_takedown_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_chase" );
    level.player _meth_8490( "clut_lagos_chase", 0.1 );
...
setup_lighting_post_middle_takedown_start()
{
    ...
    wait 2.2;
    lerpsunangles( ( -85, 120, 0 ), ( -40, 72, 0 ), 1.0 );
    wait 5.0;
    resetsundirection();
}
...
setup_lighting_van_takedown_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_chase" );
    level.player _meth_8490( "clut_lagos_chase_vista", 0.1 );
...
setup_lighting_underwater_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_underwater" );
    level.player _meth_8490( "clut_lagos_chase", 0.1 );
...
setup_lighting_shoreline_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_shoreline" );
    level.player _meth_8490( "clut_lagos_shoreline", 0.1 );
...
setup_lighting_outro_start()
{
    ...
    wait 0.1;
    level.player _meth_83C0( "lagos_outro" );
...
droneviewstatic()
{
    ...
    level.dronevignette _meth_80CC( "s1_railgun_hud_outer_shadow", 640, 480 );
...
setup_dof_drone()
{
    ...
    wait 29.0;
    maps\_utility::vision_set_fog_changes( "lagos_intro_drone_hostage", 3.0 );
    level.player _meth_84A9();
    level.player _meth_84AB( 3.0, 100 );
}
...
setup_lightgrid_lighting_drone()
{
    ...
    wait 18.0;
    maps\_utility::lerp_saveddvar( "r_lightgridintensity", 1.0, 5 );
...
setup_hostage_key_fov_tune()
{
    ...
    var_0 = getent( "government_window_back_02", "targetname" );
    var_1 = getent( "government_hostage_rim_01", "targetname" );
    common_scripts\utility::flag_wait( "fly_drone_start" );
    wait 36.0;
    var_0 _meth_8020( 20, 10 );
    wait 16.3;
    var_1 _meth_8020( 50, 40 );
    wait 6.0;
    var_1 _meth_8020( 90, 40 );
...
{
    var_0 = getentarray( "lagos_lighting_generic_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_generic_volume();
}
...
setup_lighting_generic_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos" );
        maps\_utility::vision_set_fog_changes( "lagos", 1.0 );
    }
}

setup_lighting_sunflare()
{
    var_0 = getentarray( "lagos_lighting_sunflare_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_lagos_sunflare_volume();
}
...
setup_dof_intro()
{
    ...
    if ( level.nextgen )
    {
        _func_0D3( "r_dof_physical_bokehenable", "1" );
        level.player _meth_84A9();
        level.player _meth_84AB( 2.0, 72.0 );
        wait 2.0;
        level.player _meth_84AB( 2.5, 30.0 );
        wait 3.5;
        level.player _meth_84AB( 2.0, 88.0 );
        wait 6.0;
        level.player _meth_84AB( 2.0, 133.0 );
        wait 4.35;
        level.player _meth_84AB( 2.5, 23.0 );
        wait 1.7;
    ...
    {
        level.player _meth_84A9();
        level.player _meth_84AB( 3.7, 70 );
        wait 2.0;
        level.player _meth_84AB( 3.7, 34.3 );
        wait 3.5;
        level.player _meth_84AB( 2.16, 67.0 );
        wait 6.0;
        level.player _meth_84AB( 1.76, 102.711 );
        wait 4.35;
        level.player _meth_84AB( 5.032, 24.346 );
        wait 1.7;
        wait 0.2;
        level.player _meth_84AB( 19, 5 );
    }
...
{
    var_0 = getentarray( "lagos_intro_alley_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lagos_intro_alley_volume();
}
...
{
    var_0 = getentarray( "lagos_intro_alley_transition_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lagos_intro_alley_transition_volume();
}
...
setup_lagos_intro_alley_transition_volume()
{
    for (;;)
    {
        self waittill( "trigger" );
        level.player _meth_83C0( "lagos_intro" );
        level.player _meth_8490( "clut_lagos_intro_exterior", 3 );
...
{
    var_0 = getentarray( "lagos_intro_interiors_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lagos_intro_interiors_volume();
}
...
setup_lagos_intro_interiors_volume()
{
    ...
    {
        self waittill( "trigger" );
        level.player _meth_83C0( "lagos_intro_interiors" );
        level.player _meth_8490( "clut_lagos_intro_exterior", 3.0 );
...
{
    var_0 = getent( "lighting_centroid_overlook_door", "targetname" );
    var_1 = getent( "lighting_centroid_overlook_door_exterior", "targetname" );
    var_2 = getent( "lighting_reflection_overlook_door_exterior", "targetname" );
    var_3 = getent( "exo_door_model", "targetname" );
...
{
    var_0 = getentarray( "lagos_intro_interiors_post_exo_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lagos_intro_interiors_post_exo_volume();
}
...
setup_lagos_intro_interiors_post_exo_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos_intro_interiors_post_exo" );
        level.player _meth_8490( "clut_lagos_intro_exterior", 3.0 );
        maps\_utility::vision_set_fog_changes( "lagos_intro_interiors", 3 );
        maps\_shg_fx::set_sun_flare_position( ( -31, -35, 0 ) );
...
{
    var_0 = getentarray( "lagos_government_overlook_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_government_overlook_volume();
}
...
setup_lighting_government_overlook_volume()
{
    for (;;)
    {
        self waittill( "trigger" );
        level.player _meth_83C0( "lagos_government_building_ext" );
        level.player _meth_8490( "clut_lagos_intro_exterior", 4 );
...
setup_dof_government_overlook()
{
    ...
    level.player _meth_84AB( 1.2, 47.0 );
    wait 3.75;
...
{
    var_0 = getentarray( "lagos_railwalk_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_railwalk_volume();
}
...
setup_lighting_railwalk_volume()
{
    for (;;)
    {
        self waittill( "trigger" );
        common_scripts\utility::flag_wait( "exo_door_lighting_complete" );
        level.player _meth_83C0( "lagos_railwalk" );
...
setup_government_climb_sunlerp()
{
    ...
    wait 6.9;
    lerpsunangles( ( -55, -15, 0 ), ( -55, -82, 0 ), 1.0 );
    common_scripts\utility::flag_wait( "climb_ending_lighting" );
    lerpsunangles( ( -55, -82, 0 ), ( -40, -115, 0 ), 5.0 );
}

setup_lighting_override_exo_wallclimb()
{
    common_scripts\utility::flag_wait( "climb_begin_lighting" );
    var_0 = getent( "lighting_centroid_overlook_door_exterior", "targetname" );
    var_1 = getent( "lighting_reflection_overlook_door_exterior", "targetname" );
    var_2 = level.exo_climb_rig;
    var_2 _meth_847B( var_0.origin );
    var_2 _meth_83AB( var_1.origin );
    common_scripts\utility::flag_wait( "climb_ending_lighting" );
    var_2 _meth_847C();
    var_2 _meth_83AC();
}
...
setup_dof_government_climb()
{
    ...
    level.player _meth_83C0( "lagos_wall_climb" );

    if ( level.nextgen )
    {
        level.player _meth_84A9();
        level.player _meth_84AB( 2.0, 95.0 );
        wait 7.65;
        level.player _meth_84AB( 4.5, 11.0 );
        _func_0D3( "r_dof_physical_bokehenable", 1 );
        wait 6.0;
        level.player _meth_84AB( 8.0, 16.0 );
        common_scripts\utility::flag_wait( "climb_ending_lighting" );
        wait 1.5;
        _func_0D3( "r_mbEnable", "2" );
        _func_0D3( "r_mbCameraRotationInfluence", "1" );
        wait 0.3;
        level.player _meth_84AB( 2.0, 13.0, 20, 20 );
        wait 1.0;
        level.player _meth_84AB( 2.0, 27.0, 20, 20 );
        wait 1.25;
        level.player _meth_84AB( 2.0, 18.0, 20, 20 );
        wait 1.0;
        level.player _meth_84AB( 2.0, 109.0, 20, 20 );
        wait 2.0;
        _func_0D3( "r_dof_physical_bokehenable", 0 );
        level.player _meth_84AA();
    }
    else
    {
        ...
        wait 1.5;
        wait 0.3;
        level.player _meth_84AB( 3.75, 12.55, 20, 20 );
        wait 1.0;
        level.player _meth_84AB( 2.0, 32.0, 20, 20 );
        wait 1.25;
        level.player _meth_84AB( 2.0, 18.0, 20, 20 );
        wait 1.0;
        level.player _meth_84AB( 2.0, 109.0, 20, 20 );
    ...
    level.player _meth_83C0( "lagos_government_rooftop" );
    wait 0.5;
...
setup_lighting_government_breach()
{
    ...
    level.player _meth_83C0( "lagos_government_breach" );
    wait 11.75;
    lerpsunangles( ( -40, -115, 0 ), ( -55, -15, 0 ), 1.0 );
    wait 0.25;
    resetsundirection();
    wait 3.0;
    level.player _meth_83C0( "lagos_government" );
    level.player _meth_8490( "clut_lagos_government_interior", 4 );
...
setup_dof_government_breach()
{
    ...
    level.player _meth_84A9();
    level.player _meth_84AB( 1.2, 106.0 );
    wait 4.0;
    level.player _meth_84AB( 1.2, 67.0 );
    wait 10.0;
...
{
    var_0 = getentarray( "lagos_government_lighting_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_government_volume();
}
...
setup_lighting_harmonic_breach_hud()
{
    common_scripts\utility::flag_wait( "begin_harmonic_breach_lighting" );
    wait 12.6;
    level.player _meth_83C0( "lagos_breach_hud_bright" );
    wait 0.35;
    level.player _meth_83C0( "lagos_breach_hud" );
    common_scripts\utility::flag_wait( "harmonic_complete_lighting" );
    wait 0.75;
    level.player _meth_83C0( "lagos_breach_hud_bright" );
    wait 0.35;
...
setup_lighting_harmonic_breach_dof()
{
    ...
    level.player _meth_84A9();
    level.player _meth_84AB( 2.0, 16.1 );
    wait 3.15;
    level.player _meth_84AB( 2.0, 142.5, 20, 20 );
    wait 4.5;
    level.player _meth_84AB( 2.0, 16.1, 20, 20 );
    wait 0.75;
    level.player _meth_84AB( 2.0, 23.7, 20, 20 );
    wait 0.75;
    level.player _meth_84AB( 2.0, 13.2, 20, 20 );
    wait 0.75;
    level.player _meth_84AB( 2.0, 20.9, 20, 20 );
    wait 1.25;
    level.player _meth_84AB( 22.0, 100.0, 20, 20 );
    common_scripts\utility::flag_wait( "harmonic_complete_lighting" );
...
{
    var_0 = getentarray( "lagos_government_hostage_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_government_hostage_volume();
}
...
setup_lighting_government_hostage_volume()
{
    for (;;)
    {
        ...
        if ( level.nextgen )
        {
            level.player _meth_83C0( "lagos_hostage_room" );
            maps\_utility::vision_set_fog_changes( "lagos_hostage_room", 4 );
            level.player _meth_8490( "clut_lagos_conference_room", 4 );
            thread maps\_lighting::lerp_spot_intensity( "government_window_back_02", 1, 250000 );
        }
        ...
        if ( level.nextgen )
            _func_0D3( "r_dof_physical_hipfstop", 5 );
    }
}
...
setup_lighting_hostage_release()
{
    ...
    var_0 = getent( "government_hostage_fill", "targetname" );
    var_0 _meth_8020( 90, 50 );
...
setup_dof_hostage_release()
{
    ...
    if ( level.nextgen )
    {
        level.player _meth_84A9();
        wait 0.5;
        level.player _meth_84AB( 2.0, 13.75 );
        wait 2.0;
        level.player _meth_84AB( 2.6, 36.0 );
        wait 7.25;
        level.player _meth_84AB( 2.6, 102.5 );
        wait 10.0;
        level.player _meth_84AB( 2.6, 46.0 );
        wait 7.0;
        level.player _meth_84AA();
        _func_0D3( "r_mbEnable", "0" );
        _func_0D3( "r_mbCameraRotationInfluence", "0" );
...
{
    var_0 = getentarray( "lagos_government_ext_lighting_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_government_ext_volume();
}
...
setup_lighting_government_ext_volume()
{
    for (;;)
    {
        ...
        maps\_utility::lerp_saveddvar( "r_lightgridintensity", 1.0, 2 );
...
{
    var_0 = getentarray( "lagos_lobby_lighting_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_lobby_volume();
}
...
setup_lighting_lobby_volume()
{
    ...
    {
        self waittill( "trigger" );
        level.player _meth_83C0( "lagos_lobby" );
...
{
    var_0 = getentarray( "lagos_roundabout_transition_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_roundabout_transition_volume();
}
...
setup_lighting_roundabout_transition_volume()
{
    for (;;)
    {
        ...
        level.player _meth_8490( "clut_lagos_roundabout", 6 );
        maps\_utility::lerp_saveddvar( "r_lightgridintensity", 1.0, 2 );
    }
}
...
{
    var_0 = getentarray( "lagos_roundabout_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_roundabout_volume();
}
...
{
    var_0 = getentarray( "tanker_explosion_aftermath_volume", "targetname" );

    foreach ( var_2 in var_0 )
    {
        var_2 thread setup_lighting_tanker_aftermath_volume();
        var_2 thread setup_lighting_tanker_aftermath_cleanup();
    }
}
...
{
    var_0 = getentarray( "lagos_alley_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_alley_volume();
}
...
{
    var_0 = getentarray( "lagos_alley_interiors_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_alley_interiors_volume();
}
...
setup_lighting_alley_interiors_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos_alley_interiors" );
        level.player _meth_8490( "clut_lagos_intro_exterior", 2 );
    }
}
...
setup_motion_blur_oncoming()
{
    ...
    {
        _func_0D3( "r_mbEnable", "2" );
        _func_0D3( "r_mbvelocityscalar", ".75" );
    }
...
{
    var_0 = getentarray( "lagos_rec_yard_transition_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_rec_yard_transition_volume();
}
...
{
    var_0 = getentarray( "lagos_rec_yard_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_rec_yard_volume();
}
...
{
    var_0 = getentarray( "lagos_marketplace_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_marketplace_volume();
}
...
setup_lighting_marketplace_volume()
{
    for (;;)
    {
        ...
        maps\_utility::vision_set_fog_changes( "lagos_alley", 2 );
        level.player _meth_83C0( "lagos_alley" );
        level.player _meth_8490( "clut_lagos_intro_exterior", 10 );
    }
}

setup_lighting_marketplace_interiors()
{
    var_0 = getentarray( "lagos_marketplace_interiors_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_marketplace_interiors_volume();
}
...
{
    var_0 = getentarray( "lagos_traffic_crossing_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_traffic_crossing_volume();
}
...
setup_lighting_traffic_crossing_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos_frogger" );
        level.player _meth_8490( "clut_lagos_frogger", 2 );
...
{
    var_0 = getentarray( "lagos_chase_start_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_chase_start_volume();
}
...
setup_lighting_chase_start_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos_first_jump_chase_landing" );
        level.player _meth_8490( "clut_lagos_chase", 1 );
...
setup_motion_blur_chase_start()
{
    ...
    level.player _meth_83C0( "lagos_pre_chase_jump" );
...
{
    var_0 = getentarray( "lagos_chase_tunnel_transition_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_chase_tunnel_transition_volume();
}
...
setup_lighting_chase_tunnel_transition_volume()
{
    ...
    {
        self waittill( "trigger" );
        level.player _meth_83C0( "lagos_chase_tunnel_transition" );
    }
}

setup_lighting_chase_tunnel()
{
    var_0 = getentarray( "lagos_chase_tunnel_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_chase_tunnel_volume();
}
...
setup_lighting_chase_tunnel_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos_chase_tunnel" );
        level.player _meth_8490( "clut_lagos_tunnel", 2 );
        maps\_shg_fx::set_sun_flare_position( ( -20, 80, 0 ) );
        ...
        level.player _meth_83C0( "lagos_chase" );
        level.player _meth_8490( "clut_lagos_chase", 2 );
        maps\_shg_fx::set_sun_flare_position( ( -40, 65, 0 ) );
    }
}
...
setup_lighting_suv_takedown()
{
    ...
    wait 1.0;
    level.player _meth_83C0( "lagos_chase_suv_punch" );
    lerpsunangles( ( -40, 72, 0 ), ( -85, 120, 0 ), 0.5 );
    wait 4.0;
...
{
    var_0 = getentarray( "lagos_chase_buildings_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_chase_buildings_volume();
}
...
setup_lighting_chase_buildings_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos_chase" );
        level.player _meth_8490( "clut_lagos_chase_vista", 2 );
...
{
    _func_0D3( "r_mbvelocityscalar", 0.4 );
}

ramp_up_motion_blur()
{
    wait 0.5;
    _func_0D3( "r_mbvelocityscalar", 1.0 );
}
...
setup_lighting_van_takedown()
{
    ...
    level.player _meth_83C0( "lagos_chase" );
    level.player _meth_8490( "clut_lagos_chase_vista", 1.0 );
    maps\_utility::vision_set_fog_changes( "lagos_chase_vista", 2.0 );
    ...
    wait 13.9;
    level.player _meth_83C0( "lagos_underwater_impact" );
}
...
{
    var_0 = getentarray( "lagos_underwater_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_underwater_volume();
}
...
setup_lighting_underwater_volume()
{
    for (;;)
    {
        ...
        level.player _meth_83C0( "lagos_underwater" );
        level.player _meth_8490( "clut_lagos_chase", 0.25 );
...
{
    level.player _meth_84A9();
    level.player _meth_84AB( 0.73, 65 );
    common_scripts\utility::flag_wait( "van_door_open_lighting" );
    level.player _meth_84AB( 1.78, 39 );
}
...
setup_lighting_underwater_sunlerp()
{
    ...
    lerpsunangles( ( -40, 72, 0 ), ( -30, 0, 0 ), 1.0 );
    common_scripts\utility::flag_wait( "van_door_open_lighting" );
    wait 5.0;
    lerpsunangles( ( -30, 0, 0 ), ( -40, 52, 0 ), 1.0 );
    wait 4.0;
...
setup_lighting_underwater_lights()
{
    ...
    common_scripts\utility::flag_wait( "van_door_open_lighting" );
    wait 6.5;
    thread maps\_utility::sun_light_fade( ( 13, 13, 13 ), ( 1, 1, 1 ), 1.0 );
    wait 3.0;
    thread maps\_utility::sun_light_fade( ( 1, 1, 1 ), ( 13, 13, 13 ), 1.0 );
    wait 1.0;
    resetsunlight();
...
setup_lighting_shoreline()
{
    ...
    thread maps\_lighting::lerp_spot_intensity( "underwater_omni", 1, 0 );
    level.player _meth_83C0( "lagos_shoreline" );
    level.player _meth_8490( "clut_lagos_shoreline", 2 );
    maps\_utility::vision_set_fog_changes( "lagos_shoreline", 0.5 );
    var_0 = getent( "shoreline_rim", "targetname" );
    var_0 _meth_8020( 27, 5 );
...
setup_dof_shoreline()
{
    ...
    if ( level.nextgen )
    {
        level.player _meth_84A9();
        _func_0D3( "r_dof_physical_bokehenable", 1 );
        level.player _meth_84AB( 2.5, 23.0, 20, 20 );
        wait 5.35;
        level.player _meth_84AB( 2.5, 40.0, 20, 20 );
        wait 2.0;
        level.player _meth_84AB( 2.5, 78.0, 20, 20 );
        wait 1.0;
        level.player _meth_84AB( 2.5, 40.0, 20, 20 );
        wait 2.0;
        level.player _meth_84AB( 2.5, 60.0, 20, 20 );
        wait 1.0;
        level.player _meth_84AB( 2.5, 78.0, 20, 20 );
        wait 2.0;
        level.player _meth_84AB( 2.5, 40.0, 20, 20 );
        wait 4.25;
        level.player _meth_84AB( 2.5, 90.0, 20, 20 );
        wait 3.5;
        level.player _meth_84AB( 2.5, 40.0, 20, 20 );
        wait 5.35;
        level.player _meth_84AB( 2.5, 23.0, 20, 20 );
        wait 0.15;
        level.player _meth_84AB( 2.5, 13.0, 20, 20 );
        wait 0.6;
        level.player _meth_84AB( 2.5, 60.0, 20, 20 );
    }
    else
    {
        level.player _meth_84A9();
        level.player _meth_84AB( 3.86, 25.48 );
        wait 5.35;
        level.player _meth_84AB( 3.55, 33.0 );
        wait 5.0;
        level.player _meth_84AB( 3.37, 40.48 );
        wait 7.25;
        level.player _meth_84AB( 3.37, 40.48 );
        wait 4.5;
        level.player _meth_84AB( 3.55, 33.0, 20, 20 );
        wait 1.65;
        level.player _meth_84AB( 3.33, 22.7, 20, 20 );
        wait 2.5;
        level.player _meth_84AB( 3.65, 23.0, 20, 20 );
        wait 1.0;
        level.player _meth_84AB( 2.0, 60.0, 20, 20 );
        level.player _meth_84AB( 19, 5 );
    }
}
...
{
    var_0 = getentarray( "lagos_outro_volume", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 thread setup_lighting_outro_volume();
}
