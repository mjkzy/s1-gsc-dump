...
noisy_turret_think()
{
    ...
    for (;;)
    {
        ...
        var_5 = var_5 + ( var_12 - self.last_pitch_noise );
        var_6 = var_6 + ( var_13 - self.last_yaw_noise );
        self.last_pitch_noise = var_12;
        self.last_yaw_noise = var_13;
        self.cur_local_angles = self.cur_local_angles + ( var_5, var_6, 0 );
    ...
    for (;;)
    {
        ...
        if ( var_13 )
        {
            if ( distancesquared( var_14, var_0.origin ) < var_7 )
            {
                ...
                var_0.alerted_amount = var_0.alerted_amount + var_11 * 2;
                var_15 = 1;
            }
        }
        else if ( distancesquared( var_14, var_0.origin ) < var_8 && sighttracepassed( var_0.origin, var_14, 0, var_0 ) )
        {
            ...
            var_0.alerted_amount = var_0.alerted_amount + var_11;
            var_15 = 1;
        }
...
camera_sway_tuning()
{
    ...
    for (;;)
    {
        ...
        {
            level.values[var_1] = level.values[var_1] + 0.05;
            var_2 = 1;
        }
...
camera_view_tuning( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            level.values[var_2] = level.values[var_2] + 0.05;
            var_3 = 1;
        }
        else if ( level.player buttonpressed( "DPAD_DOWN" ) )
        {
...
helo_sniper_bullet_impacts()
{
    while ( !common_scripts\utility::flag( "flag_player_enters_forest" ) )
    {
        ...
        var_2 = var_2 * randomintrange( 128, 512 );
        var_3 = var_3 * randomintrange( -96, 96 );
        var_5 = randomint( 360 );
        ...
        while ( var_7 < var_13 )
        {
            ...
            if ( var_14 < 0.8 )
            {
                ...
                var_4.origin = var_4.origin + ( var_15, var_16, var_17 );
...
get_helo_spotlight_bullet_origin( var_0 )
{
    ...
    else
    {
        ...
        var_2 = var_2 + vectornormalize( var_0 - var_2 ) * var_1;
        return var_2;
    }
}
