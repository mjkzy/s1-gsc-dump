...
start_cafe_cam_mvmnt_loops()
{
    ...
    for (;;)
    {
        ...
        if ( var_4 - var_1 > 0 )
            var_1 = var_1 + 0.15 * ( var_4 - var_1 );
        else
            var_1 = var_1 + 1 * ( var_4 - var_1 );
...
trans_alleys_end_scripted_enemy_gunshots()
{
    ...
    else
    {
        ...
        for ( var_0 = 0; var_0 < 6; var_0 = var_0 + 1 )
        {
