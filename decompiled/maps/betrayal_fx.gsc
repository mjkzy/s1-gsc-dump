...
treadfx_ai_boats_yacht_vista( var_0 )
{
    var_0 thread ai_boat_water_foamfx( "boat_wake_yacht_main_foam_far" );
    var_0 ai_boat_bow_splash_fx( "boat_wake_yacht_front_splash_fast_far", "boat_wake_yacht_front_splash_slow_far", ( 0, 0, 0 ), ( 0, 0, 0 ) );
}

treadfx_ai_boats_taxi_vista( var_0 )
{
    var_0 thread ai_boat_water_foamfx( "boat_wake_speedboat_main_foam_taxi_far" );
    var_0 ai_boat_bow_splash_fx( "boat_wake_yacht_front_splash_fast_far", "boat_wake_yacht_front_splash_slow_far", ( -75, 0, 0 ), ( 0, 0, 0 ) );
}

gideon_arm_scan( var_0 )
{
    common_scripts\_exploder::exploder( 2010 );
}

scrambler_light( var_0 )
{
    wait 1;
    common_scripts\_exploder::exploder( 2102 );
}

scrambler_light_off( var_0 )
{
    common_scripts\_exploder::kill_exploder( 2102 );
}

confrontation_flashbang( var_0 )
{
    common_scripts\_exploder::exploder( 2008 );
}

confrontation_irons_gun_shot( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "bet_irons_pistol_flash" ), var_0, "tag_flash" );
    soundscripts\_snd::snd_message( "bet_holo_irons_shoot_pistol", var_0 );
    common_scripts\utility::flag_wait( "kill_blood_fx" );
    killfxontag( common_scripts\utility::getfx( "bet_irons_pistol_flash" ), var_0, "tag_flash" );
}

confrontation_tech_blood( var_0 )
{
    wait 0.25;
    playfxontag( common_scripts\utility::getfx( "bet_con_gun_shot_blood" ), var_0, "j_head" );
    wait 0.05;
    common_scripts\_exploder::exploder( 2009 );
    wait 0.05;
    common_scripts\_exploder::exploder( 2101 );
    common_scripts\utility::flag_wait( "kill_blood_fx" );
    killfxontag( common_scripts\utility::getfx( "bet_con_gun_shot_blood" ), var_0, "j_head" );
}
...
vm_glass_impact( var_0 )
{
    wait 0.2;
    common_scripts\_exploder::exploder( 1003 );
}

vm_water_impact( var_0 )
{
    ...
    playfxontag( common_scripts\utility::getfx( "screen_fx_plunge" ), var_0, "tag_origin" );
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_cheap_lp" ), var_0, "J_Wrist_RI" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_cheap_lp" ), var_0, "J_Wrist_LE" );
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_cheap_lp" ), var_0, "tag_origin" );
}

ilana_glass_impact( var_0 )
{
    common_scripts\_exploder::exploder( 1005 );
    common_scripts\_exploder::exploder( 1001 );
    playfxontag( common_scripts\utility::getfx( "glass_slam_body" ), var_0, "J_Hip_LE" );
    wait 0.3;
...
ilana_water_impact( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_cheap_lp" ), var_0, "J_Ankle_RI" );
    playfxontag( common_scripts\utility::getfx( "bubble_trail_runner_cheap_lp" ), var_0, "J_Ankle_LE" );
    waitframe();
    ...
    wait 3;
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_cheap_lp" ), var_0, "J_Ankle_RI" );
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_cheap_lp" ), var_0, "J_Ankle_LE" );
    wait 1.5;
...
canal_boat_explosion( var_0 )
{
    if ( isdefined( self.underwater ) && self.underwater )
    {
        playfxontag( level._effect["vehicle_boat_explo_underwater"], var_0, "tag_origin" );
        wait 5;
        playfxontag( common_scripts\utility::getfx( "bet_boat_bubble_trail" ), var_0, "tag_origin" );
    }
    else
    {
        playfxontag( level._effect["boat_explosion"], var_0, "tag_origin" );
        wait 0.25;
        playfxontag( common_scripts\utility::getfx( "boat_sink_splashes" ), var_0, "tag_origin" );
        wait 6;
        playfxontag( common_scripts\utility::getfx( "bet_boat_bubble_trail" ), var_0, "tag_origin" );
    }
}

canal_boat_hit_bottom( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "dust_boat_impact_ground_underwater" ), var_0, "tag_origin" );
    soundscripts\_snd::snd_message( "bet_swim_boat_hit_bottom", var_0 );
}

canal_underwater_bullet_trails( var_0 )
{
    var_0 = level.player;
    var_1 = randomfloatrange( 0.2, 0.5 );
...
treadfx_ai_boats_yacht( var_0 )
{
    var_0 thread ai_boat_water_foamfx( "boat_wake_speedboat_main_foam" );
    var_0 ai_boat_bow_splash_fx( "boat_wake_speedboat_front_splash_fast", "boat_wake_speedboat_front_splash_slow", ( 0, 0, 0 ), ( 0, 0, 0 ) );
}

treadfx_ai_boats_taxi( var_0 )
{
    var_0 thread ai_boat_water_foamfx( "boat_wake_speedboat_main_foam_taxi" );
    var_0 ai_boat_bow_splash_fx( "boat_wake_speedboat_front_splash_fast", "boat_wake_speedboat_front_splash_slow", ( -75, 0, 0 ), ( 0, 0, 0 ) );
}

ai_boat_water_foamfx( var_0 )
{
    self endon( "death" );
    var_1 = bullettrace( self.origin + ( 0, 0, 500 ), self.origin + ( 0, 0, -100 ), 0, self, 0, 0, 0, 0, 0 );

    if ( isdefined( var_1["surfacetype"] ) && issubstr( var_1["surfacetype"], "water" ) )
    ...
    {
        var_3.origin = ( self.origin[0], self.origin[1], var_2[2] );
...
ai_boat_bow_splash_fx( var_0, var_1, var_2, var_3 )
{
    self endon( "death" );
...
vm_boat_crash_se_fx_start( var_0 )
{
...
vm_boat_crash_se_whiteout( var_0 )
{
    common_scripts\_exploder::exploder( "boat_crash" );
    wait 11.0;
...
vfx_vm_land_crane_edge( var_0 )
{
    thread rooftop_ambient_dust();
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "exo_l_glove_on" ), var_0, "J_Wrist_LE" );
    playfxontag( common_scripts\utility::getfx( "exo_r_glove_on" ), var_0, "J_Wrist_RI" );
    wait 0.25;
    common_scripts\_exploder::exploder( "crane_wall_edge" );
    wait 0.5;
    playfxontag( common_scripts\utility::getfx( "sparks_vm_lp_sml" ), var_0, "j_ball_le" );
    playfxontag( common_scripts\utility::getfx( "sparks_vm_lp_sml" ), var_0, "j_ball_ri" );
    wait 1;
    stopfxontag( common_scripts\utility::getfx( "exo_l_glove_on" ), var_0, "J_Wrist_LE" );
    stopfxontag( common_scripts\utility::getfx( "sparks_vm_lp_sml" ), var_0, "j_ball_le" );
    playfxontag( common_scripts\utility::getfx( "exo_l_glove_off" ), var_0, "J_Wrist_LE" );
    wait 1;
    playfxontag( common_scripts\utility::getfx( "sparks_vm_lp_sml" ), var_0, "j_ankle_le" );
    playfxontag( common_scripts\utility::getfx( "exo_r_glove_off" ), var_0, "J_Wrist_RI" );
    stopfxontag( common_scripts\utility::getfx( "exo_r_glove_on" ), var_0, "J_Wrist_RI" );
    wait 1;
    stopfxontag( common_scripts\utility::getfx( "sparks_vm_lp_sml" ), var_0, "j_ankle_le" );
    stopfxontag( common_scripts\utility::getfx( "sparks_vm_lp_sml" ), var_0, "j_ball_ri" );
    level waittill( "kill_glove_effects" );
    stopfxontag( common_scripts\utility::getfx( "exo_r_glove_off" ), var_0, "J_Wrist_RI" );
    stopfxontag( common_scripts\utility::getfx( "exo_l_glove_off" ), var_0, "J_Wrist_LE" );
}

vfx_vm_land_roof( var_0 )
{
