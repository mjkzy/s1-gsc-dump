...
gideon_water_splash( var_0 )
{
    ...
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_med" ), var_0, "J_ankle_ri" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_elbow_le" );
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_elbow_ri" );
    level waittill( "gideon_hit_bottom" );
    stopfxontag( common_scripts\utility::getfx( "bubble_trail_runner_lp" ), var_0, "j_SpineUpper" );
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_med" ), var_0, "J_ankle_ri" );
    waitframe();
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_elbow_le" );
    stopfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_0, "j_elbow_ri" );
}

gideon_water_splash_cg( var_0 )
{
    wait 1.5;
    soundscripts\_snd::snd_message( "fin_flyin_gideon_splash" );
    common_scripts\_exploder::exploder( "gideon_water_splash" );
    ...
    waitframe();
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_3, "tag_origin" );
    playfxontag( common_scripts\utility::getfx( "bubble_geotrail_thick_xsml" ), var_4, "tag_origin" );
    level waittill( "gideon_hit_bottom" );
    var_1 delete();
    var_2 delete();
    waitframe();
...
{
    var_0 = randomfloatrange( 0.65, 1.15 );
    wait 1.5;
...
bullet_cluster_01()
{
    var_0 = randomfloatrange( 0.15, 0.3 );
    wait(var_0);
...
{
    var_0 = randomfloatrange( 2.25, 3.5 );
...
gideon_bubble_trail_cg()
{
    ...
    waitframe();
    playfxontag( common_scripts\utility::getfx( "bubble_trail_mech_runner_lp" ), var_1, "tag_origin" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "bubble_trail_mech_runner_lp" ), var_2, "tag_origin" );
    waitframe();
    playfxontag( common_scripts\utility::getfx( "bubble_trail_mech_runner_lp" ), var_3, "tag_origin" );
}
...
door_kick_smoke( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "fin_door_kick_slide_sparks" ), var_0, "TAG_ORIGIN_ANIMATED" );
}

exhaust_hatch_break_gideon( var_0 )
{
...
exhaust_hatch_break_player( var_0 )
{
...
player_rocket()
{
    ...
    var_0 = getent( "missile_main_02", "targetname" );
    earthquake( 0.3, 2, var_0.origin, 3000 );
    ...
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_blue" ), var_0, "missile" );
    earthquake( 0.4, 3, var_0.origin, 2000 );
    wait 0.8;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach1" );
    earthquake( 0.3, 2, var_0.origin, 2000 );
    wait 0.6;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach2" );
    earthquake( 0.3, 2, var_0.origin, 2000 );
    wait 0.6;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach3" );
    earthquake( 0.3, 2, var_0.origin, 2000 );
    wait 0.5;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach4" );
    earthquake( 0.3, 2, var_0.origin, 2000 );
    wait 0.4;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach5" );
    earthquake( 0.3, 3, var_0.origin, 2000 );
    wait 0.3;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach6" );
    earthquake( 0.2, 40, var_0.origin, 2000 );
    ...
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_blue_idle" ), var_0, "missile" );
    stopfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_blue" ), var_0, "missile" );
    wait 0.3;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml_idle" ), var_0, "tag_attach1" );
    stopfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach1" );
    wait 0.3;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml_idle" ), var_0, "tag_attach2" );
    stopfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach2" );
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml_idle" ), var_0, "tag_attach3" );
    stopfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach3" );
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml_idle" ), var_0, "tag_attach4" );
    stopfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach4" );
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml_idle" ), var_0, "tag_attach5" );
    stopfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach5" );
    wait 0.2;
    playfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml_idle" ), var_0, "tag_attach6" );
    stopfxontag( common_scripts\utility::getfx( "fin_rocket_thruster_sml" ), var_0, "tag_attach6" );
...
{
    playfxontag( common_scripts\utility::getfx( "mech_damage_sparks_lp" ), var_0, "j_elbow_ri" );
    wait 0.5;
    playfxontag( common_scripts\utility::getfx( "mech_damage_sparks_lp" ), var_0, "j_SpineUpper" );
    level waittill( "stop_mech_effects" );
    stopfxontag( common_scripts\utility::getfx( "mech_damage_sparks_lp" ), var_0, "j_elbow_ri" );
    stopfxontag( common_scripts\utility::getfx( "mech_damage_sparks_lp" ), var_0, "j_SpineUpper" );
}

vfx_gideon_mech_rolls_over( var_0 )
{

}

vfx_vm_mech_sparks( var_0 )
{

}

vfx_vm_mech_stop_effects( var_0 )
{
    level notify( "stop_mech_effects" );
}

vfx_vm_mech_dmg_sparks( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "mech_damage_sparks_lp" ), var_0, "j_elbow_ri" );
...
lobby_ambient_aa_explosions()
{
    ...
    var_0 = [ ( 19736.3, -81201.1, 6196.13 ), ( 20326.3, -79994, 6168.28 ), ( 20242.2, -81596, 7343.56 ), ( 22233.2, -76351, 6777.65 ), ( 20011.2, -78193.8, 6131.02 ), ( 12361.5, -91154.7, 9126.11 ), ( 8435.29, -90739, 8148.44 ), ( 10200.3, -88663.2, 6542.32 ), ( 12048.4, -87566, 6595.51 ), ( 9218.16, -88224, 8567.6 ), ( 12797.4, -89343.2, 9535.41 ), ( 22749.1, -82353.5, 6832.5 ), ( 13236.1, -87067, 7096.58 ), ( 22476.3, -79821.1, 7969.65 ), ( 10947.5, -86478.5, 7118.63 ), ( 10868.1, -85830.2, 7855.8 ) ];
    var_1 = [ ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ) ];
    thread maps\_shg_fx::start_fx_by_view( "aa_explosion_runner_single", var_0, 1, 4, "sky_bridge_vfx", 0, var_1 );
}

lobby_ambient_explosion_midair_runner_single()
{
    level waittill( "msg_fx_zone1200_lobby" );
    var_0 = [ ( 19877.2, -79864.8, 6888.36 ), ( 19678.5, -77684.2, 6791.43 ), ( 9107.69, -89243.1, 6073.12 ), ( 12487.5, -92650.9, 8446.7 ), ( 9298.35, -89098.5, 9392.02 ), ( 14205.4, -85589.7, 6770.85 ), ( 12860.9, -86394.9, 6118.32 ), ( 13143.9, -88688.8, 8805.71 ), ( 24161, -81664.9, 6585.47 ), ( 20303.4, -82089.7, 7262.87 ), ( 10241.6, -87617.2, 7091.35 ), ( 19590.2, -77617.1, 6095.31 ), ( 11175.6, -87714.1, 6193.76 ), ( 11340.4, -86181.1, 7414.02 ), ( 20793.7, -80326.9, 5903.01 ), ( 20724.3, -78300, 5931.67 ) ];
    var_1 = [ ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ) ];
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_midair_runner_single", var_0, 3, 6, "msg_fx_zone1500_will_room", 0, var_1 );
}
...
{
    level waittill( "sky_bridge_vfx" );
    var_0 = [ ( 4654.03, -102993, 10692.7 ), ( 13108.2, -101759, 9690.11 ), ( 736.915, -101098, 9018.34 ), ( 15751.2, -102791, 11452.8 ), ( 10144.1, -106871, 11625.6 ), ( 2581.71, -100424, 12561.6 ), ( 17300, -97559.2, 8630.33 ), ( 9033.09, -97071.9, 12803.7 ), ( 15428.6, -98442.5, 13594.4 ), ( 5523.56, -104965, 14269.9 ) ];
    var_1 = [ ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ) ];
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_midair_runner_single", var_0, 0.5, 4, "msg_fx_zone1500_will_room", 0, var_1 );
}

skybridge_ambient_aa_explosions()
{
    level waittill( "sky_bridge_vfx" );
    var_0 = [ ( 2891.15, -103482, 14244.9 ), ( 8019.56, -104272, 15480 ), ( 3658.89, -90765.2, 9855.59 ), ( 10137.5, -100169, 16460.7 ), ( 15199.7, -108507, 13215.5 ), ( 1598.96, -101172, 16679.1 ), ( 14825.9, -100589, 14981.1 ), ( 4983.57, -106438, 20693.1 ), ( 20345.4, -104944, 13060.4 ), ( 13528.8, -100043, 18455.4 ), ( 1970.3, -110849, 19329.2 ) ];
    var_1 = [ ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ), ( 7.85488, 241.093, -174.052 ) ];
    thread maps\_shg_fx::start_fx_by_view( "aa_explosion_runner_single", var_0, 1, 3, "msg_fx_zone1500_will_room", 0, var_1 );
}
...
exo_release_vm_error_glow( var_0 )
{
    playfxontag( common_scripts\utility::getfx( "fin_exo_exit_glow_vm" ), var_0, "J_Elbow_LE" );
    wait 7;
    common_scripts\_exploder::kill_exploder( "lighton" );
}
...
end_roof_ambient_aa_explosions()
{
    ...
    var_0 = [ ( 28703.9, -88023.5, 11551 ), ( 25077.8, -84256.8, 12100.7 ), ( 28887.8, -79686.6, 9774.34 ), ( 24696.7, -81974, 12089.4 ), ( 22728, -80444.8, 10428.3 ), ( 31915.3, -84699.8, 14781.3 ), ( 25735.8, -88644.5, 10002.1 ), ( 27265.4, -89793.7, 11532.1 ), ( 24224, -91568, 11330.7 ), ( 25254.6, -91533.8, 10644.4 ), ( 24560.8, -92454.8, 13595.9 ), ( 28707.7, -95667.6, 10299.2 ), ( 23550.3, -79951.1, 12258.5 ), ( 21190.7, -80163.7, 11070.2 ), ( 19338.8, -79769.9, 11707.2 ), ( 21419, -75094.7, 10657 ), ( 17673.9, -76488.6, 10542 ), ( 16869.9, -80385.9, 11332.6 ), ( 26806.4, -91364.5, 14506.9 ), ( 25643.1, -88129, 12719.4 ), ( 14173.2, -78073.8, 12742.2 ), ( 15887.1, -78018.1, 13130.5 ), ( 14944.6, -75276.4, 10847.7 ), ( 19736.1, -82553, 11637.7 ), ( 17740.4, -80421, 12633.4 ), ( 24259.9, -81211.7, 14150.9 ), ( 27089.1, -95804.8, 12968.9 ), ( 22356.6, -93927.5, 12621.6 ), ( 30944.8, -79806.1, 8693.74 ), ( 28123.8, -71647, 9182.44 ), ( 31380.5, -74470.8, 9871.97 ), ( 25359.1, -80539.9, 10515.7 ), ( 36674.8, -93126.5, 9679.31 ), ( 31733.7, -95108, 9175.21 ), ( 25619.9, -86854, 14161.5 ), ( 22226.9, -94309.3, 10330.2 ), ( 21923.2, -95930.2, 12235.1 ), ( 20882.5, -99521.3, 14230.7 ), ( 19706.3, -90424.1, 11999.8 ), ( 23950, -98925.1, 9814.04 ), ( 17665, -94561.3, 13209 ), ( 19034.6, -98377.5, 10083.2 ), ( 16737.9, -97170.3, 12966.1 ), ( 15529.7, -97697.8, 14274.2 ), ( 14298.2, -97084.1, 11167.8 ), ( 13709, -101641, 13791.6 ), ( 15771.5, -95331.8, 11045 ), ( 18642.5, -98693.9, 12202.7 ), ( 12463.6, -99664.3, 8967.25 ), ( 13636.4, -97820, 10217.7 ), ( 10947.2, -97552.8, 8803.92 ), ( 11118.4, -95462.6, 10422 ) ];
    var_1 = [ ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ), ( 270, 0, 0 ) ];
    thread maps\_shg_fx::start_fx_by_view( "aa_explosion_runner_single", var_0, 1.2, 4, "sky_bridge_vfx", 0, var_1 );
}
...
end_roof_ambient_midair_runner_explosion_single()
{
    ...
    thread maps\_shg_fx::start_fx_by_view( "ambient_explosion_midair_runner_single", var_0, 1.8, 6, "sky_bridge_vfx", 0, var_1 );
}
...
vfx_landing_dust_npc( var_0 )
{
    wait 0.15;
    common_scripts\_exploder::exploder( "dust_poof_landing" );
}

vfx_push_over_ledge( var_0 )
{

}

vfx_irons_tackle( var_0 )
{
...
vfx_balcony_break_through( var_0 )
{
...
{
    playfxontag( common_scripts\utility::getfx( "fin_player_arm_cut_spark_burst_single" ), var_0, "J_Elbow_LE" );
}

vfx_arm_piece_fall( var_0 )
{
