...
missile_turret_think()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in self.missile_starts )
        {
            ...
            var_2 = var_2 * 5000;
            var_2 = var_2 + ( randomintrange( 500, 1000 ), randomintrange( 500, 1000 ), randomintrange( 1000, 2000 ) );
...
start_idle_shooting()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in var_0.missle_starts )
        {
            ...
            var_3 = var_3 * 5000;
            var_3 = var_3 + ( randomintrange( 500, 1000 ), randomintrange( 500, 1000 ), randomintrange( 1000, 2000 ) );
...
move_squad_to_bridge()
{
    ...
    foreach ( var_1 in level.heroes )
        var_1.baseaccuracy = var_1.baseaccuracy * 10;
}
