...
{
    precachefx();
    precacheshellshock( "weapon_suv_door_shield_fl" );
    precacheshellshock( "weapon_suv_door_shield_fr" );
    precacheshellshock( "weapon_boxtruck_door_shield_fl" );
    precacheshellshock( "weapon_boxtruck_door_shield_fr" );
...
doors_intialize( var_0, var_1 )
{
    foreach ( var_3 in var_0 )
    {
        if ( level.player usinggamepad() )
            var_3 sethintstring( &"_CAR_DOOR_SHIELD_INTERACT" );
        else
            var_3 sethintstring( &"_CAR_DOOR_SHIELD_INTERACT_PC" );
...
door_shield_think()
{
    ...
    for ( var_5 = 1; var_5 < var_4.size; var_5++ )
        var_1 hidepart( var_4[var_5], var_1.model );
...
stecil_when_in_view()
{
    ...
    while ( isdefined( self ) )
    {
        ...
        if ( var_0 < 200 && target_isincircle( self, level.player, 65, 150 ) )
...
play_vb_cardoor_anim( var_0, var_1 )
{
    ...
    self playerlinktoblend( var_3, "tag_player", var_4 );
...
car_door_ripoff_fx( var_0 )
{
    if ( issubstr( var_0.model, "fr" ) )
    {
        ...
        var_1 linkto( var_0, "tag_flash", ( 0, 35, 0 ), ( 0, 0, 0 ) );
    ...
    else
    {
        ...
        var_2 linkto( var_0, "tag_flash", ( 0, -35, 0 ), ( 0, 0, 0 ) );
...
give_door_shield_weapon( var_0, var_1, var_2, var_3 )
{
    ...
    var_0 linktoplayerview( level.player, "TAG_WEAPON_LEFT", ( 0, 0, 0 ), ( 0, get_yaw_offset_if_vm_model( var_2 ), 0 ), 1 );
...
exo_door_throw( var_0, var_1 )
{
    ...
    if ( !1 )
    {
        ...
        var_2 setmodel( "npc_atlas_suv_door_FL" );
    ...
    target_set( var_4 );
    target_hidefromplayer( var_4, level.player );
    var_5 = undefined;
    ...
    if ( var_1 )
    {
        ...
        {
            var_4.origin = var_9 geteye();

            if ( target_isincircle( var_4, level.player, 65, 100 ) )
                var_7 = var_9;
        }
...
fire_door_shield( var_0, var_1 )
{
    ...
    {
        var_7 = anglestoforward( level.player getgunangles() );
    ...
    self physicslaunchserver( self.origin, var_2 * randomfloatrange( var_3, var_4 ), 20000, 1080 );
...
kill_npc_on_impact( var_0 )
{
    ...
    self startragdollfromimpact( "torso_lower", var_1 * 3400 );
    ...
    for (;;)
    {
        if ( level.player isthrowinggrenade() )
        {
            ...
            for (;;)
            {
                ...
                if ( var_1 == "frag_button" && level.player secondaryoffhandbuttonpressed() )
                {
                    var_1 = "secondary_offhand_button";
                    continue;
                }

                if ( var_1 == "secondary_offhand_button" && level.player fragbuttonpressed() )
                {
                    var_1 = "frag_button";
                    continue;
                }
...
monitor_weapon_switch( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( issubstr( level.player getcurrentweapon(), "door" ) )
        {
            ...
            if ( weaponinventorytype( var_1 ) != "offhand" && var_1 != "none" )
                var_2 = 0;

            thread play_throw_anim( level.player getcurrentweapon(), var_0, 0, var_2 );
            return;
        }
    }
}
...
monitor_door_broken( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( issubstr( level.player getcurrentweapon(), "door" ) )
        {
            thread play_throw_anim( level.player getcurrentweapon(), var_0, 0 );
            return;
        }
    }
}
...
{
    var_0 = level.player getcurrentoffhand();
...
monitor_door_state( var_0, var_1 )
{
    ...
    for ( var_5 = 1; var_5 < var_4.size; var_5++ )
        var_0 hidepart( var_4[var_5], var_0.model );
...
handle_car_door_shield_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( is_current_weapon_shield( var_0 getcurrentweapon() ) )
    {
        ...
        if ( var_1.state_num < var_2.size - 1 )
        {
            ...
            if ( var_1.door_state_health <= 0 )
            {
                ...
                foreach ( var_15 in var_2 )
                    var_1 hidepart( var_15, var_1.model );

                var_1 showpart( var_2[var_1.state_num], var_1.model );
