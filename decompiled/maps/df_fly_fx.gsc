...
vfx_dam_setup()
{
    var_0 = getent( "dam_cracks1", "targetname" );
    var_1 = getent( "dam_cracks2", "targetname" );
    var_0 thread vfx_dam_burst( "dam_cracks1" );
    var_1 thread vfx_dam_burst( "dam_cracks2" );
}
...
vfx_handle_disintegrating_jet()
{
    ...
    switch ( var_0 )
    {
        case 1:
            ...
            break;
        case 2:
            var_1 = "bagh_atlas_jet_disintegrate01";
            break;
        case 3:
            var_1 = "bagh_atlas_jet_disintegrate02";
            break;
        case 4:
            var_1 = "bagh_atlas_jet_disintegrate01";
            break;
    ...
    if ( var_0 > 1 )
    {
        ...
        if ( var_0 == 4 )
        {
            ...
            var_2 rotate_roll_link( self, "tag_origin", -1440 * var_5, 0, randomintrange( 2, 5 ) );
        }
        ...
        if ( isdefined( self ) )
        {
            killfxontag( common_scripts\utility::getfx( var_1 ), var_2, "tag_origin" );
            playfx( common_scripts\utility::getfx( "bagh_aircraft_explosion_midair" ), self.origin );
        }
...
rotate_roll_link( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
    var_6 = var_2 / ( var_4 / 0.05 );
    var_7 = 0;

    if ( var_3 != 0 )
        var_7 = var_3 / ( var_4 / 0.05 );
