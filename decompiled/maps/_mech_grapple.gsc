...
mech_spawn_player_rig()
{
    ...
    else
    {
        ...
        var_0 _meth_80B1( self.grapple["model_body"].model );
    }
...
mech_start_grapple_tappy( var_0, var_1, var_2 )
{
    ...
    var_4 _meth_804D( var_5 );
    var_3.link = var_5;
    var_5 _meth_82B5( ( vectortoangles( var_1.origin - var_0.origin )[0], var_0.angles[1], var_0.angles[2] ), 0.2 );
    var_0 maps\_grapple::grapple_disconnect();
    var_0 _meth_807F( var_3, "tag_player" );
    var_3 show();
    var_6 = common_scripts\utility::spawn_tag_origin();
    var_6.origin = var_1.origin;
    var_6.angles = var_1.angles;
    var_6 _meth_8092();
    var_1 _meth_804D( var_6 );
    var_6 _meth_82B5( ( var_6.angles[0], var_0.angles[1], var_6.angles[2] ), 0.2 );
    ...
    wait 1;
    var_0 _meth_80AE( "minigun_rumble" );
    ...
    _func_0D3( "r_dof_physical_accurateFov", 1 );
    var_0 _meth_84A9();
...
mech_handle_grapple_tappy( var_0, var_1, var_2, var_3 )
{
    ...
    var_1 _meth_8117( var_1 maps\_utility::getanim( var_6 ), 0.5 );
    var_3 _meth_8117( var_3 maps\_utility::getanim( var_6 ), 0.5 );
    var_0 thread mech_grapple_tappy_monitor_button_presses();
    var_0 _meth_84AB( 1.0, var_9, 0.25, 0.25 );
    ...
    while ( var_8 > 0.0 )
    {
        ...
        {
            if ( var_5 < 0.0 )
                var_0 _meth_84AB( 2.5, 6.0, 0.25, 0.25 );
            else
                var_0 _meth_84AB( 2.0, var_9, 0.25, 0.25 );

            var_10 = 1.0 - var_1 _meth_814F( var_1 maps\_utility::getanim( var_6 ) );
            var_6 = var_7;
            var_1 thread maps\_anim::anim_single_solo( var_1, var_6 );
            var_1 thread maps\_anim::anim_single_solo( var_3, var_6 );
            var_1 _meth_8117( var_1 maps\_utility::getanim( var_6 ), var_10 );
            var_3 _meth_8117( var_1.rope maps\_utility::getanim( var_6 ), var_10 );
        }

        var_1 _meth_83C7( var_1 maps\_utility::getanim( var_6 ), abs( var_5 ) );
        var_3 _meth_83C7( var_3 maps\_utility::getanim( var_6 ), abs( var_5 ) );
        wait 0.05;
        var_8 -= 0.05;
    }
    ...
    if ( var_6 == "tappy" )
    {
        ...
        var_1 thread maps\_anim::anim_single_solo( var_3, var_6 );
        var_1 _meth_8117( var_1 maps\_utility::getanim( var_6 ), var_10 );
        var_3 _meth_8117( var_3 maps\_utility::getanim( var_6 ), var_10 );
    }

    var_1 _meth_83C7( var_1 maps\_utility::getanim( var_6 ), 1.0 );
    var_3 _meth_83C7( var_3 maps\_utility::getanim( var_6 ), 1.0 );
}
...
mech_grapple_player_success_loop( var_0 )
{
    ...
    wait 0.3;
    level.player _meth_80AF( "minigun_rumble" );
    wait 1.0;
    level.player _meth_80AD( "mech_grapple_kill" );
    wait 0.1;
    level.player _meth_80AF( "mech_grapple_kill" );
    ...
    var_2 = distance( var_1, var_0.start_origin + _func_06F( var_0.angles, level.scr_anim["mech_grapple_guy"]["success_start"] ) );
    var_3 = var_2 / 360.0;
    var_3 += ( 1.0 - var_0 _meth_814F( level.scr_anim["mech_grapple_guy"]["success_start"] ) ) * getanimlength( level.scr_anim["mech_grapple_guy"]["success_start"] );
    var_3 = floor( var_3 * 10.0 ) / 10.0;
    var_4 = getanimlength( level.scr_anim["mech_grapple_player"]["success_loop"] ) / var_3;
    self _meth_83C7( level.scr_anim["mech_grapple_player"]["success_loop"], var_4 );
}
...
mech_grapple_tappy_success( var_0 )
{
    ...
    var_3 = var_0.rope;
    var_4 = var_1.origin;
    var_0 _meth_83C7( var_0 maps\_utility::getanim( "tappy" ), 1.0 );
    var_3 _meth_83C7( var_3 maps\_utility::getanim( "tappy" ), 1.0 );
    var_5 = distance( var_1.origin, var_2.origin );
    var_2 _meth_84AB( 2.0, var_5, 0.05, 0.05 );
    ...
    var_8 _meth_8092();
    var_6 _meth_804D( var_8 );
    var_8 _meth_82B5( ( vectortoangles( var_4 - var_2.origin )[0], var_8.angles[1], var_8.angles[2] ), 0.1 );
    ...
    var_6 _meth_804D( var_0.link );
    wait 0.2;
    var_2 _meth_80AD( "mech_grapple_kill" );
    wait 0.05;
    var_8 _meth_82B5( ( 0, var_8.angles[1], var_8.angles[2] ), 0.25 );
    var_0.link _meth_82B5( ( 0, var_0.link.angles[1], var_0.link.angles[2] ), 0.25 );
    wait 0.9;
    var_2 _meth_80AD( "mech_grapple_kill" );
...
mech_grapple_pull_guy_to_player( var_0 )
{
    ...
    if ( var_5 >= 0.1 )
    {
        ...
        var_1 _meth_82AE( var_2, var_5, var_5 / 2, 0.0 );
        var_1 _meth_82B5( var_3, var_5 * 0.25, min( 0.1, var_5 * 0.1 ), min( 0.1, var_5 * 0.1 ) );
        self.player _meth_84AB( 1.5, var_4, var_5, var_5 );
        var_0 thread maps\_anim::anim_single_solo( var_0, "success_loop" );
        var_0 _meth_83C7( level.scr_anim["mech_grapple_guy"]["success_loop"], getanimlength( level.scr_anim["mech_grapple_guy"]["success_loop"] ) / var_5 );
        wait(var_5);
    }

    level notify( "aud_stop_grapple_mech_pull" );
    thread mech_slate_quick();
    self.player _meth_84AB( 2.0, 6.0, 0.1, 0.1 );
    var_0 _meth_804F();
    var_1 delete();
}
...
mech_grapple_spawn_mech_parts( var_0 )
{
    ...
    var_1[0] _meth_8115( #animtree );
    var_1[0] _meth_80B1( "playermech_animated_model_btm" );
    var_1[1] = spawn( "script_model", var_0.origin );
    var_1[1].angles = var_0.angles;
    var_1[1].animname = "mech_grapple";
    var_1[1] _meth_8115( #animtree );
    var_1[1] _meth_80B1( "playermech_animated_model_top" );
...
mech_grapple_tappy_fail( var_0 )
{
    ...
    var_2 = var_0.player;
    var_3 = var_0.rope;
    var_0 _meth_83C7( var_0 maps\_utility::getanim( "tappy_rev" ), 1.0 );
    var_1 _meth_83C7( maps\_utility::getanim_from_animname( "tappy_rev", "mech_grapple" ), 1.0 );
    var_0 waittillmatch( "single anim", "end" );
    level notify( "aud_stop_grapple_mech_cable_stress" );
    level notify( "aud_stop_grapple_mech_servo" );
    var_2 _meth_84AA();
    _func_0D3( "r_dof_physical_enable", level.old_dof_physical_enable );
    var_2 _meth_80F0();
...
{
    var_0.player _meth_84AB( 5.6, 100, 0.25, 0.25 );
    wait 0.25;
    var_0.player _meth_84AA();
    _func_0D3( "r_dof_physical_enable", level.old_dof_physical_enable );
...
vfx_mech_grapple_fx()
{
    ...
    var_2 = self gettagorigin( "jnt_bridge" );
    var_3 = self gettagangles( "jnt_bridge" );
