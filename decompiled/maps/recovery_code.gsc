...
training_s1_door_breach_anim()
{
    ...
    var_2.angles = var_2.angles + var_3;
    var_2.origin = var_2.origin + var_4;
    wait 1;
...
training_s1_ending()
{
    ...
    var_10.origin = var_10.origin + ( 0, 0, 3.25 );
    var_11 = 0.4;
    ...
    var_12.origin = var_12.origin + ( 0, 0, 64 );
...
tour_ambient_01()
{
    ...
    var_10 linkto( var_9 );
    var_9.origin = var_9.origin - ( 331, 0, 0 );
    wait 5.0;
...
tour_titan_02()
{
    ...
    var_5.origin = var_5.origin + ( 0, 0, 55 );
...
tour_variable_grenade_auto_fill()
{
    ...
    var_0 = 0;
    var_0 = var_0 + level.player setweaponammostock( "flash_grenade_var" );
    var_0 = var_0 + level.player setweaponammostock( "emp_grenade_var" );
    var_0 = var_0 + level.player setweaponammostock( "paint_grenade_var" );
    var_0 = var_0 + level.player setweaponammostock( "frag_grenade_var" );
    var_0 = var_0 + level.player setweaponammostock( "contact_grenade_var" );
    var_0 = var_0 + level.player setweaponammostock( "tracking_grenade_var" );
    var_0 = var_0 / 3;
...
ready_room_sniper_rifle()
{
    ...
    var_0.origin = var_0.origin - ( 0, 0, 500 );
...
training_s2_player_breach()
{
    ...
    var_4 = var_4 - 0.5 * clamp( var_5 / 200, 0, 1 );
    var_3 hide();
...
training_s2_helicopter_player()
{
    ...
    var_2 = var_2 - 0.4 * clamp( var_3 / 250, 0, 1 );
    level.player maps\_utility::add_wait( maps\_shg_utility::setup_player_for_scene, 1 );
