...
hintprint( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    var_8 = gettime();
    ...
    var_14 = maps\_hud_util::createclientfontstring( "default", var_13 );
    level.current_hint = var_14;
    level.hint_breakfunc = var_1;
    thread destroy_hint_on_friendlyfire( var_14 );
    level endon( "friendlyfire_mission_fail" );
    var_14.alpha = 0.9;
    var_14.x = 0;
    var_14.y = -68 + var_7;
    var_14.alignx = "center";
    var_14.aligny = "middle";
    var_14.horzalign = "center";
    var_14.vertalign = "middle";
    var_14.foreground = 0;
    var_14.hidewhendead = 1;
    var_14.hidewheninmenu = 1;
    var_14 settext( var_0 );
    ...
    if ( isdefined( var_5 ) )
        var_16 thread hint_timeout( var_5 );

    if ( isdefined( level.hint_breakfunc ) )
    {
        for (;;)
        {
            var_14 fadeovertime( var_10 );
            var_14.alpha = var_12;
            hintprintwait( var_10, level.hint_breakfunc );
    ...
    maps\_utility::wait_for_buffer_time_to_pass( var_8, var_6 );
    var_14 notify( "destroying" );
