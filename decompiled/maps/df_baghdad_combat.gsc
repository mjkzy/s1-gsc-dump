...
heli_shoot_allies( var_0 )
{
    ...
    foreach ( var_2 in self.mgturret )
    {
        ...
        var_2 _meth_80E2();
        var_2 common_scripts\utility::delaycall( 4, ::_meth_80E3 );
    }
    ...
    {
        var_2 _meth_80E2();
        var_2 _meth_8106( var_4[var_5] );
        var_7 = getent( var_4[var_5].target, "targetname" );
        var_4[var_5] _meth_82AE( var_7.origin, 6, 3, 0.1 );
        var_5++;
    }
...
player_grapple_into_vehicle( var_0, var_1, var_2 )
{
    ...
    level.player _meth_8080( var_3, "tag_player", 0.25, 0.1, 0.1 );
    wait 0.25;
    level.player _meth_807D( var_3, "tag_player", 1.0, 25, 25, 25, 25, 1 );
...
heli_strafe( var_0 )
{
    ...
    for (;;)
    {
        ...
        for ( var_5 = 0; var_5 < 2; var_5++ )
        {
            ...
            var_6 _meth_8065( "manual" );
            var_6 _meth_8106( var_4, ( 0, 0, 36 ) );
            var_6 _meth_80E2();
            var_6 common_scripts\utility::delaycall( var_1, ::_meth_80E3 );
        }
...
handle_drone_group( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( !isdefined( var_3 ) || !_func_22A( level.player.origin, var_3 ) )
        {
...
tower_combat_wave3()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( isalive( var_2 ) )
        {
            var_2 _meth_8177( "front1_allies" );
            var_2 thread wait_for_cleanup();
            var_2.canjumppath = 1;
        }
    }
