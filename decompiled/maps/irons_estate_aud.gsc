...
create_level_envelop_arrays()
{
    ...
    level.aud.envs["aud_mute_device_falloff"] = [ [ 0.0, 1.0 ], [ 0.1, 0.9 ], [ 0.2, 0.88 ], [ 0.3, 0.85 ], [ 0.4, 0.82 ], [ 0.5, 0.8 ], [ 0.6, 0.65 ], [ 0.7, 0.5 ], [ 0.8, 0.35 ], [ 0.9, 0.15 ], [ 1.0, 0.0 ] ];
}
...
zone_handler( var_0, var_1 )
{
    ...
    switch ( var_0 )
    {
        case "enter_irons_int_poolhouse":
            if ( var_2 == "irons_ext_grounds_quiet" )
                thread aud_poolhouse_ambience();

            break;
        case "exit_irons_int_poolhouse":
            if ( var_3 == "irons_ext_grounds_quiet" )
        ...
        case "enter_irons_int_guard_station":
            ...
            else if ( var_2 == "irons_int_guard_station_corridor" )
                thread aud_guard_station_ambience();
        case "exit_irons_int_guard_station":
            if ( var_3 == "irons_ext_grounds_quiet" )
                level notify( "aud_stop_guard_station_ambience" );
            else if ( var_3 == "irons_int_guard_station_corridor" )
                level notify( "aud_stop_guard_station_ambience" );
...
start_grapple()
{
    ...
    thread aud_waterfall_ambience();
    soundscripts\_audio_zone_manager::azm_start_zone( "irons_ext_falls_cliff", 1.0 );
...
start_recon()
{
    ...
    soundscripts\_audio_zone_manager::azm_start_zone( "irons_ext_falls_top", 1.0 );
    thread aud_foliage_movement();
    thread aud_foliage_mix();
}
...
start_security_center()
{
    ...
    soundscripts\_audio_zone_manager::azm_start_zone( "irons_ext_grounds_quiet", 1.0 );
    thread aud_foliage_movement();
    thread aud_foliage_mix();
}
...
start_hack_security()
{
    ...
    thread aud_estate_grounds_emitters();
    thread stealth_music_control_p1();
    soundscripts\_audio_zone_manager::azm_start_zone( "irons_int_security_center_main", 1.0 );
    thread aud_foliage_movement();
    thread aud_foliage_mix();
}
...
start_intel()
{
    ...
    thread aud_waterfall_ambience();
    thread aud_estate_grounds_emitters();
    soundscripts\_audio_zone_manager::azm_start_zone( "irons_int_penthouse_living", 1.0 );
...
aud_cave_ambience()
{
    soundscripts\_audio_zone_manager::azm_start_zone( "irons_ext_cave_intro", 1.0 );
    var_0 = soundscripts\_snd_playsound::snd_play_loop_2d( "mus_irons_cave_amb", "stop_mus_irons_cave_amb", 9, 3 );
...
aud_sprinklers()
{
    ...
    for (;;)
    {
        if ( common_scripts\utility::flag( "aud_human_activity_area_1" ) == 1 && var_0 != 1 )
        {
            var_0 = 1;
        ...
        else if ( common_scripts\utility::flag( "aud_human_activity_area_2" ) == 1 && var_0 != 2 )
        {
            var_0 = 2;
        ...
        else if ( common_scripts\utility::flag( "aud_human_activity_area_3" ) == 1 && var_0 != 3 )
        {
            var_0 = 3;
            level notify( "aud_stop_mid_area_sprinklers" );
            wait 2;
...
aud_security_countdown()
{
    ...
    while ( !common_scripts\utility::flag( "player_is_out_of_security_center" ) && var_0 > 1 )
    {
        var_1 = gettime();

        if ( var_1 - level.aud_last_time > 950 )
        {
            soundscripts\_snd_playsound::snd_play_2d( "irons_timer_tick" );
            level.aud_last_time = var_1;
            var_0 -= 1;
        }
...
aud_vtol_land( var_0 )
{
    ...
    {
        var_0 soundscripts\_snd_playsound::snd_play_linked( "irons_vtol_landing" );
...
{
    level.player endon( "death" );
    var_0 = spawn( "script_origin", ( -7925, -3370, 1443 ) );
    var_1 = spawn( "script_origin", ( 8151, -3673, 1443 ) );
    var_0 soundscripts\_snd_playsound::snd_play_loop( "irons_amb_rooftops_front" );
    var_1 soundscripts\_snd_playsound::snd_play_loop( "irons_amb_rooftops_rear" );
    ...
    for (;;)
    {
        ...
        {
            level.aud_rooftop_wind_volume = ( var_2 - 200 ) / 200;
        ...
        {
            level.aud_rooftop_wind_volume = ( var_2 - 350 ) / 350;
        ...
        {
            level.aud_rooftop_wind_volume = ( var_2 - 800 ) / 800;
            soundscripts\_audio_mix_manager::mm_add_submix( "irons_occlude_pool_music" );
        }
        else
...
aud_guardhouse_foley_cormack()
{
    ...
    level.allies[0] waittillmatch( "single anim", "run_to_street" );
    wait 0.5;
    ...
    level.allies[0] waittillmatch( "single anim", "roll_out" );
    wait 0.5;
...
aud_exfil_vtol_grapple()
{
    ...
    var_0 = level.vtol.origin[2];
    var_1 = level.player.origin[2];
    var_2 = ( var_0 - var_1 ) / 2500;
    soundscripts\_snd_playsound::snd_play_delayed_2d( "irons_vtol_grapple", var_2 );
    soundscripts\_snd_playsound::snd_play_delayed_2d( "irons_finale_onboard_front", var_2 );
    wait(var_2);
...
aud_panic_walla()
{
    ...
    else if ( common_scripts\utility::flag( "aud_human_activity_area_2" ) == 1 )
...
aud_foliage_movement()
{
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        {
            var_2 = distance( level.player getvelocity(), ( 0, 0, 0 ) );
...
aud_foliage_insects()
{
    if ( randomint( 100 ) > 94 && level.aud_insect_sound == 0 )
    {
        ...
        if ( randomint( 10 ) == 0 )
        {
            var_0 = level.player.origin + ( randomintrange( -50, 50 ), randomintrange( -50, 50 ), 0 );
            soundscripts\_snd_playsound::snd_play_at( "irons_insect_buzz", var_0 );
        }
        else
        {
            var_1 = randomint( 4 );
            ...
            {
                case 0:
                    var_2 = level.player.origin + ( randomintrange( -1000, 1000 ), randomintrange( -1000, 1000 ), 0 );
                    var_3 = randomint( 7 );

                    for ( var_4 = 0; var_4 < var_3; var_4++ )
                    {
                        soundscripts\_snd_playsound::snd_play_at( "irons_insect_chirp_a", var_2 );
                        wait 0.8;
                    }

                    break;
                case 1:
                    var_5 = level.player.origin + ( randomintrange( -1000, 1000 ), randomintrange( -1000, 1000 ), 0 );
                    var_3 = randomint( 4 );

                    for ( var_4 = 0; var_4 < var_3; var_4++ )
                    {
                        soundscripts\_snd_playsound::snd_play_at( "irons_insect_chirp_b", var_5 );
                        wait 0.7;
                    }

                    break;
                case 2:
                    var_6 = level.player.origin + ( randomintrange( -1000, 1000 ), randomintrange( -1000, 1000 ), 0 );
                    var_3 = randomint( 7 );

                    for ( var_4 = 0; var_4 < var_3; var_4++ )
                    {
                        soundscripts\_snd_playsound::snd_play_at( "irons_insect_chirp_c", var_6 );
                        wait 0.75;
                    }

                    break;
                case 3:
                    var_7 = level.player.origin + ( randomintrange( -1000, 1000 ), randomintrange( -1000, 1000 ), 0 );
                    var_3 = randomint( 4 );

                    for ( var_4 = 0; var_4 < var_3; var_4++ )
                    {
                        soundscripts\_snd_playsound::snd_play_at( "irons_insect_chirp_d", var_7 );
                        wait 0.5;
                    }

                    break;
                case 4:
                    var_8 = level.player.origin + ( randomintrange( -1000, 1000 ), randomintrange( -1000, 1000 ), 0 );
                    soundscripts\_snd_playsound::snd_play_at( "irons_insect_chirp_random", var_8 );
                    break;
            }
        }
...
forklift_audio_loop()
{
    for (;;)
    {
        self waittillmatch( "looping anim", "forklift_sound_001" );
        wait 1;
        soundscripts\_snd_playsound::snd_play_linked( "irons_hangar_forklift_path2" );
        self waittillmatch( "looping anim", "forklift_sound_300" );
        wait 0.3;
        ...
        self waittillmatch( "looping anim", "forklift_sound_700" );
        wait 0.5;
        soundscripts\_snd_playsound::snd_play_linked( "irons_hangar_forklift_slow_to_stop" );
    }
}
