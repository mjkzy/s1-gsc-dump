...
setup_start_points()
{
    ...
    {
        var_0 = [];
        var_0[0] = "sanfran_intro_tr";
        maps\_utility::set_start_transients( "intro", var_0 );
        maps\_utility::set_start_transients( "tunnel", var_0 );
        maps\_utility::set_start_transients( "oncoming", var_0 );
        maps\_utility::set_start_transients( "bridge", var_0 );
        var_0[0] = "sanfran_outro_tr";
        maps\_utility::set_start_transients( "street", var_0 );
        maps\_utility::set_start_transients( "police", var_0 );
        maps\_utility::set_start_transients( "pitbull", var_0 );
        var_0[1] = "sanfran_bigm_tr";
        maps\_utility::set_start_transients( "van", var_0 );
        maps\_utility::set_start_transients( "boost", var_0 );
        maps\_utility::set_start_transients( "movie capture", var_0 );
        var_0 = [ "sanfran_outro_tr" ];
...
intro_title_text()
{
    ...
    thread intro_title_text_end( var_0 );
}
...
start_bridge_capture()
{
    ...
    foreach ( var_1 in level.collapse_scene_ents )
        var_1 show();
    ...
    for (;;)
    {
        var_3.origin = ( 3244, 78603, 4885 );
        var_3.angles = ( 17.6333, -139.389, 0 );
        wait 30;
        var_3.origin = ( -7204, 70913, 2547 );
        var_3.angles = ( 18.7136, 137.806, 0 );
        wait 30;
        var_3.origin = ( -6068, 70229, 423 );
        var_3.angles = ( 9.6663, 131.838, 0 );
        wait 30;
        var_3.origin = ( 5885, 63227, 2920 );
        var_3.angles = ( 25.2254, 143.381, 0 );
        wait 30;
    }
}
...
objectives()
{
    ...
    if ( !common_scripts\utility::flag( "flag_obj_player_used_van" ) )
    {
        ...
        var_0 = getent( "trigger_player_used_van", "targetname" );
        var_1 = var_0.origin;
        objective_position( maps\_utility::obj( "obj_use_van" ), var_1 );
...
increase_actor_base_accuracy_by_player_distance()
{
    ...
    for (;;)
    {
        ...
        self.baseaccuracy = var_0 + level.axis_global_accuracy_mod;
        wait 0.5;
    }
}
...
handle_sanfran_portal_groups_on( var_0, var_1, var_2 )
{
...
itiot_logic( var_0, var_1 )
{
    ...
    level.player setangles( ( 0, 172, 0 ) );
    thread maps\sanfran_code::setup_bridge_explosion_anim_sequence();
    common_scripts\utility::run_thread_on_targetname( "trigger_player_at_van", maps\sanfran_code::handle_bridge_collapse );
    level.player.auxillary_hud.alpha = 1;
