...
setup_vo()
{
    ...
    var_3 = "disarm_guy_1";
    var_4 = "PAS";
    level.scr_sound[var_0]["lab_gdn_theyreonus"] = "lab_gdn_theyreonus";
    level.scr_sound[var_0]["lab_gdn_dontletthatsniperdial"] = "lab_gdn_dontletthatsniperdial";
    level.scr_sound[var_0]["lab_gdn_thatempcockedupour"] = "lab_gdn_thatempcockedupour";
    level.scr_sound[var_0]["lab_gdn_exosstillrebooting"] = "lab_gdn_exosstillrebooting";
    level.scr_sound[var_0]["lab_gdn_gogogo"] = "lab_gdn_gogogo";
    level.scr_sound[var_0]["lab_gdn_keepmoving"] = "lab_gdn_keepmoving";
    level.scr_sound[var_0]["lab_gdn_run"] = "lab_gdn_run";
    level.scr_sound[var_0]["lab_gdn_heloscirclingaroundcomeon"] = "lab_gdn_heloscirclingaroundcomeon";
    level.scr_sound[var_0]["lab_gdn_uphere"] = "lab_gdn_uphere";
    level.scr_sound[var_0]["lab_gdn_moveit"] = "lab_gdn_moveit";
    level.scr_sound[var_0]["lab_gdn_overhere"] = "lab_gdn_overhere";
    level.scr_sound[var_0]["lab_gdn_holdon"] = "lab_gdn_holdon";
    level.scr_sound[var_0]["lab_gdn_cmon"] = "lab_gdn_cmon";
    level.scr_sound[var_0]["lab_gdn_exosupcloak"] = "lab_gdn_exosupcloak";
    level.scr_sound[var_0]["lab_gdn_choppersmovinoff"] = "lab_gdn_choppersmovinoff";
    level.scr_sound[var_0]["lab_gdn_syncyourvisortomy"] = "lab_gdn_syncyourvisortomy";
    level.scr_sound[var_0]["lab_gdn_moveslownearhostiles"] = "lab_gdn_moveslownearhostiles";
    level.scr_sound[var_0]["lab_gdn_dronedontmove"] = "lab_gdn_dronedontmove";
    level.scr_sound[var_0]["lab_gdn_dontmove"] = "lab_gdn_dontmove";
    level.scr_sound[var_0]["lab_gdn_stopmovingoritwill"] = "lab_gdn_stopmovingoritwill";
    level.scr_sound[var_0]["lab_gdn_easy"] = "lab_gdn_easy";
    level.scr_sound[var_0]["lab_gdn_damnitheardyou"] = "lab_gdn_damnitheardyou";
    level.scr_sound[var_0]["lab_gdn_letsgo"] = "lab_gdn_letsgo";
    level.scr_sound[var_0]["lab_gdn_watchyourenergycells"] = "lab_gdn_watchyourenergycells";
    level.scr_sound[var_0]["lab_gdn_turnoffcloaktorecharge"] = "lab_gdn_turnoffcloaktorecharge";
    level.scr_sound[var_0]["lab_gdn_mitchellonme"] = "lab_gdn_mitchellonme";
    level.scr_sound[var_0]["lab_gdn_damnitmitchell"] = "lab_gdn_damnitmitchell";
    level.scr_sound[var_0]["lab_gdn_werecompromised"] = "lab_gdn_werecompromised";
    level.scr_sound[var_0]["lab_gdn_theyveseenus"] = "lab_gdn_theyveseenus";
    level.scr_sound[var_0]["lab_gdn_theyvegotusengage"] = "lab_gdn_theyvegotusengage";
    level.scr_sound[var_0]["lab_gdn_choppermustbegoingfor"] = "lab_gdn_choppermustbegoingfor";
    level.scr_sound[var_0]["lab_gdn_moreincoming"] = "lab_gdn_moreincoming";
    level.scr_sound[var_0]["lab_gdn_keepitquietnexttime"] = "lab_gdn_keepitquietnexttime";
    level.scr_sound[var_0]["lab_gdn_takeemout"] = "lab_gdn_takeemout";
    level.scr_sound[var_0]["lab_gdn_slowlynow"] = "lab_gdn_slowlynow";
    level.scr_sound[var_0]["lab_gdn_kingpinthisissentineltwoone"] = "lab_gdn_kingpinthisissentineltwoone";
    level.scr_radio["lab_kpn_thisiskingpin"] = "lab_kpn_thisiskingpin";
    level.scr_sound[var_0]["lab_brk_eemode"] = "lab_brk_eemode";
    level.scr_sound[var_0]["lab_brk_needexfil"] = "lab_brk_needexfil";
    level.scr_radio["lab_kgn_negativesentineltwoone"] = "lab_kgn_negativesentineltwoone";
    level.scr_sound[var_0]["lab_gdn_copyfuckinhell"] = "lab_gdn_copyfuckinhell";
    level.scr_sound[var_0]["lab_gdn_patrolapproaching"] = "lab_gdn_patrolapproaching";
    level.scr_radio["lab_scr_victorzerosevenwhatsyourlocation"] = "lab_scr_victorzerosevenwhatsyourlocation";
    level.scr_sound[var_3]["lab_gr1_thisisvictorsevenwereat"] = "lab_gr1_thisisvictorsevenwereat";
    level.scr_radio["lab_scr_wepickedupthreedead"] = "lab_scr_wepickedupthreedead";
    level.scr_sound[var_3]["lab_gr1_nosignofthemhere"] = "lab_gr1_nosignofthemhere";
    level.scr_radio["lab_scr_holdyourpositionsandwait"] = "lab_scr_holdyourpositionsandwait";
    level.scr_sound[var_3]["lab_gr1_copythat"] = "lab_gr1_copythat";
    level.scr_sound[var_0]["lab_gdn_theseareunsuppressed"] = "lab_gdn_theseareunsuppressed";
    level.scr_sound[var_0]["lab_gdn_toomuchactivity"] = "lab_gdn_toomuchactivity";
    level.scr_sound[var_0]["lab_gdn_waituntiltheypass"] = "lab_gdn_waituntiltheypass";
    level.scr_sound[var_0]["lab_gdn_makemistakeslikethaton"] = "lab_gdn_makemistakeslikethaton";
    level.scr_sound[var_0]["lab_gdn_itsyourfuneralmate"] = "lab_gdn_itsyourfuneralmate";
    level.scr_sound[var_0]["lab_gdn_cormackandknoxshouldbe"] = "lab_gdn_cormackandknoxshouldbe";
    level.scr_sound[var_0]["lab_gdn_twointhevehicle"] = "lab_gdn_twointhevehicle";
    level.scr_sound[var_0]["lab_gdn_takeoutthepassenger"] = "lab_gdn_takeoutthepassenger";
    level.scr_sound[var_0]["lab_gdn_takehimdown"] = "lab_gdn_takehimdown";
    level.scr_sound[var_0]["lab_gdn_mitchellgetthatbastard"] = "lab_gdn_mitchellgetthatbastard";
    level.scr_sound[var_0]["lab_gdn_topjob"] = "lab_gdn_topjob";
    level.scr_sound[var_0]["lab_gdn_convoyaheadholdup"] = "lab_gdn_convoyaheadholdup";
    level.scr_sound[var_0]["lab_gdn_thisway"] = "lab_gdn_thisway";
    level.scr_sound[var_0]["lab_gdn_fiveastsapproaching"] = "lab_gdn_fiveastsapproaching";
    level.scr_sound[var_0]["lab_gdn_forgetaboutshootingourway"] = "lab_gdn_forgetaboutshootingourway";
    level.scr_sound[var_0]["lab_gdn_grabsomecover"] = "lab_gdn_grabsomecover";
    level.scr_sound[var_0]["lab_gdn_keepmovingalmostthere"] = "lab_gdn_keepmovingalmostthere";
    level.scr_sound[var_0]["lab_gdn_waitforthepatrolto"] = "lab_gdn_waitforthepatrolto";
    level.scr_sound[var_0]["lab_gdn_waitforthebeam"] = "lab_gdn_waitforthebeam";
    level.scr_sound[var_0]["lab_gdn_waitwait"] = "lab_gdn_waitwait";
    level.scr_sound[var_0]["lab_gdn_okaygo"] = "lab_gdn_okaygo";
    level.scr_sound[var_0]["lab_gdn_watchthatbeam"] = "lab_gdn_watchthatbeam";
    level.scr_sound[var_0]["lab_gdn_okaynow"] = "lab_gdn_okaynow";
    level.scr_sound[var_0]["lab_gdn_seeker"] = "lab_gdn_seeker";
    level.scr_sound[var_0]["lab_gdn_cloaksuselessagainstit"] = "lab_gdn_cloaksuselessagainstit";
    level.scr_sound[var_0]["lab_gdn_werepastkeepmoving"] = "lab_gdn_werepastkeepmoving";
    level.scr_sound[var_0]["lab_gdn_thisisit"] = "lab_gdn_thisisit";
    level.scr_sound[var_1]["lab_crk_copy"] = "lab_crk_copy";
    level.scr_sound[var_0]["lab_gdn_weneedanexfilsharpish"] = "lab_gdn_weneedanexfilsharpish";
    level.scr_sound[var_1]["lab_crk_missionisntoverkitup"] = "lab_crk_missionisntoverkitup";
    level.scr_sound[var_0]["lab_gdn_themissionwasoverbefore"] = "lab_gdn_themissionwasoverbefore";
    level.scr_sound[var_1]["lab_crk_werenotleavinguntilwe"] = "lab_crk_werenotleavinguntilwe";
    level.scr_sound[var_0]["lab_gdn_idontseeafucking"] = "lab_gdn_idontseeafucking";
    level.scr_sound[var_1]["lab_crmk_switchtermal"] = "lab_crmk_switchtermal";
    level.scr_sound[var_2]["lab_knx_sendingyoumyfeed"] = "lab_knx_sendingyoumyfeed";
    level.scr_sound[var_1]["lab_crk_theyvegotsomethingtohide"] = "lab_crk_theyvegotsomethingtohide";
    level.scr_sound[var_0]["lab_gdn_wevelosttheinitiativewe"] = "lab_gdn_wevelosttheinitiativewe";
    level.scr_sound[var_1]["lab_crk_thereisnootherday"] = "lab_crk_thereisnootherday";
    level.scr_sound[var_0]["lab_gdn_thisthinggoessidewaysits"] = "lab_gdn_thisthinggoessidewaysits";
    level.scr_sound[var_2]["lab_knx_holographiccanopy"] = "lab_knx_holographiccanopy";
    level.scr_sound[var_0]["lab_gdn_mitchelgetclippedon"] = "lab_gdn_mitchelgetclippedon";
    level.scr_sound[var_0]["lab_gdn_hookupmitchel"] = "lab_gdn_hookupmitchel";
    level.scr_sound[var_1]["lab_crk_targetbuildingupahead"] = "lab_crk_targetbuildingupahead";
    level.scr_sound[var_1]["lab_crk_camera"] = "lab_crk_camera";
    level.scr_sound[var_1]["lab_crk_twoguardsbythecamera"] = "lab_crk_twoguardsbythecamera";
    level.scr_sound[var_1]["lab_crk_mitchellpickatarget"] = "lab_crk_mitchellpickatarget";
    level.scr_sound[var_1]["lab_crk_wakeupmitchell"] = "lab_crk_wakeupmitchell";
    level.scr_sound[var_0]["lab_gdn_moveup"] = "lab_gdn_moveup";
    level.scr_sound[var_2]["lab_knx_eyesontheentrypoint"] = "lab_knx_eyesontheentrypoint";
    level.scr_sound[var_1]["lab_crk_thisisourbreachpoint"] = "lab_crk_thisisourbreachpoint";
    level.scr_sound[var_1]["lab_crk_mitchellsetthecharge"] = "lab_crk_mitchellsetthecharge";
    level.scr_sound[var_1]["lab_crk_mitchellmoveit"] = "lab_crk_mitchellmoveit";
    level.scr_sound[var_1]["lab_crk_movemovemove"] = "lab_crk_movemovemove";
    level.scr_sound[var_0]["lab_gdn_twointhehallway"] = "lab_gdn_twointhehallway";
    level.scr_sound[var_1]["lab_crk_takeemout"] = "lab_crk_takeemout";
    level.scr_sound[var_1]["lab_crk_kingpinweveinfiltratedthetarget"] = "lab_crk_kingpinweveinfiltratedthetarget";
    level.scr_radio["lab_kgn_rogerthat"] = "lab_kgn_rogerthat";
    level.scr_sound[var_1]["lab_crk_roger"] = "lab_crk_roger";
    level.scr_sound[var_2]["lab_knx_clear"] = "lab_knx_clear";
    level.scr_sound[var_0]["lab_gdn_clear"] = "lab_gdn_clear";
    level.scr_sound[var_1]["lab_crk_hitthestairs"] = "lab_crk_hitthestairs";
    level.scr_sound[var_2]["lab_knx_gotchacovered"] = "lab_knx_gotchacovered";
    level.scr_sound[var_1]["lab_crk_thisisit"] = "lab_crk_thisisit";
    level.scr_sound[var_0]["lab_gdn_nevermind"] = "lab_gdn_nevermind";
    level.scr_sound[var_0]["lab_gdn_clear2"] = "lab_gdn_clear2";
    level.scr_sound[var_0]["lab_gdn_youreupmitchel"] = "lab_gdn_youreupmitchel";
    level.scr_sound[var_0]["lab_gdn_getonthatconsole"] = "lab_gdn_getonthatconsole";
    level.scr_sound[var_0]["lab_gdn_mitchellgetonthatconsole"] = "lab_gdn_mitchellgetonthatconsole";
    level.scr_sound[var_0]["lab_gdn_getmovingmitchell"] = "lab_gdn_getmovingmitchell";
    level.scr_sound[var_1]["lab_crk_walksrightpastplayergiving"] = "lab_crk_walksrightpastplayergiving";
    level.scr_sound[var_2]["lab_crmk_sse"] = "lab_crmk_sse";
    level.scr_radio["lab_kgn_standingbytoreceivepackage"] = "lab_kgn_standingbytoreceivepackage";
    level.scr_sound[var_2]["lab_knx_bingowevegotthepackage"] = "lab_knx_bingowevegotthepackage";
    level.scr_radio["lab_kgn_uplinkconfirmed"] = "lab_kgn_uplinkconfirmed";
    level.scr_sound[var_1]["lab_crk_okayburnitdown"] = "lab_crk_okayburnitdown";
    level.scr_sound[var_2]["lab_brk_thermite"] = "lab_brk_thermite";
    level.scr_sound[var_1]["lab_crk_approachestheplayertheresmore"] = "lab_crk_approachestheplayertheresmore";
    level.scr_radio["lab_kgn_packagerecievedgoodjob"] = "lab_kgn_packagerecievedgoodjob";
    level.scr_sound[var_1]["lab_crk_copythat"] = "lab_crk_copythat";
    level.scr_radio["lab_kgn_twothreebeadvised"] = "lab_kgn_twothreebeadvised";
    level.scr_sound[var_2]["lab_knx_theyjustactivedasensor"] = "lab_knx_theyjustactivedasensor";
    level.scr_sound[var_1]["lab_crk_okaystealthsnolongeran"] = "lab_crk_okaystealthsnolongeran";
    level.scr_sound[var_1]["lab_crk_go2"] = "lab_crk_go2";
    level.scr_sound[var_0]["lab_gdn_takeoutthatsensor"] = "lab_gdn_takeoutthatsensor";
    level.scr_sound[var_0]["lab_gdn_sensorinthecorner"] = "lab_gdn_sensorinthecorner";
    level.scr_sound[var_1]["lab_crk_eyesonasensor"] = "lab_crk_eyesonasensor";
    level.scr_sound[var_0]["lab_gdn_sensorsdown"] = "lab_gdn_sensorsdown";
    level.scr_sound[var_0]["lab_gdn_sensorsout"] = "lab_gdn_sensorsout";
    level.scr_sound[var_1]["lab_crk_sensorsdown"] = "lab_crk_sensorsdown";
    level.scr_sound[var_1]["lab_crk_sensorsdead"] = "lab_crk_sensorsdead";
    level.scr_sound[var_0]["lab_gdn_contactbelowus"] = "lab_gdn_contactbelowus";
    level.scr_sound[var_1]["lab_crk_flankleftorright"] = "lab_crk_flankleftorright";
    level.scr_sound[var_1]["lab_crk_mitchelltakepoint"] = "lab_crk_mitchelltakepoint";
    level.scr_sound[var_1]["lab_crk_moveup"] = "lab_crk_moveup";
    level.scr_sound[var_0]["lab_gdn_clear2"] = "lab_gdn_clear2";
    level.scr_sound[var_1]["lab_crk_werehere"] = "lab_crk_werehere";
    level.scr_sound[var_2]["lab_knx_biosparqispickinguptrace"] = "lab_knx_biosparqispickinguptrace";
    level.scr_sound[var_1]["lab_crk_mitchellplantthefrbs"] = "lab_crk_mitchellplantthefrbs";
    level.scr_sound[var_1]["lab_crk_wakeupmitchell2"] = "lab_crk_wakeupmitchell2";
    level.scr_sound[var_1]["lab_crk_mitchellgetthefrbready"] = "lab_crk_mitchellgetthefrbready";
    level.scr_sound[var_1]["lab_crk_plantitmitchell"] = "lab_crk_plantitmitchell";
    level.scr_sound[var_1]["lab_crk_everyoneout"] = "lab_crk_everyoneout";
    level.scr_sound[var_1]["lab_crk_mitchellhitit"] = "lab_crk_mitchellhitit";
    level.scr_sound[var_1]["lab_crk_hitit"] = "lab_crk_hitit";
    level.scr_sound[var_1]["lab_crk_kingpinmaterialissecure"] = "lab_crk_kingpinmaterialissecure";
    level.scr_radio["lab_kgn_primarylzistoohot"] = "lab_kgn_primarylzistoohot";
    level.scr_sound[var_1]["lab_crk_understoodweremoving"] = "lab_crk_understoodweremoving";
    level.scr_sound[var_0]["lab_gdn_keepsgettingbetter"] = "lab_gdn_keepsgettingbetter";
    level.scr_sound[var_0]["lab_gdn_chargeyourcloak"] = "lab_gdn_chargeyourcloak";
    level.scr_sound[var_0]["lab_gdn_holdupcharging"] = "lab_gdn_holdupcharging";
    level.scr_sound[var_0]["lab_gdn_chargeup"] = "lab_gdn_chargeup";
    level.scr_sound[var_0]["lab_gdn_moving"] = "lab_gdn_moving";
    level.scr_sound[var_1]["lab_crk_contact"] = "lab_crk_contact";
    level.scr_sound[var_1]["lab_crk_knoxgetthisdooropen"] = "lab_crk_knoxgetthisdooropen";
    level.scr_sound[var_2]["lab_knx_runningabypasscoverme"] = "lab_knx_runningabypasscoverme";
    level.scr_sound[var_2]["lab_knx_imgettinginterferencefromthat"] = "lab_knx_imgettinginterferencefromthat";
    level.scr_sound[var_1]["lab_crk_thatsyoumitchell"] = "lab_crk_thatsyoumitchell";
    level.scr_sound[var_0]["lab_gdn_ast"] = "lab_gdn_ast";
    level.scr_sound[var_1]["lab_crk_shitdrawitsfire"] = "lab_crk_shitdrawitsfire";
    level.scr_sound[var_1]["lab_crk_scramblersontopofthat"] = "lab_crk_scramblersontopofthat";
    level.scr_sound[var_0]["lab_gdn_jammersontopofthat"] = "lab_gdn_jammersontopofthat";
    level.scr_sound[var_0]["lab_gdn_lookforaladder"] = "lab_gdn_lookforaladder";
    level.scr_sound[var_1]["lab_crk_plantthatjammer"] = "lab_crk_plantthatjammer";
    level.scr_sound[var_1]["lab_crk_mitchellgetthatjammerhooked"] = "lab_crk_mitchellgetthatjammerhooked";
    level.scr_sound[var_1]["lab_crk_mitchellplantthejammer"] = "lab_crk_mitchellplantthejammer";
    level.scr_sound[var_2]["lab_knx_signalsclear"] = "lab_knx_signalsclear";
    level.scr_sound[var_1]["lab_crk_moretangosmovingin"] = "lab_crk_moretangosmovingin";
    level.scr_sound[var_2]["lab_knx_doorsopenletsmove"] = "lab_knx_doorsopenletsmove";
    level.scr_sound[var_1]["lab_crk_mitchellregroupdownhere"] = "lab_crk_mitchellregroupdownhere";
    level.scr_sound[var_1]["lab_crk_mitchellrallyup"] = "lab_crk_mitchellrallyup";
    level.scr_radio["lab_pas_wehavehostilesinthe"] = "lab_pas_wehavehostilesinthe";
    level.scr_sound[var_1]["lab_crk_vehiclehangarsthroughhere"] = "lab_crk_vehiclehangarsthroughhere";
    ...
    level.scr_sound[var_1]["lab_crmk_anotherdoor"] = "lab_crmk_anotherdoor";
    level.scr_sound[var_2]["lab_knx_onit"] = "lab_knx_onit";
    level.scr_sound[var_0]["lab_brk_improvise"] = "lab_brk_improvise";
    level.scr_sound[var_2]["lab_knx_itsopen"] = "lab_knx_itsopen";
    level.scr_sound[var_0]["lab_brk_backup"] = "lab_brk_backup";
    level.scr_sound[var_0]["lab_brk_getout"] = "lab_brk_getout";
    level.scr_sound[var_1]["lab_crk_sweeptheroom"] = "lab_crk_sweeptheroom";
    level.scr_sound[var_0]["lab_gdn_clear3"] = "lab_gdn_clear3";
    level.scr_sound[var_1]["lab_crk_thisisourride"] = "lab_crk_thisisourride";
    level.scr_sound[var_2]["lab_knx_copythat"] = "lab_knx_copythat";
    level.scr_sound[var_0]["lab_gdn_t740stillonlyaprototype"] = "lab_gdn_t740stillonlyaprototype";
    level.scr_sound[var_2]["lab_knx_poweringitup"] = "lab_knx_poweringitup";
    level.scr_sound[var_1]["lab_crk_handsupwhoknowshow"] = "lab_crk_handsupwhoknowshow";
    level.scr_sound[var_0]["lab_gdn_mitchellanditrainedup"] = "lab_gdn_mitchellanditrainedup";
    level.scr_sound[var_2]["lab_knx_disengaging"] = "lab_knx_disengaging";
    level.scr_sound[var_2]["lab_knx_werechargedandfullyarmed"] = "lab_knx_werechargedandfullyarmed";
    level.scr_sound[var_1]["lab_crk_kingpinthisissentineltwothree"] = "lab_crk_kingpinthisissentineltwothree";
    level.scr_radio["lab_kgn_rogerthatsentineltwothree"] = "lab_kgn_rogerthatsentineltwothree";
    level.scr_sound[var_1]["lab_crk_alrighteveryonein"] = "lab_crk_alrighteveryonein";
    level.scr_sound[var_0]["lab_gdn_allsystemscheckgreen"] = "lab_gdn_allsystemscheckgreen";
    level.scr_sound[var_0]["lab_gdn_alrightmitchelljustlikein"] = "lab_gdn_alrightmitchelljustlikein";
    level.scr_sound[var_0]["lab_gdn_moveitoutmitchell"] = "lab_gdn_moveitoutmitchell";
    level.scr_sound[var_2]["lab_knx_fullyarmed"] = "lab_knx_fullyarmed";
    level.scr_sound[var_0]["lab_gdn_theyreontous"] = "lab_gdn_theyreontous";
    level.scr_sound[var_0]["lab_gdn_infantryaheadofus"] = "lab_gdn_infantryaheadofus";
    level.scr_sound[var_0]["lab_gdn_warbirdincoming"] = "lab_gdn_warbirdincoming";
    level.scr_sound[var_0]["lab_gdn_armorapproaching"] = "lab_gdn_armorapproaching";
    level.scr_sound[var_0]["lab_gdn_tankapproaching"] = "lab_gdn_tankapproaching";
    level.scr_sound[var_0]["lab_gdn_warbirdonourleft"] = "lab_gdn_warbirdonourleft";
    level.scr_sound[var_0]["lab_gdn_ourtrophysystemisempty"] = "lab_gdn_ourtrophysystemisempty";
    level.scr_sound[var_0]["lab_brk_reloadtrophy"] = "lab_brk_reloadtrophy";
    level.scr_sound[var_0]["lab_gdn_wecanttakeanotherhit"] = "lab_gdn_wecanttakeanotherhit";
    level.scr_sound[var_0]["lab_gdn_weregettingbeatenup"] = "lab_gdn_weregettingbeatenup";
    level.scr_sound[var_0]["lab_gdn_tankonourleft"] = "lab_gdn_tankonourleft";
    level.scr_sound[var_0]["lab_gdn_tankonourright"] = "lab_gdn_tankonourright";
    level.scr_sound[var_0]["lab_gdn_keepmovingmitchell2"] = "lab_gdn_keepmovingmitchell2";
    level.scr_sound[var_0]["lab_gdn_lzisupahead"] = "lab_gdn_lzisupahead";
    level.scr_sound[var_0]["lab_gdn_switchtomissiles"] = "lab_gdn_switchtomissiles";
    level.scr_sound[var_0]["lab_gdn_useyourcannononthose"] = "lab_gdn_useyourcannononthose";
    level.scr_sound[var_0]["lab_gdn_empthatwarbird"] = "lab_gdn_empthatwarbird";
    level.scr_sound[var_1]["lab_crmk_awaytargetzone"] = "lab_crmk_awaytargetzone";
    level.scr_radio["lab_kpn_cantposid"] = "lab_kpn_cantposid";
    level.scr_sound[var_1]["lab_crmk_biggesttincan"] = "lab_crmk_biggesttincan";
    level.scr_radio["lab_kpn_rogerseeyou"] = "lab_kpn_rogerseeyou";
    level.scr_sound[var_0]["lab_brk_firewhenready"] = "lab_brk_firewhenready";
    level.scr_sound[var_2]["lab_knx_fuelcellslow"] = "lab_knx_fuelcellslow";
    level.scr_sound[var_1]["lab_crk_straightahead"] = "lab_crk_straightahead";
    level.scr_sound[var_1]["lab_crk_headright"] = "lab_crk_headright";
    level.scr_sound[var_1]["lab_crk_turnleft"] = "lab_crk_turnleft";
    level.scr_sound[var_1]["lab_crk_acrosstheriver"] = "lab_crk_acrosstheriver";
    level.scr_sound[var_1]["lab_crk_upthehill"] = "lab_crk_upthehill";
    level.scr_sound[var_1]["lab_crk_throughthegate2"] = "lab_crk_throughthegate2";
    level.scr_sound[var_1]["lab_crk_takingfirefromtheright"] = "lab_crk_takingfirefromtheright";
    level.scr_sound[var_1]["lab_crk_takingfirefromtheleft"] = "lab_crk_takingfirefromtheleft";
    level.scr_sound[var_0]["lab_gdn_firefromtheright"] = "lab_gdn_firefromtheright";
    level.scr_sound[var_0]["lab_gdn_firefromtheleft"] = "lab_gdn_firefromtheleft";
    level.scr_sound[var_1]["lab_crmk_armorcrit"] = "lab_crmk_armorcrit";
    level.scr_sound[var_0]["lab_gdn_reloading"] = "lab_gdn_reloading";
    level.scr_sound[var_0]["lab_gdn_empthechoppers"] = "lab_gdn_empthechoppers";
    level.scr_sound[var_0]["lab_gdn_usemissilesagainstinfantry"] = "lab_gdn_usemissilesagainstinfantry";
    level.scr_sound[var_0]["lab_gdn_empsuselessagainstthosetanks"] = "lab_gdn_empsuselessagainstthosetanks";
    level.scr_sound[var_0]["lab_gdn_niceshot"] = "lab_gdn_niceshot";
    level.scr_sound[var_0]["lab_gdn_gothim"] = "lab_gdn_gothim";
    level.scr_sound[var_0]["lab_gdn_tanksdown"] = "lab_gdn_tanksdown";
    level.scr_sound[var_0]["lab_gdn_warbirdsdown"] = "lab_gdn_warbirdsdown";
    level.scr_sound[var_0]["lab_gdn_hithimagain"] = "lab_gdn_hithimagain";
    level.scr_sound[var_0]["lab_gdn_fireagain"] = "lab_gdn_fireagain";
    level.scr_sound[var_1]["lab_crk_moreinfantrycomingin"] = "lab_crk_moreinfantrycomingin";
    level.scr_sound[var_1]["lab_crk_vrapsinbound"] = "lab_crk_vrapsinbound";
    level.scr_sound[var_1]["lab_crk_vrapahead"] = "lab_crk_vrapahead";
    level.scr_sound[var_1]["lab_crk_armoronourleft"] = "lab_crk_armoronourleft";
    level.scr_sound[var_1]["lab_crk_tankscomingdowntheroad"] = "lab_crk_tankscomingdowntheroad";
    level.scr_sound[var_1]["lab_crk_firefromabove"] = "lab_crk_firefromabove";
    level.scr_sound[var_1]["lab_crk_threatbehindus"] = "lab_crk_threatbehindus";
    level.scr_sound[var_0]["lab_brk_enginesdown"] = "lab_brk_enginesdown";
    level.scr_sound[var_1]["lab_crmk_holdoff"] = "lab_crmk_holdoff";
    level.scr_sound[var_0]["lab_gdn_switchtoslugs"] = "lab_gdn_switchtoslugs";
    level.scr_radio["lab_kgn_sentineltwothreeihaveahelo"] = "lab_kgn_sentineltwothreeihaveahelo";
    level.scr_sound[var_1]["lab_crk_copythatcoordinatesconfirmed"] = "lab_crk_copythatcoordinatesconfirmed";
    level.scr_sound[var_2]["lab_knx_271degrees"] = "lab_knx_271degrees";
    level.scr_sound[var_0]["lab_brk_howsammo"] = "lab_brk_howsammo";
    level.scr_sound[var_2]["lab_knx_dontwannaknow"] = "lab_knx_dontwannaknow";
    level.scr_sound[var_0]["lab_brk_fireeverything"] = "lab_brk_fireeverything";
    level.scr_sound[var_1]["lab_crmk_nearlythere"] = "lab_crmk_nearlythere";
    level.scr_sound[var_0]["lab_brk_cmonmoveit"] = "lab_brk_cmonmoveit";
    level.scr_sound[var_2]["lab_knx_outofjuice"] = "lab_knx_outofjuice";
    level.scr_sound[var_1]["lab_crk_thelzshouldbejust"] = "lab_crk_thelzshouldbejust";
    level.scr_sound[var_0]["lab_brk_goodideas"] = "lab_brk_goodideas";
    level.scr_sound[var_0]["lab_gdn_getreadytobailout"] = "lab_gdn_getreadytobailout";
    level.scr_sound[var_1]["lab_crk_thisisit2"] = "lab_crk_thisisit2";
    level.scr_sound[var_0]["lab_gdn_holdon"] = "lab_gdn_holdon";
    level.scr_sound[var_0]["lab_gdn_everybodyoutmovemovemove"] = "lab_gdn_everybodyoutmovemovemove";
    level.scr_radio["lab_ch5_falcon22cominginfor"] = "lab_ch5_falcon22cominginfor";
    level.scr_sound[var_1]["lab_crk_thatsourbird"] = "lab_crk_thatsourbird";
    level.scr_radio["lab_ch5_standingbytoloadpassengers"] = "lab_ch5_standingbytoloadpassengers";
    level.scr_sound[var_1]["lab_crk_loaduploadup"] = "lab_crk_loaduploadup";
    level.scr_sound[var_0]["lab_gdn_comeon2"] = "lab_gdn_comeon2";
    level.scr_radio["lab_plt_holdon"] = "lab_plt_holdon";
    level.scr_sound[var_1]["lab_crk_shit2"] = "lab_crk_shit2";
    level.scr_sound[var_0]["lab_gdn_onestepaheadofyou"] = "lab_gdn_onestepaheadofyou";
    level.scr_sound[var_1]["lab_crmk_gjsoldier"] = "lab_crmk_gjsoldier";
    level.scr_sound[var_1]["lab_crk_niceworksoldier"] = "lab_crk_niceworksoldier";
...
burke_drone_warning_dialogue()
{
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            var_1 = common_scripts\utility::random( [ "lab_gdn_dontmove", "lab_gdn_stopmovingoritwill", "lab_gdn_easy" ] );
        ...
        var_0 = var_1;
        wait 1;
        level.burke maps\_utility::dialogue_queue( var_1 );
        wait 5;
    }
}
...
stealth_broken_dialogue()
{
    ...
    var_0[0] = "lab_gdn_damnitmitchell";
    var_0[1] = "lab_gdn_werecompromised";
    var_0[2] = "lab_gdn_theyveseenus";
    var_0[3] = "lab_gdn_theyvegotusengage";
    var_1 = randomintrange( 0, var_0.size );
    waitframe();
    level.burke maps\_utility::dialogue_queue( var_0[var_1] );
    wait 5;
...
{
    var_0 = [ "lab_gdn_mitchelgetclippedon", "lab_gdn_hookupmitchel" ];
    thread maps\_shg_utility::dialogue_reminder( level.burke, "flag_rappel_start", var_0 );
}
...
facility_breach_nag_dialogue()
{
    ...
    var_0 = [ "lab_crk_mitchellsetthecharge", "lab_crk_mitchellmoveit" ];
    thread maps\_shg_utility::dialogue_reminder( level.cormack, "breach_start", var_0 );
}
...
{
    var_0 = [ "lab_gdn_youreupmitchel", "lab_gdn_getmovingmitchell", "lab_gdn_mitchellgetonthatconsole" ];
    thread maps\_shg_utility::dialogue_reminder( level.burke, "flag_obj_bio_weapons_hack", var_0 );
}
...
security_camera_dialogue()
{
    ...
    var_0 = getent( "camera_interior_01", "script_noteworthy" );

    if ( isalive( var_0 ) && level.player maps\_utility::can_see_origin( var_0.origin ) )
...
camera_scanner_interior_trigger_think()
{
    ...
    var_0 = common_scripts\utility::get_linked_ents()[0];

    if ( !isdefined( var_0 ) )
        return;

    var_0 endon( "stop_scanner_vo_loop" );
    var_0 endon( "death" );
    var_0 thread maps\_utility::notify_delay( "stop_scanner_vo_loop", 10 );

    while ( var_0.destructible_parts[0].v["health"] > 0 )
    {
        if ( level.player maps\_utility::can_see_origin( var_0.origin ) )
        {
            ...
            var_0 notify( "stop_scanner_vo_loop" );
        }
...
{
    var_0[0] = "lab_crk_wakeupmitchell2";
    var_0[1] = "lab_crk_mitchellgetthefrbready";
    var_0[2] = "lab_crk_plantitmitchell";
    wait(randomintrange( 5, 10 ));

    while ( !common_scripts\utility::flag( "flag_obj_neutralize_bio_weapons_planted" ) )
    {
        var_1 = randomintrange( 0, var_0.size );
        level.cormack maps\_utility::dialogue_queue( var_0[var_1] );
        wait(randomintrange( 5, 10 ));
    }
}
...
courtyard_squad_defend_nag_dialogue()
{
    ...
    var_0 = getent( "courtyard_defend_volume", "targetname" );
    var_1 = 0;
    wait 1;
...
tank_road_enemy_tank_dialogue( var_0 )
{
    var_0 endon( "death" );
    var_1 = var_0.health;
    wait 5;
...
tank_field_choppers_dialogue( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        if ( isalive( var_2 ) && issubstr( var_2.classname, "warbird" ) )
...
pcap_vo_lab_intro_guy1( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_theyreonus", 2.0 );
    wait 2;
    common_scripts\utility::flag_set( "flag_intro_run_dialogue_start" );
}

pcap_vo_lab_wallclimb_player_hero_01( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_cmon", 0.0 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_exosupcloak", 3.12 );
}

pcap_vo_lab_cliff_rappel_meetup_burke( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_weneedanexfilsharpish", 2.09 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_themissionwasoverbefore", 9.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_idontseeafucking", 15.03 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_wevelosttheinitiativewe", 27.27 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_thisthinggoessidewaysits", 32.03 );
}

pcap_vo_lab_cliff_rappel_meetup_cormack( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_yougood", 1.12 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_missionisntoverkitup", 7.24 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_werenotleavinguntilwe", 11.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_knoxshowem", 17.18 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_theyvegotsomethingtohide", 26.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_thereisnootherday", 29.27 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_itsalwaysbeenonme", 34.24 );
}

pcap_vo_lab_cliff_rappel_meetup_knox( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_sendingyoumyfeed", 20.15 );
}

pcap_vo_lab_cliff_jump_burke( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_hesahardbastardill", 6.03 );
}

pcap_vo_lab_serverroom_burke( var_0 )
{

}

pcap_vo_lab_serverroom_cormack( var_0 )
{
    soundscripts\_snd::snd_message( "begin_pcap_vo_lab_serverroom_cormack" );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_walksrightpastplayergiving", 2.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_okayburnitdown", 21.03 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_approachestheplayertheresmore", 25.12 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_copythat", 36.13 );
}

pcap_vo_lab_serverroom_knox( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_runsuptoaterminal", 8.06 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_hurriesovertocormackpats", 12.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_bingowevegotthepackage", 17.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_thermiteout", 23.24 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_onme", 39.12 );
...
pcap_vo_lab_serverroom_promo_knox( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_runsuptoaterminal", 8.06 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_hurriesovertocormackpats", 12.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_bingowevegotthepackage", 17.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_thermiteout", 23.24 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_knx_promo_om", 39.12 );
    level maps\_utility::delaythread( 11.4, maps\_utility::dialogue_queue, "lab_kgn_standingbytoreceivepackage" );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_kgn_uplinkconfirmed", 19.27 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_kpn_promo_st", 33.03 );
}

pcap_vo_lab_serverroom_promo_cormack( var_0 )
{
    soundscripts\_snd::snd_message( "begin_pcap_vo_lab_serverroom_cormack" );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_walksrightpastplayergiving", 2.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_okayburnitdown", 21.03 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_prepromo", 25.12 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_promo1", 28.0 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_promo2", 33.24 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_promo3", 41.15 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_promo4", 47.24 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_promo5", 54.24 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_promo6", 63.21 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crmk_promo7", 69.06 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_copythat", 79.13 );
}

pcap_vo_lab_chopper_evac_enter_burke( var_0 )
{
    level.player soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_plt_confirmfourpaxonboard", 6.06 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_onestepaheadofyou", 12.03 );
    level.player soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_plt_extractcompleteheadinghome", 23.12 );
}

pcap_vo_lab_chopper_evac_enter_cormack( var_0 )
{
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_gdn_wereupfour", 3.27 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_shit2", 9.27 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_niceworksoldier", 17.21 );
    var_0 soundscripts\_snd_pcap::snd_pcap_play_vo_30fps( "lab_crk_toknoxoncethisstuff", 19.27 );
    maps\_utility::delaythread( 20, soundscripts\_snd::snd_music_message, "lab_finale" );
}

ai_toggle_cloak_start_vo( var_0 )
{
    ...
    if ( !isdefined( var_0 ) || var_0 == -1 )
        var_1 = common_scripts\utility::random( [ "lab_gdn_chargeyourcloak", "lab_gdn_holdupcharging", "lab_gdn_chargeup" ] );
    else if ( var_0 == 1 )
        var_1 = "lab_gdn_chargeyourcloak";
    else if ( var_0 == 2 )
        var_1 = "lab_gdn_holdupcharging";
    else if ( var_0 == 3 )
        var_1 = "lab_gdn_chargeup";

    maps\_utility::dialogue_queue( var_1 );
}

ai_toggle_cloak_complete_vo( var_0 )
{
    if ( isdefined( var_0 ) && var_0 == 0 )
        return;
    ...
    if ( !isdefined( var_0 ) || var_0 == -1 )
        var_1 = common_scripts\utility::random( [ "lab_gdn_moving", "lab_gdn_okaygo" ] );
    else if ( var_0 == 1 )
        var_1 = "lab_gdn_moving";
    else if ( var_0 == 2 )
        var_1 = "lab_gdn_okaygo";

    maps\_utility::dialogue_queue( var_1 );
}

important_dialogue_queue( var_0, var_1 )
{
    if ( !common_scripts\utility::flag( "flag_important_dialogue_playing" ) || isdefined( var_1 ) && var_1 )
        level maps\_utility::function_stack( ::important_dialogue, self, var_0, var_1 );
}

important_dialogue( var_0, var_1, var_2 )
{
