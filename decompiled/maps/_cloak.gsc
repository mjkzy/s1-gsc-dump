...
cloak_battery_hud()
{
    ...
    for (;;)
    {
        if ( level._cloaked_stealth_settings.cloak_on == 1 )
        {
            if ( 1 )
            {
                ...
                if ( var_6 < 10 )
                {
                    ...
                    {
                        level._cloaked_stealth_settings.cloak_battery_level = level._cloaked_stealth_settings.cloak_battery_level + var_4;
                ...
                else
                {
                    ...
                    level._cloaked_stealth_settings.cloak_battery_level = level._cloaked_stealth_settings.cloak_battery_level - var_8 * var_2;
            ...
            {
                level._cloaked_stealth_settings.cloak_battery_level = level._cloaked_stealth_settings.cloak_battery_level - var_2;
        ...
        else if ( 1 )
        {
            ...
            {
                var_5 = var_5 - var_0;
                level._cloaked_stealth_settings.penalty_timer = level._cloaked_stealth_settings.penalty_timer - var_0;
            }
            else
            {
                level._cloaked_stealth_settings.cloak_battery_level = level._cloaked_stealth_settings.cloak_battery_level + var_3;
