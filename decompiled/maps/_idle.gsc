...
idle_proc( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        var_5 = maps\_utility::spawn_anim_model( "chair_ak" );
        self.has_delta = 1;
        self.anim_props = maps\_utility::make_array( var_5 );
        var_0 thread maps\_anim::anim_first_frame_solo( var_5, "sit_load_ak_react" );
    }
    ...
    {
        var_5 = maps\_utility::spawn_anim_model( "chair" );
        self.has_delta = 1;
        self.anim_props = maps\_utility::make_array( var_5 );
        var_0 thread maps\_anim::anim_first_frame_solo( var_5, "sleep_react" );
    ...
    if ( isdefined( self._stealth ) )
    {
        ...
        var_0 maps\_stealth_utility::stealth_ai_idle_and_react( self, var_2, var_3, undefined, var_6 );
    ...
    else
    {
        do_into_idle_anim( var_1 );
        var_7 = "stop_loop";
        var_0 thread maps\_anim::anim_generic_loop( self, var_2, var_7 );
        thread animate_props_on_death( var_0, var_3 );
        thread reaction_proc( var_0, var_7, var_3 );
    }
}
