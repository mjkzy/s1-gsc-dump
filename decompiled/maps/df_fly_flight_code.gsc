...
{
    self.default_player_dist = self.default_player_dist + var_0;
    self.infront_dist_min = self.infront_dist_min + var_0;
    self.infront_dist_max = self.infront_dist_max + var_0;
}
...
fly_think_constrained( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        var_3 = var_3 + randomfloatrange( -5.0, 5.0 );
        var_9 = 1.0;
        var_10 = 1.0;
        ...
        {
            if ( var_4 < 0 )
                var_3 = var_3 + var_15 * randomfloatrange( -65.0, -40.0 );
            else if ( var_8 > abs( self.infront_dist_min + var_9 ) * var_1 )
                var_3 = var_3 + var_15 * randomfloatrange( 100, 300.0 );
            else
                var_3 = var_3 - var_15 * randomfloatrange( 6, 9.0 );
        }
        else if ( var_4 > 0 || var_7 < ( var_9 + self.infront_dist_min ) * var_1 )
            var_3 = var_3 + var_15 * randomfloatrange( 20, 25.0 );
        else if ( var_4 < 0 )
        {
            if ( var_8 < ( var_9 + self.infront_dist_max ) * var_2 )
                var_3 = var_3 + var_15 * randomfloatrange( 6, 9.0 );
            else
                var_3 = var_3 + var_15 * randomfloatrange( -20.0, -15.0 );
        }
...
get_plane_gun_origin( var_0 )
{
    ...
    if ( getdvar( "vehCam_mode" ) == "chase" )
        var_2 = var_2 + ( var_5 * 0 + var_4 * 500 + var_3 * 16 );
    else
        var_2 = var_2 + ( var_5 * 150 + var_4 * 500 + var_3 * -50 );
...
jet_shoot_gun( var_0 )
{
    ...
    var_3 = var_3 + common_scripts\utility::randomvector( 2 * tan( var_1 ) * distance( var_2, var_3 ) );
...
spawn_cbdr_missile( var_0, var_1, var_2 )
{
    ...
    var_3.origin = var_3.origin - ( 0, 0, 50 );
...
cbdr_missile_think( var_0 )
{
    ...
    for ( var_13 = 0.0; var_13 < 0.5; var_13 = var_13 + 0.05 )
    {
    ...
    while ( var_21 < var_0 && !common_scripts\utility::flag( "canyon_finished" ) )
    {
        ...
        if ( var_25 )
            ...
            var_18 = var_18 + length( self.velocity ) * var_16 * 0.05;
...
toggle_chase_cam()
{
    ...
    else
    {
        ...
        var_0 = var_0 + anglestoforward( getdvarvector( "vehCam_chaseAngleOffset" ) ) * 10000;
    }
...
fighter_jet_set_shake( var_0, var_1 )
{
    ...
    for ( var_2 = var_0 / ( var_1 / 0.05 ); var_1 > 0.0; var_1 = var_1 - 0.05 )
    {
        wait 0.05;
        level.jet_shake = level.jet_shake - var_2;
    }
    ...
    while ( isalive( level.player ) )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            if ( isdefined( level.jet_shake ) && level.jet_shake > 0.0 )
                var_31 = var_31 + common_scripts\utility::randomvector( level.jet_shake );
...
fighter_jet_handle_throttle( var_0, var_1, var_2 )
{
    ...
    {
        for ( var_3 = 0; var_3 < level.current_median_speed; var_3 = var_3 + 0.05 )
        {
...
fighter_jet_hud( var_0, var_1 )
{
    ...
    if ( getdvar( "vehCam_mode" ) == "chase" )
    {
        ...
        var_17 = var_17 + anglestoforward( getdvarvector( "vehCam_chaseAngleOffset" ) ) * 10000;
    }
...
compute_best_gun_target( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.enemy_units ) )
    {
        foreach ( var_14 in level.enemy_units )
        {
            ...
            var_18 = 0;
            var_18 = var_18 + maps\_shg_utility::linear_map_clamp( var_17, 1, var_5, var_9, 0 );
            var_18 = var_18 + maps\_shg_utility::linear_map_clamp( var_15, 0, var_7, var_8, 0 );
...
missile_miss_player( var_0 )
{
    ...
    else
    {
        ...
        var_3 = var_3 + ( randomintrange( -256, 256 ), randomintrange( -256, 256 ), randomintrange( -256, 256 ) );
    }
...
plane_health_monitor()
{
    ...
    while ( !common_scripts\utility::flag( "final_hit" ) )
    {
        ...
        if ( !common_scripts\utility::flag( "playerPlaneNoDeath" ) )
            self.current_hit_count = self.current_hit_count + var_5;
...
chromo_anim2( var_0, var_1 )
{
    ...
    for ( var_4 = 0; var_4 < var_3; var_4++ )
    {
        ...
        level.chromo_offset = level.chromo_offset - var_6;
...
fadeupstatic( var_0, var_1 )
{
    ...
    if ( !isdefined( level.overlaystatic ) )
    {
        ...
        {
            level.overlaystatic.alpha = level.overlaystatic.alpha + var_2;
            wait 0.05;
        }
...
fadedownstatic( var_0 )
{
    if ( isdefined( level.overlaystatic ) )
    {
        ...
        {
            level.overlaystatic.alpha = level.overlaystatic.alpha - var_1;
            wait 0.05;
        }
