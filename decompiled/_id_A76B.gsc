...
_id_8341( var_0 )
{
    var_1 = [ ( -584.903, -1536.18, 163.125 ), 1.5, ( -252.849, -2122.8, 166.125 ), 0, ( -156.219, -1567.68, 160.125 ), 2, ( 172.208, -1528.17, 167.125 ), 3, ( 1054.11, -1649.7, 164.125 ), 0, ( 1602.57, -1416.54, 167.125 ), 1, ( 2043.16, -942.894, 167.125 ), 1.6, ( 2530.3, -567.627, 164.125 ), 2.2, ( 2852.56, -303.176, 163.79 ), 4, ( -1169.37, -1656.77, 161.125 ), 1, ( -1622.98, -1736.73, 164.125 ), 0, ( -2182.48, -480.268, 168.0 ), 1.2, ( -2455.47, -131.343, 168.0 ), 0, ( -1917.2, -1068.53, 159.0 ), 2, ( 2980.57, 245.072, 170.125 ), 0.5, ( 3434.08, 736.992, 210.864 ), 3, ( 4049.32, 1242.84, 168.0 ), 4.5, ( 2270.59, -692.692, 170.125 ), 3.5 ];

    for ( var_2 = 0; var_2 < var_1.size; var_2 += 2 )
    {
        var_3 = spawnstruct();
        var_3._id_27BF = var_1[var_2 + 1];
        var_4 = common_scripts\utility::spawn_tag_origin();
        var_4 show();
        var_4.origin = ( var_1[var_2][0], var_1[var_2][1], var_0.origin[2] );
        var_4.angles = ( 270.0, 0.0, -90.0 );
        var_4 linktosynchronizedparent( var_0 );
        var_3.ent = var_4;
        level._id_3B95[level._id_3B95.size] = var_3;
    }
}

_id_8321( var_0 )
{
    var_1 = [ ( -589.197, -1605.05, 233.502 ), ( 270.0, 0.0, -90.0 ), 0, ( -843.596, -1305.72, 258.718 ), ( 270.0, 0.0, -90.0 ), 1, ( 37.7022, -1250.75, 255.878 ), ( 270.0, 0.0, -90.0 ), 2, ( -605.969, -878.506, 254.76 ), ( 270.0, 0.0, -90.0 ), 3, ( -225.131, -725.816, 254.456 ), ( 270.0, 0.0, -90.0 ), 4, ( 503.141, -654.117, 273.566 ), ( 270.0, 0.0, -90.0 ), 5, ( 1366.39, -1202.34, 266.587 ), ( 270.0, 0.0, -77.0 ), 6, ( 2322.31, -81.669, 215.623 ), ( 270.0, 0.0, -77.0 ), 7, ( 3591.37, 752.588, 255.0 ), ( 270.0, 0.0, -58.0 ), 8 ];

    for ( var_2 = 0; var_2 < var_1.size; var_2 += 3 )
    {
        var_3 = spawnstruct();
        var_3._id_627A = var_1[var_2 + 2];
        var_4 = common_scripts\utility::spawn_tag_origin();
        var_4 show();
        var_4.origin = ( var_1[var_2][0], var_1[var_2][1], var_0.origin[2] );
        ...
        var_4 linktosynchronizedparent( var_0 );
        var_3.ent = var_4;
        level._id_3B73[level._id_3B73.size] = var_3;
    }
}

_id_6DEB( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        foreach ( var_5 in level._id_3B95 )
        {
            var_5._id_3BA6 = var_3;
            thread _id_6DA1( var_5 );
        }
...
{
    wait(var_0._id_27BF);
    playfxontag( common_scripts\utility::getfx( var_0._id_3BA6 ), var_0.ent, "tag_origin" );
}

_id_6DC7( var_0, var_1 )
{
    foreach ( var_3 in level._id_3B73 )
    {
        if ( var_3._id_627A == var_1 )
            playfxontag( common_scripts\utility::getfx( var_0 ), var_3.ent, "tag_origin" );
    }
}
