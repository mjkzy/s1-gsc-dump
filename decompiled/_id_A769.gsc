...
_id_8317()
{
    var_0 = 15;
    wait 0.5;
    var_1 = getent( "canister_holo", "targetname" );
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_2 show();
            wait 0.5;
            var_2 thread maps\mp\mp_lab2::_id_75FD( 16 );
            playfxontag( common_scripts\utility::getfx( "hologram_bio_lab_canister" ), var_2, "tag_origin" );
            var_3 = spawnfx( common_scripts\utility::getfx( "hologram_bio_lab_canister_child_tablegfx" ), var_1.origin, ( 0.0, 0.0, 270.0 ) );
            triggerfx( var_3 );

            for (;;)
            {
                wait(var_0);
                stopfxontag( common_scripts\utility::getfx( "hologram_bio_lab_canister" ), var_2, "tag_origin" );
                var_3 delete();
                playfxontag( common_scripts\utility::getfx( "hologram_lab_chemical_vat" ), var_2, "tag_origin" );
                var_4 = spawnfx( common_scripts\utility::getfx( "hologram_lab2_chemical_vat_child_tablegfx" ), var_1.origin, ( 0.0, 0.0, 270.0 ) );
                triggerfx( var_4 );
