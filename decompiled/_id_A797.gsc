...
_id_94C9( var_0 )
{
    ...
    for ( var_32 = 0; var_32 < var_8; var_32 += 0.05 )
    {
        ...
        {
            var_33 = var_20 _id_94C1( var_0 );

            if ( isdefined( var_33 ) )
            {
                var_31 = 1;
                var_26 = var_33;
                _id_94C7( var_26.origin );
            }
        }
        ...
        {
            if ( isdefined( var_26 ) )
                var_25 = var_26.origin + var_26 _id_3DF3();
        }
        else
        {
            var_22 = var_0 geteye();
        ...
        if ( var_32 > var_5 )
        {
            var_35 = _id_576A( var_32 - var_5 - var_6, 0, var_10, 0, var_9 );
        ...
        if ( var_42 > 0 )
        {
            ...
            var_20.angles = combineangles( vectortoangles( var_30 ), ( 90.0, 0.0, 0.0 ) );
            ...
            if ( var_47 > var_18 )
            {
                var_20 _id_94CA( var_46, "tracking_grenade_spray_small", var_44 * var_17 );

                if ( var_47 > 2 * var_18 )
                    var_20 _id_94CA( -1 * var_46, "tracking_grenade_spray_small", var_44 * ( var_17 * -1 ) );
            }
...
_id_94C7( var_0 )
{
    badplace_cylinder( "", 4, var_0 + ( 0.0, 0.0, -64.0 ), 117, 128, "all" );
}
...
_id_576A( var_0, var_1, var_2, var_3, var_4 )
{
    return clamp( _id_5769( var_0, var_1, var_2, var_3, var_4 ), min( var_3, var_4 ), max( var_3, var_4 ) );
}

_id_5769( var_0, var_1, var_2, var_3, var_4 )
{
