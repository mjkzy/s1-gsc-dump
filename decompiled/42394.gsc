...
{
    var_1 = maps\_colors::add_ai_to_colors( var_0 );
}

issue_color_orders( var_0, var_1 )
{
    maps\_colors::issue_color_orders_generic( var_0, var_1 );
}

clear_color_order( var_0, var_1 )
{
    maps\_colors::clear_color_order_from_team( var_0, var_1 );
}

clear_all_color_orders( var_0 )
{
    foreach ( var_2 in level.colorlist )
        maps\_colors::clear_color_order_from_team( var_2, var_0 );
}
...
{
    thread maps\_colors::colornode_stop_replace_on_death_group( var_0, var_1 );
}
...
spawn_reinforcement( var_0, var_1, var_2, var_3 )
{
    ...
    thread maps\_colors::colornode_spawn_reinforcement( var_3, var_0, var_1, var_2 );
}
...
{
    maps\_colors::colornode_set_promotion_order( var_0, var_1 );
}

set_empty_promotion_order( var_0 )
{
    maps\_colors::colornode_set_empty_promotion_order( var_0 );
}
...
display_hint( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.trigger_hint_func[var_0] ) )
    {
        ...
        var_5 thread maps\_utility_code::hintprint( level.trigger_hint_string[var_0], level.trigger_hint_func[var_0], var_1, var_2, var_3, undefined, undefined, var_4 );
    }
    else
        var_5 thread maps\_utility_code::hintprint( level.trigger_hint_string[var_0], undefined, undefined, undefined, undefined, undefined, undefined, var_4 );
}
...
display_hint_timeout( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_6 thread maps\_utility_code::hintprint( level.trigger_hint_string[var_0], level.trigger_hint_func[var_0], var_2, var_3, var_4, var_1, undefined, var_5 );
}
...
{
    thread maps\_introscreen::center_screen_lines( var_0 );
}
