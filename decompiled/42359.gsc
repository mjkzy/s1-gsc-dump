...
deathfunctions()
{
    ...
    if ( isdefined( var_0 ) )
    {
        if ( self.team == "axis" || self.team == "team3" )
        {
            ...
            if ( isplayer( var_0 ) && getdvar( "mapname" ) == "sanfran_b" && ( var_1 == "MOD_MELEE_ALT" || var_1 == "MOD_MELEE" ) )
                thread maps\_utility::check_man_overboard();

            if ( isplayer( var_0 ) && isdefined( var_2 ) && var_2 == "tracking_grenade_var" )
                maps\_utility::monitor_genius_achievement( var_0, var_1, var_2 );
            ...
            if ( isplayer( var_0 ) && isdefined( var_0.never_saw_it_coming ) && isdefined( var_2 ) && var_2 == "boost_slam_sp" )
    ...
    for ( var_8 = 0; var_8 < self.deathfuncs.size; var_8++ )
    {
        var_9 = self.deathfuncs[var_8];
        ...
        switch ( var_9["params"] )
        {
            case 0:
                ...
                break;
            case 1:
                [[ var_9["func"] ]]( var_0, var_9["param1"] );
                break;
            case 2:
                [[ var_9["func"] ]]( var_0, var_9["param1"], var_9["param2"] );
                break;
            case 3:
                [[ var_9["func"] ]]( var_0, var_9["param1"], var_9["param2"], var_9["param3"] );
                break;
        }
    }
}
...
pyramid_spawn( var_0 )
{
    ...
    while ( var_4.size > 0 )
    {
        ...
        var_5 = common_scripts\utility::array_first( var_4 );
        ...
        var_4 = common_scripts\utility::array_remove( var_4, var_5 );
        self.count--;
        var_5.spawn = var_6;
