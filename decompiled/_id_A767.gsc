...
{
    wait 1;
    common_scripts\_exploder::_id_06F5( 105 );
}

_id_1BE1()
{
    wait 2.5;
    common_scripts\_exploder::_id_06F5( 201 );
    common_scripts\_exploder::_id_06F5( 202 );
    common_scripts\_exploder::_id_06F5( 203 );
    common_scripts\_exploder::_id_06F5( 204 );
}

_id_1BE2()
{
    common_scripts\_exploder::_id_06F5( 172 );
}

_id_2DEB()
{
    wait 2;
    common_scripts\_exploder::_id_06F5( 171 );
}
...
{
    wait 1;
    common_scripts\_exploder::_id_06F5( 200 );
}
